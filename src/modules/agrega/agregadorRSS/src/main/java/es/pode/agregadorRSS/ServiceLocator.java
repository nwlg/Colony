...
public class ServiceLocator
{
     ...
     */
    private final String DEFAULT_BEAN_REFERENCE_LOCATION = "beanRefFactory_agregadorRSS.xml";
     ...
     */
    public final es.pode.agregador.negocio.agregador.servicio.SrvAgregadorRssService getSrvAgregadorRssService()
    {
        return (es.pode.agregador.negocio.agregador.servicio.SrvAgregadorRssService)
            getContext().getBean("srvAgregadorRssService");
    }
