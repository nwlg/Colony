...
public class CriteriaSearchProperties
{
    ...
    private static final void initialize1()
    {
        embeddedValuesByType.put(
            es.pode.modificador.negocio.dominio.ResultadoModificacionImpl.class,
            null);
        navigableAssociationEndsByType.put(
            ...
            java.util.Arrays.asList(
                new AssociationType[] 
                {
                    new AssociationType("modificacion", es.pode.modificador.negocio.dominio.ModificacionImpl.class)
                }
            )
        );
    }
    ...
    {
        embeddedValuesByType.put(
            es.pode.modificador.negocio.dominio.ModificacionImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.modificador.negocio.dominio.ModificacionImpl.class,
            java.util.Arrays.asList(
                new AssociationType[] 
                {
                    new AssociationType("resultados", es.pode.modificador.negocio.dominio.ResultadoModificacionImpl.class)
                }
            )
        );
    }
