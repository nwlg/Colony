...
public class ServiceLocator
{
     ...
     */
    private final String DEFAULT_BEAN_REFERENCE_LOCATION = "beanRefFactory_fuentestaxonomicas.xml";
     ...
     */
    public final es.pode.fuentestaxonomicas.negocio.servicio.SrvVocabulariosControladosService getSrvVocabulariosControladosService()
    {
        return (es.pode.fuentestaxonomicas.negocio.servicio.SrvVocabulariosControladosService)
            getContext().getBean("srvVocabulariosControladosService");
    }

    /**
     * Gets an instance of {@link es.pode.fuentestaxonomicas.negocio.servicio.SrvTaxonomiaService}.
     */
    public final es.pode.fuentestaxonomicas.negocio.servicio.SrvTaxonomiaService getSrvTaxonomiaService()
    {
        return (es.pode.fuentestaxonomicas.negocio.servicio.SrvTaxonomiaService)
            getContext().getBean("srvTaxonomiaService");
    }

    /**
     * Gets an instance of {@link es.pode.fuentestaxonomicas.negocio.servicio.SrvTesaurosServices}.
     */
    public final es.pode.fuentestaxonomicas.negocio.servicio.SrvTesaurosServices getSrvTesaurosServices()
    {
        return (es.pode.fuentestaxonomicas.negocio.servicio.SrvTesaurosServices)
            getContext().getBean("srvTesaurosServices");
    }

    /**
     * Gets an instance of {@link es.pode.fuentestaxonomicas.negocio.servicio.SrvEstructurasEducativasService}.
     */
    public final es.pode.fuentestaxonomicas.negocio.servicio.SrvEstructurasEducativasService getSrvEstructurasEducativasService()
    {
        return (es.pode.fuentestaxonomicas.negocio.servicio.SrvEstructurasEducativasService)
            getContext().getBean("srvEstructurasEducativasService");
    }
