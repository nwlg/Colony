...
//
package es.pode.validador.negocio;
...
public class ServiceLocator
{
     ...
     */
    private final String DEFAULT_BEAN_REFERENCE_LOCATION = "beanRefFactory_validador.xml";
     ...
     */
    public final es.pode.validador.negocio.servicio.SrvValidadorService getSrvValidadorService()
    {
        return (es.pode.validador.negocio.servicio.SrvValidadorService)
            getContext().getBean("srvValidadorService");
    }

    /**
     * Gets an instance of {@link es.pode.validador.negocio.servicio.SrvValidadorVDEXService}.
     */
    public final es.pode.validador.negocio.servicio.SrvValidadorVDEXService getSrvValidadorVDEXService()
    {
        return (es.pode.validador.negocio.servicio.SrvValidadorVDEXService)
            getContext().getBean("srvValidadorVDEXService");
    }
     ...
     */
    //public final es.pode.validador.negocio.servicio.ScormDao getScormDao()
     ...
     */
    //public final es.pode.validador.negocio.servicio.LomesDao getLomesDao()
