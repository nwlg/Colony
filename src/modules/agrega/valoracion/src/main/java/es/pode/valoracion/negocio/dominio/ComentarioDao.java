...
public interface ComentarioDao
{
     ...
     * {@link es.pode.valoracion.negocio.servicios.ComentarioVO}.
     */
    public final static int TRANSFORM_COMENTARIOVO = 1;
    
    
    /**
     * Converts this DAO's entity to an object of type {@link es.pode.valoracion.negocio.servicios.ComentarioVO}.
     * @param entity es.pode.valoracion.negocio.dominio.Comentario
     * @return es.pode.valoracion.negocio.servicios.ComentarioVO     
     */
    public es.pode.valoracion.negocio.servicios.ComentarioVO toComentarioVO(es.pode.valoracion.negocio.dominio.Comentario entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link es.pode.valoracion.negocio.servicios.ComentarioVO}.
     * @param entities java.util.Collection
     */
    public void toComentarioVOCollection(java.util.Collection entities);

    public es.pode.valoracion.negocio.dominio.Comentario fromComentarioVO(es.pode.valoracion.negocio.servicios.ComentarioVO vo);
    ...
    /**
     * Loads an instance of es.pode.valoracion.negocio.dominio.Comentario from the persistent store.
    ...
    /**
     * Loads all entities of type {@link es.pode.valoracion.negocio.dominio.Comentario}. 
     * 
    ...
    /**
     * Creates an instance of es.pode.valoracion.negocio.dominio.Comentario and adds it to the persistent store.
     * @param comentario es.pode.valoracion.negocio.dominio.Comentario
     * @return es.pode.valoracion.negocio.dominio.Comentario     
     */
    ...
    /**
     * <p>
     *   Does the same thing as {@link #create(es.pode.valoracion.negocio.dominio.Comentario)} with an
     *   additional flag called <code>transform</code>.  If this flag is set to <code>TRANSFORM_NONE</code> then
     *   the returned entity will <strong>NOT</strong> be transformed.  If this flag is any of the other constants
     *   defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     *   transform the entity (into a value object for example).  By default, transformation does
     ...
     * @return Object     
     */
    public Object create(int transform, es.pode.valoracion.negocio.dominio.Comentario comentario);

    /**
     * Creates a new instance of es.pode.valoracion.negocio.dominio.Comentario and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of es.pode.valoracion.negocio.dominio.Comentario
     *        instances to create.
     *
    ...
    /**
     * <p>
     *   Creates a new <code>es.pode.valoracion.negocio.dominio.Comentario</code>
    ...
    /**
     * Removes the instance of es.pode.valoracion.negocio.dominio.Comentario from the persistent store.
     * @param comentario es.pode.valoracion.negocio.dominio.Comentario  
     */
    public void remove(es.pode.valoracion.negocio.dominio.Comentario comentario);

    /**
     * Removes the instance of es.pode.valoracion.negocio.dominio.Comentario having the given
   ...
   */
    ...
    /**
     * <p>
     *   Does the same thing as {@link #buscarComentariosPorCriterioODE(es.pode.valoracion.negocio.dominio.IdODEFechaCriteria)} with an
     *   additional flag called <code>transform</code>.  If this flag is set to <code>TRANSFORM_NONE</code> then
