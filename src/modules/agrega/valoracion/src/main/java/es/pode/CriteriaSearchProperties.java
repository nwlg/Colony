...
public class CriteriaSearchProperties
{
    ...
    private static final void initialize1()
    {
        embeddedValuesByType.put(
            es.pode.tagging.negocio.dominio.TaggingImpl.class,
            null);
    ...
    {
        embeddedValuesByType.put(
            es.pode.valoracion.negocio.dominio.ValoracionImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.valoracion.negocio.dominio.ValoracionImpl.class,
            java.util.Arrays.asList(
    ...
    {
        embeddedValuesByType.put(
            es.pode.valoracion.negocio.dominio.ComentarioImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.valoracion.negocio.dominio.ComentarioImpl.class,
            java.util.Arrays.asList(
