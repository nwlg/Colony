 ...
 * 
 */
public class IdUsuarioCriteria
    implements java.io.Serializable
{
   ...
   */
    ...
    /**
     * Copies constructor from other IdUsuarioCriteria
      * @param otherBean IdUsuarioCriteria
     */
    public IdUsuarioCriteria(IdUsuarioCriteria otherBean)
    {
        if (otherBean != null)
        {
