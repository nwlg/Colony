 ...
 * 
 */
public class IdentificadoresCriteria
    implements java.io.Serializable
{
   ...
   */
    public IdentificadoresCriteria()
    {
    }

    /**
     * Constructor taking all properties.
      * @param identificadores java.lang.String[]
     */
    public IdentificadoresCriteria(
    ...
    /**
     * Copies constructor from other IdentificadoresCriteria
      * @param otherBean IdentificadoresCriteria
     */
    public IdentificadoresCriteria(IdentificadoresCriteria otherBean)
    {
        if (otherBean != null)
        {
            this.identificadores = otherBean.getIdentificadores();
        }
    }
   ...
   * El array de identificadores.
   * </p>
   *  @param identificadores  El array de identificadores. 
   */
