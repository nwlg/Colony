...
public class NavegarLOMBuscarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public NavegarLOMBuscarFormImpl()
    {
    }
    ...
    public void setTipoBusquedaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("NavegarLOMBuscarFormImpl.setTipoBusquedaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NavegarLOMBuscarFormImpl.setTipoBusquedaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("NavegarLOMBuscarFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NavegarLOMBuscarFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
