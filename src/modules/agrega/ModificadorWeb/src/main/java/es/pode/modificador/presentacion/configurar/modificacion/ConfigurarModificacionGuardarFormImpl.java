...
public class ConfigurarModificacionGuardarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.configurar.modificacion.GuardarModificacionForm
        , es.pode.modificador.presentacion.configurar.modificacion.BorrarSesionForm
        , es.pode.modificador.presentacion.configurar.modificacion.SubmitBotonesForm
{
    ...
    public ConfigurarModificacionGuardarFormImpl()
    {
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfigurarModificacionGuardarFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfigurarModificacionGuardarFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
