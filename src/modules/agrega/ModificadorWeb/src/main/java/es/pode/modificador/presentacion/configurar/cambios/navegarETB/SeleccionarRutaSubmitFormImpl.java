...
public class SeleccionarRutaSubmitFormImpl
        ...
        , es.pode.modificador.presentacion.configurar.cambios.navegarETB.SelectActionRutasForm
{
    ...
    private java.lang.Object[] taxonomiaValueList;
    private java.lang.Object[] taxonomiaLabelList;
    ...
    public SeleccionarRutaSubmitFormImpl()
    {
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("SeleccionarRutaSubmitFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarRutaSubmitFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }

    /**
     * Resets the given <code>taxonomia</code>.
     */
    public void resetTaxonomia()
    {
        this.taxonomia = null;
    }
    ...
    public java.lang.Object[] getTaxonomiaBackingList()
    {
        java.lang.Object[] values = this.taxonomiaValueList;
        java.lang.Object[] labels = this.taxonomiaLabelList;
    ...
    public java.lang.Object[] getTaxonomiaValueList()
    {
        return this.taxonomiaValueList;
    }

    public void setTaxonomiaValueList(java.lang.Object[] taxonomiaValueList)
    {
        this.taxonomiaValueList = taxonomiaValueList;
    }

    public java.lang.Object[] getTaxonomiaLabelList()
    {
        return this.taxonomiaLabelList;
    }

    public void setTaxonomiaLabelList(java.lang.Object[] taxonomiaLabelList)
    {
        this.taxonomiaLabelList = taxonomiaLabelList;
    }

    public void setTaxonomiaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarRutaSubmitFormImpl.setTaxonomiaBackingList requires non-null property arguments");
        }

        this.taxonomiaValueList = null;
        this.taxonomiaLabelList = null;

        if (items != null)
        {
            this.taxonomiaValueList = new java.lang.Object[items.size()];
            this.taxonomiaLabelList = new java.lang.Object[items.size()];
            ...
            try
            {
                ...
                for (java.util.Iterator iterator = items.iterator(); iterator.hasNext(); i++)
                {
                    ...
                    this.taxonomiaValueList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, valueProperty);
                    this.taxonomiaLabelList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, labelProperty);
                }
            }
            catch (Exception ex)
            {
                throw new java.lang.RuntimeException("SeleccionarRutaSubmitFormImpl.setTaxonomiaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdTerminoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarRutaSubmitFormImpl.setIdTerminoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarRutaSubmitFormImpl.setIdTerminoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTipoBusquedaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarRutaSubmitFormImpl.setTipoBusquedaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarRutaSubmitFormImpl.setTipoBusquedaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setPosicionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarRutaSubmitFormImpl.setPosicionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarRutaSubmitFormImpl.setPosicionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarRutaSubmitFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarRutaSubmitFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public java.lang.String toString()
    {
        ...
        builder.append("taxonomia", this.taxonomia);
