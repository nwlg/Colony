 ...
 * 
 */
public final class IndicarRuta extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final IndicarRutaFormImpl specificForm = (IndicarRutaFormImpl)form;

        final Object previousFormObject = request.getSession().getAttribute("form");

        if (previousFormObject instanceof es.pode.modificador.presentacion.configurar.objetos.ConfigurarObjetosFormImpl)
        {
            final es.pode.modificador.presentacion.configurar.objetos.ConfigurarObjetosFormImpl previousForm = (es.pode.modificador.presentacion.configurar.objetos.ConfigurarObjetosFormImpl)previousFormObject;
        }
        else
        ...
        try
        {
            forward = _recuperarIdioma(mapping, form, request, response);
        }
    ...
    private org.apache.struts.action.ActionForward _recuperarIdioma(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.configurar.objetos.ruta.IndicarRutaControllerFactory.getIndicarRutaControllerInstance().recuperarIdioma(mapping, (IndicarRutaFormImpl)form, request, response);
