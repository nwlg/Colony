...
public class CrearModificacionContinuarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.configurar.nombre.GuardarNombreForm
        , es.pode.modificador.presentacion.configurar.nombre.CerrarSesionForm
        , es.pode.modificador.presentacion.configurar.nombre.SelectActionForm
{
    ...
    public CrearModificacionContinuarFormImpl()
    {
    }
    ...
    public void setNombreBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CrearModificacionContinuarFormImpl.setNombreBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearModificacionContinuarFormImpl.setNombreBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CrearModificacionContinuarFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearModificacionContinuarFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
