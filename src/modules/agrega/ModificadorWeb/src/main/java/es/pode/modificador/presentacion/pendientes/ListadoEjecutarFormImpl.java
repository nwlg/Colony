...
public class ListadoEjecutarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.pendientes.EjecutarTareaForm
        , es.pode.modificador.presentacion.pendientes.EsOfflineForm
{
    ...
    public ListadoEjecutarFormImpl()
    {
    }
    ...
    public void setIdModificacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoEjecutarFormImpl.setIdModificacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoEjecutarFormImpl.setIdModificacionBackingList encountered an exception", ex);
            }
        }
    }
