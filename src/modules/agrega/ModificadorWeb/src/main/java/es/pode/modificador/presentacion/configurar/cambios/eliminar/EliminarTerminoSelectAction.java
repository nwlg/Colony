 ...
 * 
 */
public final class EliminarTerminoSelectAction extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final EliminarTerminoSelectActionFormImpl specificForm = (EliminarTerminoSelectActionFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _eliminar(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.configurar.cambios.eliminar.EliminarTerminoControllerFactory.getEliminarTerminoControllerInstance().eliminar(mapping, (EliminarTerminoSelectActionFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _borrarSesion(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.configurar.cambios.eliminar.EliminarTerminoControllerFactory.getEliminarTerminoControllerInstance().borrarSesion(mapping, (EliminarTerminoSelectActionFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _recuperarIdTermino(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.configurar.cambios.eliminar.EliminarTerminoControllerFactory.getEliminarTerminoControllerInstance().recuperarIdTermino(mapping, (EliminarTerminoSelectActionFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.modificador.presentacion.configurar.cambios.eliminar.EliminarTerminoControllerFactory.getEliminarTerminoControllerInstance().selectAction(mapping, (EliminarTerminoSelectActionFormImpl)form, request, response));
