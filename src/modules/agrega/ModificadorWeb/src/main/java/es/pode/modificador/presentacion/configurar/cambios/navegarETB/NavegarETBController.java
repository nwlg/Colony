 ...
 * 
 */
public abstract class NavegarETBController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.modificador.presentacion.configurar.cambios.navegarETB.NavegarETBForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void navegarETB(org.apache.struts.action.ActionMapping mapping, es.pode.modificador.presentacion.configurar.cambios.navegarETB.NavegarETBForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.modificador.presentacion.configurar.cambios.navegarETB.SelectActionForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     * @return java.lang.String
     */
    public abstract java.lang.String selectAction(org.apache.struts.action.ActionMapping mapping, es.pode.modificador.presentacion.configurar.cambios.navegarETB.SelectActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.modificador.presentacion.configurar.cambios.navegarETB.GuardarTerminoForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void guardarTermino(org.apache.struts.action.ActionMapping mapping, es.pode.modificador.presentacion.configurar.cambios.navegarETB.GuardarTerminoForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.modificador.presentacion.configurar.cambios.navegarETB.ComprobarJerarquiasForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     * @return java.lang.String
     */
    public abstract java.lang.String comprobarJerarquias(org.apache.struts.action.ActionMapping mapping, es.pode.modificador.presentacion.configurar.cambios.navegarETB.ComprobarJerarquiasForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.modificador.presentacion.configurar.cambios.navegarETB.SelectActionRutasForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     * @return java.lang.String
     */
    public abstract java.lang.String selectActionRutas(org.apache.struts.action.ActionMapping mapping, es.pode.modificador.presentacion.configurar.cambios.navegarETB.SelectActionRutasForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.modificador.presentacion.configurar.cambios.navegarETB.PrepararSeleccionForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void prepararSeleccion(org.apache.struts.action.ActionMapping mapping, es.pode.modificador.presentacion.configurar.cambios.navegarETB.PrepararSeleccionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    /**
     * Returns the current TesauroSession from the session found in the argument request.
     * <p/>
     * In case an object was found in the session but it was not of the correct type, this method
     * will return <code>null</code>.
     * <p/>
     ...
     *
     * @param request javax.servlet.http.HttpServletRequest          
     * @return es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession
     */
    protected final es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession getTesauroSession(javax.servlet.http.HttpServletRequest request)
    {
        es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession object = null;
        javax.servlet.http.HttpSession session = request.getSession(true);

        Object attribute = session.getAttribute(es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession.SESSION_KEY);
        if (attribute instanceof es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession)
        {
            object = (es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession)attribute;
        }
        else if (attribute == null)
        {
            object = new es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession ();
            setTesauroSession(request, object);
        }
    ...
    /**
     * Set the argument TesauroSession object in the session corresponding with the argument request.
     * In case the session would not exist it will be created.
     *
     * @param request javax.servlet.http.HttpServletRequest 
     * @param object es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession                          
     */
    protected final void setTesauroSession(javax.servlet.http.HttpServletRequest request, es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession object)
    {
        setTesauroSession(request, object, true);
    }
     ...
     * @param object es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession             
     */
    protected final void setTesauroSession(javax.servlet.http.HttpServletRequest request, es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession object, boolean createSession)
    {
        javax.servlet.http.HttpSession session = request.getSession(createSession);
        if (session != null)
        {
            session.setAttribute(es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession.SESSION_KEY, object);
        }
    }

    /**
     * Removes the argument TesauroSession object from the session corresponding with the argument request.
     * In any of the following cases this method will do nothing:
     * <ul>
     *   <li>No session corresponds to the argument request</li>
     *   <li>No TesauroSession object could be found in the request</li>
     *   <li>The object is not of the correct type</li>
     * </ul>
     * @param request javax.servlet.http.HttpServletRequest            
     */
    protected final void removeTesauroSession(javax.servlet.http.HttpServletRequest request)
    {
        javax.servlet.http.HttpSession session = request.getSession(false);
        if (session != null)
        {
            ...
            if (attribute instanceof es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession)
            {
                session.removeAttribute(es.pode.modificador.presentacion.configurar.cambios.navegarETB.TesauroSession.SESSION_KEY);
            }
        }
    }
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvHerramientaModificacionInputStream=NavegarETBController.class.getClassLoader().getResourceAsStream(srvHerramientaModificacionFile);
