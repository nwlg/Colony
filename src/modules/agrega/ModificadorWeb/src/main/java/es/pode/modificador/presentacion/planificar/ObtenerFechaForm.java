 ...
 * <code>obtenerFecha</code> method, which is located on the
 * <code>es.pode.modificador.presentacion.planificar.PlanificarController</code> controller.
 *
 * 
 *
 * @see es.pode.modificador.presentacion.planificar.PlanificarController#obtenerFecha
 */
public interface ObtenerFechaForm
{
    /**
