...
public class IndicarRutaSelectActionFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.configurar.objetos.ruta.AAdirObjetoForm
        , es.pode.modificador.presentacion.configurar.objetos.ruta.SelectActionForm
{
    ...
    public IndicarRutaSelectActionFormImpl()
    {
    }
    ...
    public void setPathBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("IndicarRutaSelectActionFormImpl.setPathBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("IndicarRutaSelectActionFormImpl.setPathBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("IndicarRutaSelectActionFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("IndicarRutaSelectActionFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
