...
public class ConfirmacionSubmitConfirmacionFormImpl
    ...
    implements java.io.Serializable
        , es.pode.modificador.presentacion.pendientes.EliminarModificacionesForm
        , es.pode.modificador.presentacion.pendientes.RecuperarModificacionesForm
        , es.pode.modificador.presentacion.pendientes.SubmitConfirmacionForm
{
    ...
    public void setIdPlanificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfirmacionSubmitConfirmacionFormImpl.setIdPlanificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionSubmitConfirmacionFormImpl.setIdPlanificadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.modificador.presentacion.pendientes.ConfirmacionSubmitConfirmacionFormImpl#getModificaciones
     */
     ...
     * will also return <code>null</code>.
     *
     * @see es.pode.modificador.presentacion.pendientes.ConfirmacionSubmitConfirmacionFormImpl#getIdentificadores
     */
    ...
    public void setIdentificadoresBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionSubmitConfirmacionFormImpl.setIdentificadoresBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionSubmitConfirmacionFormImpl.setIdentificadoresBackingList encountered an exception", ex);
            }
        }
    }
