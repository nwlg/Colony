 ...
 * 
 */
public final class ConfigurarCambiosSelectAction extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final ConfigurarCambiosSelectActionFormImpl specificForm = (ConfigurarCambiosSelectActionFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _destruirSesion(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.configurar.cambios.ConfigurarCambiosControllerFactory.getConfigurarCambiosControllerInstance().destruirSesion(mapping, (ConfigurarCambiosSelectActionFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.modificador.presentacion.configurar.cambios.ConfigurarCambiosControllerFactory.getConfigurarCambiosControllerInstance().selectAction(mapping, (ConfigurarCambiosSelectActionFormImpl)form, request, response));

        if (value.equals("Add"))
        {
            return mapping.findForward("tipo.anadir");
        }
        if (value.equals("Validador"))
        {
