 ...
 * 
 */
public abstract class ModificacionesEjecutandoseController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.modificador.presentacion.ejecutandose.RecuperarModificacionesForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void recuperarModificaciones(org.apache.struts.action.ActionMapping mapping, es.pode.modificador.presentacion.ejecutandose.RecuperarModificacionesForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvHerramientaModificacionInputStream=ModificacionesEjecutandoseController.class.getClassLoader().getResourceAsStream(srvHerramientaModificacionFile);
