...
public class ComprobarTerminoBuscarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ComprobarTerminoBuscarFormImpl()
    {
    }
    ...
    public void setTipoBusquedaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ComprobarTerminoBuscarFormImpl.setTipoBusquedaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ComprobarTerminoBuscarFormImpl.setTipoBusquedaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ComprobarTerminoBuscarFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ComprobarTerminoBuscarFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
