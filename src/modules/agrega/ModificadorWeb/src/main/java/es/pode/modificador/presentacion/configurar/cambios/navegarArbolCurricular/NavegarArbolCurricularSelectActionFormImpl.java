...
public class NavegarArbolCurricularSelectActionFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.configurar.cambios.navegarArbolCurricular.GuardarTerminoForm
        , es.pode.modificador.presentacion.configurar.cambios.navegarArbolCurricular.SelectActionForm
{
    ...
    public NavegarArbolCurricularSelectActionFormImpl()
    {
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("NavegarArbolCurricularSelectActionFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NavegarArbolCurricularSelectActionFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdTerminoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("NavegarArbolCurricularSelectActionFormImpl.setIdTerminoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NavegarArbolCurricularSelectActionFormImpl.setIdTerminoBackingList encountered an exception", ex);
            }
        }
    }
