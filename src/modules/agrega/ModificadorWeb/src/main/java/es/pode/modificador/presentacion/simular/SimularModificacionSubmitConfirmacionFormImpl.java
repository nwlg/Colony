...
public class SimularModificacionSubmitConfirmacionFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.simular.SimularForm
        , es.pode.modificador.presentacion.simular.SubmitConfirmacionForm
{
    ...
    public SimularModificacionSubmitConfirmacionFormImpl()
    {
    }
    ...
    public void setResultadosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("SimularModificacionSubmitConfirmacionFormImpl.setResultadosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SimularModificacionSubmitConfirmacionFormImpl.setResultadosBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SimularModificacionSubmitConfirmacionFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SimularModificacionSubmitConfirmacionFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdModificacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SimularModificacionSubmitConfirmacionFormImpl.setIdModificacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SimularModificacionSubmitConfirmacionFormImpl.setIdModificacionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    {
        this.resultados = null;
        this.resultadosValueList = new java.lang.Object[0];
        this.resultadosLabelList = new java.lang.Object[0];
    }
