...
public class ConfigurarCambiosSelectActionFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.configurar.cambios.DestruirSesionForm
        , es.pode.modificador.presentacion.configurar.cambios.SelectActionForm
{
    ...
    public ConfigurarCambiosSelectActionFormImpl()
    {
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfigurarCambiosSelectActionFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfigurarCambiosSelectActionFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdTerminoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfigurarCambiosSelectActionFormImpl.setIdTerminoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfigurarCambiosSelectActionFormImpl.setIdTerminoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setOptionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfigurarCambiosSelectActionFormImpl.setOptionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfigurarCambiosSelectActionFormImpl.setOptionBackingList encountered an exception", ex);
            }
        }
    }
