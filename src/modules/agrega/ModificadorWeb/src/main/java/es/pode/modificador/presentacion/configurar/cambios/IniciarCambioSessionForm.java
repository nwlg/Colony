 ...
 * <code>iniciarCambioSession</code> method, which is located on the
 * <code>es.pode.modificador.presentacion.configurar.cambios.ConfigurarCambiosController</code> controller.
 *
 * 
 *
 * @see es.pode.modificador.presentacion.configurar.cambios.ConfigurarCambiosController#iniciarCambioSession
 */
public interface IniciarCambioSessionForm
{
    /**
     * Sets the <code>tipos</code> field.
     *
     * 
     */
    ...
    /**
     * Gets the <code>tipos</code> field.
     *
     * 
     */
    ...
    /**
     * Resets the <code>tipos</code> field.
     */
