 ...
 * <code>recuperaNombre</code> method, which is located on the
 * <code>es.pode.modificador.presentacion.configurar.nombre.ConfigurarNombreController</code> controller.
 *
 * 
 *
 * @see es.pode.modificador.presentacion.configurar.nombre.ConfigurarNombreController#recuperaNombre
 */
public interface RecuperaNombreForm
{
    /**
