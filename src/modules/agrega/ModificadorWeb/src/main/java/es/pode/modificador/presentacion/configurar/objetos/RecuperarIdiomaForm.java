 ...
 * <code>recuperarIdioma</code> method, which is located on the
 * <code>es.pode.modificador.presentacion.configurar.objetos.ConfigurarObjetosController</code> controller.
 *
 * 
 *
 * @see es.pode.modificador.presentacion.configurar.objetos.ConfigurarObjetosController#recuperarIdioma
 */
public interface RecuperarIdiomaForm
{
    /**
