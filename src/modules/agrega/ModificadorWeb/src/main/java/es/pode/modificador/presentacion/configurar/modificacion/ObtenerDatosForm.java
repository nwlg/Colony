 ...
 * 
 *
 * @see es.pode.modificador.presentacion.configurar.modificacion.ConfigurarModificacionController#obtenerDatos
 */
public interface ObtenerDatosForm
{
    ...
    /**
     * Resets the <code>cambios</code> field.
     */
