...
public class EliminarTerminoBuscarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public EliminarTerminoBuscarFormImpl()
    {
    }
    ...
    public void setTipoBusquedaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("EliminarTerminoBuscarFormImpl.setTipoBusquedaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("EliminarTerminoBuscarFormImpl.setTipoBusquedaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("EliminarTerminoBuscarFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("EliminarTerminoBuscarFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
