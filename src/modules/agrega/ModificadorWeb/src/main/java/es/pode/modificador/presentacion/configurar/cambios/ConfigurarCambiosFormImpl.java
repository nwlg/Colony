...
public class ConfigurarCambiosFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.configurar.cambios.IniciarCambioSessionForm
{
    ...
    private java.lang.String[] tipos;
    private java.lang.Object[] tiposValueList;
    private java.lang.Object[] tiposLabelList;
    ...
    private java.lang.Object[] optionValueList;
    private java.lang.Object[] optionLabelList;
    ...
    public ConfigurarCambiosFormImpl()
    {
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfigurarCambiosFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfigurarCambiosFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdTerminoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfigurarCambiosFormImpl.setIdTerminoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfigurarCambiosFormImpl.setIdTerminoBackingList encountered an exception", ex);
            }
        }
    }

    /**
     * Resets the given <code>tipos</code>.
     */
    ...
    public void setTipos(java.lang.String[] tipos)
    {
        this.tipos = tipos;
    }
     ...
     * 
     */
    public java.lang.String[] getTipos()
    {
        return this.tipos;
    }
    
    public java.lang.Object[] getTiposBackingList()
    {
        java.lang.Object[] values = this.tiposValueList;
        java.lang.Object[] labels = this.tiposLabelList;
    ...
    public java.lang.Object[] getTiposValueList()
    {
        return this.tiposValueList;
    }

    public void setTiposValueList(java.lang.Object[] tiposValueList)
    {
        this.tiposValueList = tiposValueList;
    }

    public java.lang.Object[] getTiposLabelList()
    {
        return this.tiposLabelList;
    }

    public void setTiposLabelList(java.lang.Object[] tiposLabelList)
    {
        this.tiposLabelList = tiposLabelList;
    }

    public void setTiposBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfigurarCambiosFormImpl.setTiposBackingList requires non-null property arguments");
        }

        this.tiposValueList = null;
        this.tiposLabelList = null;

        if (items != null)
        {
            this.tiposValueList = new java.lang.Object[items.size()];
            this.tiposLabelList = new java.lang.Object[items.size()];
            ...
            try
            {
                ...
                for (java.util.Iterator iterator = items.iterator(); iterator.hasNext(); i++)
                {
                    ...
                    this.tiposValueList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, valueProperty);
                    this.tiposLabelList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, labelProperty);
                }
            }
            catch (Exception ex)
            {
                throw new java.lang.RuntimeException("ConfigurarCambiosFormImpl.setTiposBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTipoBusquedaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfigurarCambiosFormImpl.setTipoBusquedaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfigurarCambiosFormImpl.setTipoBusquedaBackingList encountered an exception", ex);
            }
        }
    }

    /**
     * Resets the given <code>option</code>.
     */
    ...
    public java.lang.Object[] getOptionBackingList()
    {
        java.lang.Object[] values = this.optionValueList;
        java.lang.Object[] labels = this.optionLabelList;
    ...
    public java.lang.Object[] getOptionValueList()
    {
        return this.optionValueList;
    }

    public void setOptionValueList(java.lang.Object[] optionValueList)
    {
        this.optionValueList = optionValueList;
    }

    public java.lang.Object[] getOptionLabelList()
    {
        return this.optionLabelList;
    }

    public void setOptionLabelList(java.lang.Object[] optionLabelList)
    {
        this.optionLabelList = optionLabelList;
    }

    public void setOptionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfigurarCambiosFormImpl.setOptionBackingList requires non-null property arguments");
        }

        this.optionValueList = null;
        this.optionLabelList = null;

        if (items != null)
        {
            this.optionValueList = new java.lang.Object[items.size()];
            this.optionLabelList = new java.lang.Object[items.size()];
            ...
            try
            {
                ...
                for (java.util.Iterator iterator = items.iterator(); iterator.hasNext(); i++)
                {
                    ...
                    this.optionValueList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, valueProperty);
                    this.optionLabelList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, labelProperty);
                }
            }
            catch (Exception ex)
            {
                throw new java.lang.RuntimeException("ConfigurarCambiosFormImpl.setOptionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfigurarCambiosFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfigurarCambiosFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public java.lang.String toString()
    {
        ...
        builder.append("tipos", this.tipos);
