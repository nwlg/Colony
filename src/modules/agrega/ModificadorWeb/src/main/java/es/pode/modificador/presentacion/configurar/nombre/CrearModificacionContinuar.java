 ...
 * 
 */
public final class CrearModificacionContinuar extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final CrearModificacionContinuarFormImpl specificForm = (CrearModificacionContinuarFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _crear(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.configurar.nombre.ConfigurarNombreControllerFactory.getConfigurarNombreControllerInstance().guardarNombre(mapping, (CrearModificacionContinuarFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _cerrarSesion(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.configurar.nombre.ConfigurarNombreControllerFactory.getConfigurarNombreControllerInstance().cerrarSesion(mapping, (CrearModificacionContinuarFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.modificador.presentacion.configurar.nombre.ConfigurarNombreControllerFactory.getConfigurarNombreControllerInstance().selectAction(mapping, (CrearModificacionContinuarFormImpl)form, request, response));
        ...
        {
            return _cerrarSesion(mapping, form, request, response);
        }
