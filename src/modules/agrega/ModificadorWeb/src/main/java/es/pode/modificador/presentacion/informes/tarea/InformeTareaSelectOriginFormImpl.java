...
public class InformeTareaSelectOriginFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.informes.tarea.SelectOriginForm
{
    ...
    public InformeTareaSelectOriginFormImpl()
    {
    }
    ...
    public void setIdModificacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("InformeTareaSelectOriginFormImpl.setIdModificacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("InformeTareaSelectOriginFormImpl.setIdModificacionBackingList encountered an exception", ex);
            }
        }
    }
