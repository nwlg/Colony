...
public class ListadoBusquedaFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ListadoBusquedaFormImpl()
    {
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoBusquedaFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoBusquedaFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
