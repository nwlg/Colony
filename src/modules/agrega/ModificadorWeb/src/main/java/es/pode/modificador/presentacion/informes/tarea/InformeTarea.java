 ...
 * 
 */
public final class InformeTarea extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final InformeTareaFormImpl specificForm = (InformeTareaFormImpl)form;

        final Object previousFormObject = request.getSession().getAttribute("form");

        if (previousFormObject instanceof es.pode.modificador.presentacion.ejecutadas.ListadoInformeFormImpl)
        {
            final es.pode.modificador.presentacion.ejecutadas.ListadoInformeFormImpl previousForm = (es.pode.modificador.presentacion.ejecutadas.ListadoInformeFormImpl)previousFormObject;
        }
        else
    ...
    private org.apache.struts.action.ActionForward _obtenerDatos(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.informes.tarea.InformeTareaControllerFactory.getInformeTareaControllerInstance().obtenerDatos(mapping, (InformeTareaFormImpl)form, request, response);
