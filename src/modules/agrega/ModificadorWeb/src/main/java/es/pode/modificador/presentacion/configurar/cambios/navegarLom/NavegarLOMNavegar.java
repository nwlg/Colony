 ...
 * 
 */
public final class NavegarLOMNavegar extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final NavegarLOMNavegarFormImpl specificForm = (NavegarLOMNavegarFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _navegar(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.configurar.cambios.navegarLom.NavegarLomControllerFactory.getNavegarLomControllerInstance().navegarLom(mapping, (NavegarLOMNavegarFormImpl)form, request, response);
