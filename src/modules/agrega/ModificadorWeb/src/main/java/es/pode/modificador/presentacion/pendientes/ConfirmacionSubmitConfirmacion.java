...
public final class ConfirmacionSubmitConfirmacion extends org.apache.struts.action.Action
{
    ...
    private org.apache.struts.action.ActionForward _eliminarModificaciones(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.pendientes.ModificacionesPendientesControllerFactory.getModificacionesPendientesControllerInstance().eliminarModificaciones(mapping, (ConfirmacionSubmitConfirmacionFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _recuperarModificaciones(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.pendientes.ModificacionesPendientesControllerFactory.getModificacionesPendientesControllerInstance().recuperarModificaciones(mapping, (ConfirmacionSubmitConfirmacionFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.modificador.presentacion.pendientes.ModificacionesPendientesControllerFactory.getModificacionesPendientesControllerInstance().submitConfirmacion(mapping, (ConfirmacionSubmitConfirmacionFormImpl)form, request, response));
