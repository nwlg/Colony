 ...
 * 
 */
public final class ListadoEliminar extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final ListadoEliminarFormImpl specificForm = (ListadoEliminarFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _submit(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.modificador.presentacion.ejecutadas.ModificacionesEjecutadasControllerFactory.getModificacionesEjecutadasControllerInstance().submitEliminar(mapping, (ListadoEliminarFormImpl)form, request, response);
