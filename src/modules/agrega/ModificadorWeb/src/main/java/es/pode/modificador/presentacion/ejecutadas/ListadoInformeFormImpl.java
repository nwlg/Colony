...
public class ListadoInformeFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.modificador.presentacion.ejecutadas.RecuperarInformeForm
{
    ...
    public void setIdModificacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoInformeFormImpl.setIdModificacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoInformeFormImpl.setIdModificacionBackingList encountered an exception", ex);
            }
        }
    }
