			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.taxonomias.seleccione"/>">
  								<bean:message key="estructuras.taxonomias.alta.label"/>&nbsp;01:
  							</label>
  						</div>
 					</div>
			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.taxonomias.seleccione"/>">
  								<bean:message key="estructuras.taxonomias.alta.label"/>&nbsp;02:
  							</label>
  						</div>
 					</div>
					<div class="contenedor_derecha_may">
			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.taxonomias.seleccione"/>">
  								<bean:message key="estructuras.taxonomias.alta.label"/>&nbsp;03:
  							</label>
  						</div>
 					</div>
					<div class="contenedor_derecha_may">
			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.taxonomias.seleccione"/>">
  								<bean:message key="estructuras.taxonomias.alta.label"/>&nbsp;04:
  							</label>
  						</div>
 					</div>
					<div class="contenedor_derecha_may">
			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.taxonomias.seleccione"/>">
  								<bean:message key="estructuras.taxonomias.alta.label"/>&nbsp;05:
  							</label>
  						</div>
 					</div>
					<div class="contenedor_derecha_may">
