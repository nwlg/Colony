...
<form id="altaArbolesFormNuevoArbolSubmitForm" 
	action="<html:rewrite action="/AltaArboles/FormNuevoArbolSubmit"/>" method="post" enctype="multipart/form-data">
			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.arboles.seleccione"/>">
  								<bean:message key="estructuras.arboles.alta.label"/>&nbsp;01:
  							</label>
  						</div>
 					</div>
					<div class="contenedor_derecha_may">
						<div class="text">
							<input  name="fichero1"
									...
									type="file" 
									class="selfuente" 
									title="<bean:message key="estructuras.arboles.seleccione"/>"  />
						</div>
					</div>
			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.arboles.seleccione"/>">
  								<bean:message key="estructuras.arboles.alta.label"/>&nbsp;02:
  							</label>
  						</div>
 					</div>
			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.arboles.seleccione"/>">
  								<bean:message key="estructuras.arboles.alta.label"/>&nbsp;03:
  							</label>
  						</div>
 					</div>
			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.arboles.seleccione"/>">
  								<bean:message key="estructuras.arboles.alta.label"/>&nbsp;04:
  							</label>
  						</div>
 					</div>
			...
			<div id="formulario" >
				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda_may">
  						<div class="text">
  							<label for="<bean:message key="estructuras.arboles.seleccione"/>">
  								<bean:message key="estructuras.arboles.alta.label"/>&nbsp;05:
  							</label>
  						</div>
 					</div>
