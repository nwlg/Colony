...
public class ListarUsuariosPendientesFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.adminusuarios.listarUsuariosPendientes.ObtenerUsuariosPendientesForm
{
    ...
    public ListarUsuariosPendientesFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListarUsuariosPendientesFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarUsuariosPendientesFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.adminusuarios.listarUsuariosPendientes.ListarUsuariosPendientesFormImpl#getUsuarios
     */
    ...
    public void setUsuariosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarUsuariosPendientesFormImpl.setUsuariosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarUsuariosPendientesFormImpl.setUsuariosBackingList encountered an exception", ex);
            }
        }
    }
