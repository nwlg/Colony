 ...
 * 
 */
public final class ModificarDosVolver extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final ModificarDosVolverFormImpl specificForm = (ModificarDosVolverFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _obtenerIdentificadores(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.administracion.presentacion.faqs.modificar.ModificarControllerFactory.getModificarControllerInstance().obtenerIdentificadores(mapping, (ModificarDosVolverFormImpl)form, request, response);
