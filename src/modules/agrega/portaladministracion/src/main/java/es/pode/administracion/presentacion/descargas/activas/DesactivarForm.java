 ...
 * <code>desactivar</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.descargas.activas.ActivasController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.descargas.activas.ActivasController#desactivar
 */
public interface DesactivarForm
{
    /**
