...
public class ListarUsuariosInactivosFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.adminusuarios.listarUsuariosInactivos.ObtenerUsuariosInactivosForm
{
    ...
    public ListarUsuariosInactivosFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListarUsuariosInactivosFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarUsuariosInactivosFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.adminusuarios.listarUsuariosInactivos.ListarUsuariosInactivosFormImpl#getUsuarios
     */
    ...
    public void setUsuariosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarUsuariosInactivosFormImpl.setUsuariosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarUsuariosInactivosFormImpl.setUsuariosBackingList encountered an exception", ex);
            }
        }
    }
