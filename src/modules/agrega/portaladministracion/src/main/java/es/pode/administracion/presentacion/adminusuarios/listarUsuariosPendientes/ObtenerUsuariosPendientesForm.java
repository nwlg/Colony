 ...
 * <code>obtenerUsuariosPendientes</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.adminusuarios.listarUsuariosPendientes.ListarUsuariosPendientesController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.adminusuarios.listarUsuariosPendientes.ListarUsuariosPendientesController#obtenerUsuariosPendientes
 */
public interface ObtenerUsuariosPendientesForm
{
    /**
