...
public class FormListarTaxonomiasValidarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.estructuraseducativas.taxonomias.listar.ValidarSeleccionadosForm
{
    ...
    public FormListarTaxonomiasValidarFormImpl()
    {
    }
    ...
    public void setSeleccionadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormListarTaxonomiasValidarFormImpl.setSeleccionadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormListarTaxonomiasValidarFormImpl.setSeleccionadoBackingList encountered an exception", ex);
            }
        }
    }
