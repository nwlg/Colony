...
public class ResultadoModificarGrupoAceptarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ResultadoModificarGrupoAceptarFormImpl()
    {
    }
    ...
    public void setIdModificadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ResultadoModificarGrupoAceptarFormImpl.setIdModificadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ResultadoModificarGrupoAceptarFormImpl.setIdModificadoBackingList encountered an exception", ex);
            }
        }
    }
