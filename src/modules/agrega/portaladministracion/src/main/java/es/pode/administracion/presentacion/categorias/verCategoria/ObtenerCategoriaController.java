 ...
 * 
 */
public abstract class ObtenerCategoriaController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.administracion.presentacion.categorias.verCategoria.ObtieneCategoriaForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void obtieneCategoria(org.apache.struts.action.ActionMapping mapping, es.pode.administracion.presentacion.categorias.verCategoria.ObtieneCategoriaForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvNoticiasServiceInputStream=ObtenerCategoriaController.class.getClassLoader().getResourceAsStream(srvNoticiasServiceFile);
