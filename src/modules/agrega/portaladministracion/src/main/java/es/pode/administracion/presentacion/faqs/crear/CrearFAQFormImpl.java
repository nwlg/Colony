        ...
        , es.pode.administracion.presentacion.faqs.crear.ObtenerCategoriaForm
{
    ...
    public void setCategoriaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CrearFAQFormImpl.setCategoriaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearFAQFormImpl.setCategoriaBackingList encountered an exception", ex);
            }
        }
    }
