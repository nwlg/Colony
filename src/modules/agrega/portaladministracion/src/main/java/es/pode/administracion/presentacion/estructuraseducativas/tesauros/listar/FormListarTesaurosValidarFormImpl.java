...
public class FormListarTesaurosValidarFormImpl
        ...
        , es.pode.administracion.presentacion.estructuraseducativas.tesauros.listar.ValidarSeleccionadosForm
{
    ...
    public FormListarTesaurosValidarFormImpl()
    {
    }
    ...
    public void setSeleccionadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormListarTesaurosValidarFormImpl.setSeleccionadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormListarTesaurosValidarFormImpl.setSeleccionadoBackingList encountered an exception", ex);
            }
        }
    }
