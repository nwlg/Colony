...
public class CrearInformeFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.informes.crearInforme.CargarInformesForm
{
     ...
     *
     * @see es.pode.administracion.presentacion.informes.crearInforme.CrearInformeFormImpl#getInformes
     */
    ...
    public void setInformesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CrearInformeFormImpl.setInformesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearInformeFormImpl.setInformesBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setInformeBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CrearInformeFormImpl.setInformeBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearInformeFormImpl.setInformeBackingList encountered an exception", ex);
            }
        }
    }
