...
public class ListarTareasEjecutadasFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.planificador.listarTareasEjecutadas.ObtenerTrabajosEjecutadosForm
{
    private java.util.List idRowSelection = null;
    private java.lang.Object[] idValueList;
    private java.lang.Object[] idLabelList;
    private java.util.Collection tareasEjecutadas = null;
    private java.lang.Object[] tareasEjecutadasValueList;
    private java.lang.Object[] tareasEjecutadasLabelList;
    ...
    public ListarTareasEjecutadasFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListarTareasEjecutadasFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarTareasEjecutadasFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }

    /**
     * Resets the given <code>tareasEjecutadas</code>.
     */
    public void resetTareasEjecutadas()
    {
        this.tareasEjecutadas = null;
    }

    public void setTareasEjecutadas(java.util.Collection tareasEjecutadas)
    {
     ...
     * 
     */
    public java.util.Collection getTareasEjecutadas()
    {
        return this.tareasEjecutadas;
    }

    public void setTareasEjecutadasAsArray(Object[] tareasEjecutadas)
    {
        this.tareasEjecutadas = (tareasEjecutadas == null) ? null : java.util.Arrays.asList(tareasEjecutadas);
    }
     ...
     *
     * @see es.pode.administracion.presentacion.planificador.listarTareasEjecutadas.ListarTareasEjecutadasFormImpl#getTareasEjecutadas
     */
    public java.lang.Object[] getTareasEjecutadasAsArray()
    {
        return (tareasEjecutadas == null) ? null : tareasEjecutadas.toArray();
    }
    
    public java.lang.Object[] getTareasEjecutadasBackingList()
    {
        java.lang.Object[] values = this.tareasEjecutadasValueList;
        java.lang.Object[] labels = this.tareasEjecutadasLabelList;
    ...
    public java.lang.Object[] getTareasEjecutadasValueList()
    {
        return this.tareasEjecutadasValueList;
    }

    public void setTareasEjecutadasValueList(java.lang.Object[] tareasEjecutadasValueList)
    {
        this.tareasEjecutadasValueList = tareasEjecutadasValueList;
    }

    public java.lang.Object[] getTareasEjecutadasLabelList()
    {
        return this.tareasEjecutadasLabelList;
    }

    public void setTareasEjecutadasLabelList(java.lang.Object[] tareasEjecutadasLabelList)
    {
        this.tareasEjecutadasLabelList = tareasEjecutadasLabelList;
    }

    public void setTareasEjecutadasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarTareasEjecutadasFormImpl.setTareasEjecutadasBackingList requires non-null property arguments");
        }

        this.tareasEjecutadasValueList = null;
        this.tareasEjecutadasLabelList = null;

        if (items != null)
        {
            this.tareasEjecutadasValueList = new java.lang.Object[items.size()];
            this.tareasEjecutadasLabelList = new java.lang.Object[items.size()];
            ...
            try
            {
                ...
                for (java.util.Iterator iterator = items.iterator(); iterator.hasNext(); i++)
                {
                    ...
                    this.tareasEjecutadasValueList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, valueProperty);
                    this.tareasEjecutadasLabelList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, labelProperty);
                }
            }
            catch (Exception ex)
            {
                throw new java.lang.RuntimeException("ListarTareasEjecutadasFormImpl.setTareasEjecutadasBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTrabajoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarTareasEjecutadasFormImpl.setTrabajoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarTareasEjecutadasFormImpl.setTrabajoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setDescripcionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarTareasEjecutadasFormImpl.setDescripcionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarTareasEjecutadasFormImpl.setDescripcionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setFechaFinBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarTareasEjecutadasFormImpl.setFechaFinBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarTareasEjecutadasFormImpl.setFechaFinBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setFechaInicioBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarTareasEjecutadasFormImpl.setFechaInicioBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarTareasEjecutadasFormImpl.setFechaInicioBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public java.lang.String toString()
    {
        ...
        builder.append("tareasEjecutadas", this.tareasEjecutadas);
