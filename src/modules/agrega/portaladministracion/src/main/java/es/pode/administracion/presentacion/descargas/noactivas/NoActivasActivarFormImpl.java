...
public class NoActivasActivarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.descargas.noactivas.ActivarForm
        , es.pode.administracion.presentacion.descargas.noactivas.ObtenerDatosForm
{
    ...
    public NoActivasActivarFormImpl()
    {
    }
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("NoActivasActivarFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NoActivasActivarFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.descargas.noactivas.NoActivasActivarFormImpl#getDescargas
     */
    ...
    public void setDescargasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("NoActivasActivarFormImpl.setDescargasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NoActivasActivarFormImpl.setDescargasBackingList encountered an exception", ex);
            }
        }
    }
