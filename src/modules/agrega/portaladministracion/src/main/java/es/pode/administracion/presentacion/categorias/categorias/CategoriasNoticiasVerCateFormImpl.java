...
public class CategoriasNoticiasVerCateFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public CategoriasNoticiasVerCateFormImpl()
    {
    }
    ...
    public void setIdCategoriaNoticiaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CategoriasNoticiasVerCateFormImpl.setIdCategoriaNoticiaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasNoticiasVerCateFormImpl.setIdCategoriaNoticiaBackingList encountered an exception", ex);
            }
        }
    }
