...
public class ListadoFechasRangoCancelarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ListadoFechasRangoCancelarFormImpl()
    {
    }
     ...
     *
     * @see es.pode.administracion.presentacion.informes.crearInforme.ListadoFechasRangoCancelarFormImpl#getInformes
     */
    ...
    public void setInformesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoFechasRangoCancelarFormImpl.setInformesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoFechasRangoCancelarFormImpl.setInformesBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setInformeBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListadoFechasRangoCancelarFormImpl.setInformeBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoFechasRangoCancelarFormImpl.setInformeBackingList encountered an exception", ex);
            }
        }
    }
