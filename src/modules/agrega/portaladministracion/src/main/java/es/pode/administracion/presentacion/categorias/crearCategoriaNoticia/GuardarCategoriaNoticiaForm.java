 ...
 * <code>guardarCategoriaNoticia</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.categorias.crearCategoriaNoticia.CrearCategoriaNoticiaController</code> controller.
 *
 * <p>
 * Guarda el vo de la categoría noticia en base de datos.
 * </p>
 *
 * @see es.pode.administracion.presentacion.categorias.crearCategoriaNoticia.CrearCategoriaNoticiaController#guardarCategoriaNoticia
 */
public interface GuardarCategoriaNoticiaForm
{
    /**
