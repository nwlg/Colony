 ...
 * <code>crearNoticiaDos</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.noticias.crear.CrearController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.noticias.crear.CrearController#crearNoticiaDos
 */
public interface CrearNoticiaDosForm
{
    /**
