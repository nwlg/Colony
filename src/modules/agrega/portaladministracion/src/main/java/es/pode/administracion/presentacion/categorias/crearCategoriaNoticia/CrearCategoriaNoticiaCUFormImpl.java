...
public class CrearCategoriaNoticiaCUFormImpl
        ...
        , es.pode.administracion.presentacion.categorias.crearCategoriaNoticia.RecuperarDatosForm
{
    ...
    public CrearCategoriaNoticiaCUFormImpl()
    {
    }
     ...
     *
     * @see es.pode.administracion.presentacion.categorias.crearCategoriaNoticia.CrearCategoriaNoticiaCUFormImpl#getNombreCategoria
     */
    ...
    public void setNombreCategoriaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CrearCategoriaNoticiaCUFormImpl.setNombreCategoriaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearCategoriaNoticiaCUFormImpl.setNombreCategoriaBackingList encountered an exception", ex);
            }
        }
    }
     ...
     * will also return <code>null</code>.
     *
     * @see es.pode.administracion.presentacion.categorias.crearCategoriaNoticia.CrearCategoriaNoticiaCUFormImpl#getIdiomas
     */
    ...
    public void setIdiomasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CrearCategoriaNoticiaCUFormImpl.setIdiomasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearCategoriaNoticiaCUFormImpl.setIdiomasBackingList encountered an exception", ex);
            }
        }
    }
