...
public final class MostrarDescripcionVolver extends org.apache.struts.action.Action
{
    ...
    private org.apache.struts.action.ActionForward _cargar(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.administracion.presentacion.planificador.informeTrabajo.InformeControllerFactory.getInformeControllerInstance().obtenerInformeTrabajo(mapping, (MostrarDescripcionVolverFormImpl)form, request, response);
