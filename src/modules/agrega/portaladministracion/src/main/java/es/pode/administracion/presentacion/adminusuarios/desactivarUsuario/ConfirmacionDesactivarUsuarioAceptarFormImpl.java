...
public class ConfirmacionDesactivarUsuarioAceptarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.adminusuarios.desactivarUsuario.DesactivarUsuarioForm
{
    ...
    public ConfirmacionDesactivarUsuarioAceptarFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfirmacionDesactivarUsuarioAceptarFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionDesactivarUsuarioAceptarFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setResultadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionDesactivarUsuarioAceptarFormImpl.setResultadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionDesactivarUsuarioAceptarFormImpl.setResultadoBackingList encountered an exception", ex);
            }
        }
    }
