...
public class NoActivasFormImpl
        ...
        , es.pode.administracion.presentacion.descargas.noactivas.ObtenerDatosForm
{
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("NoActivasFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NoActivasFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.descargas.noactivas.NoActivasFormImpl#getDescargas
     */
    ...
    public void setDescargasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("NoActivasFormImpl.setDescargasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NoActivasFormImpl.setDescargasBackingList encountered an exception", ex);
            }
        }
    }
