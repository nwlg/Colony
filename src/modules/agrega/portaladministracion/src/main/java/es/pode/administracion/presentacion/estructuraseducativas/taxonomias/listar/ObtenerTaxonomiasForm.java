 ...
 * <code>obtenerTaxonomias</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.administracion.presentacion.estructuraseducativas.taxonomias.listar.ListarTaxonomiasController#obtenerTaxonomias
 */
public interface ObtenerTaxonomiasForm
{
    /**
     ...
     * 
     *
     * @see #setTaxonomias#sArray(Object[])
     */
     ...
     * 
     *
     * @see #setTaxonomias(java.util.Collection)
     */
    ...
    /**
     * Resets the <code>taxonomias</code> field.
     */
