...
public class FormularioListadoUsuariosPendientesVerUsuarioPendienteFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public FormularioListadoUsuariosPendientesVerUsuarioPendienteFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioListadoUsuariosPendientesVerUsuarioPendienteFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioListadoUsuariosPendientesVerUsuarioPendienteFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
