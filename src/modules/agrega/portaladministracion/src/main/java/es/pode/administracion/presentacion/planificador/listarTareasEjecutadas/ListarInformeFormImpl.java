...
public class ListarInformeFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListarInformeFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarInformeFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
