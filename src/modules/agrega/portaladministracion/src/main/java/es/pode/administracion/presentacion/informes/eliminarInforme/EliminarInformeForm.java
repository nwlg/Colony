 ...
 * <code>eliminarInforme</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.informes.eliminarInforme.EliminarInformeController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.informes.eliminarInforme.EliminarInformeController#eliminarInforme
 */
public interface EliminarInformeForm
{
    /**
