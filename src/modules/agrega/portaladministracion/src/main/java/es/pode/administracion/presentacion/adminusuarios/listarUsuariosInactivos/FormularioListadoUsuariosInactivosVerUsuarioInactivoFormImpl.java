...
public class FormularioListadoUsuariosInactivosVerUsuarioInactivoFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public FormularioListadoUsuariosInactivosVerUsuarioInactivoFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioListadoUsuariosInactivosVerUsuarioInactivoFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioListadoUsuariosInactivosVerUsuarioInactivoFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
