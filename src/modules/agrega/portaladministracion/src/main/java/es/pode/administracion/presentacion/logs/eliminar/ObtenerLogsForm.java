 ...
 * <code>obtenerLogs</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.logs.eliminar.EliminarLogController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.logs.eliminar.EliminarLogController#obtenerLogs
 */
public interface ObtenerLogsForm
{
    /**
