 ...
 * 
 */
public final class NoActivas extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final NoActivasFormImpl specificForm = (NoActivasFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _obtenerDatos(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.administracion.presentacion.descargas.noactivas.NoActivasControllerFactory.getNoActivasControllerInstance().obtenerDatos(mapping, (NoActivasFormImpl)form, request, response);
