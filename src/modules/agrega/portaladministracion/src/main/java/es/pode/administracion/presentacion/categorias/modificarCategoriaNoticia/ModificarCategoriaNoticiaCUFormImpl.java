...
public class ModificarCategoriaNoticiaCUFormImpl
        ...
        , es.pode.administracion.presentacion.categorias.modificarCategoriaNoticia.RecuperarIdentificadorCategoriaForm
{
    ...
    public ModificarCategoriaNoticiaCUFormImpl()
    {
    }
     ...
     *
     * @see es.pode.administracion.presentacion.categorias.modificarCategoriaNoticia.ModificarCategoriaNoticiaCUFormImpl#getNombreCategoria
     */
    ...
    public void setNombreCategoriaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ModificarCategoriaNoticiaCUFormImpl.setNombreCategoriaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarCategoriaNoticiaCUFormImpl.setNombreCategoriaBackingList encountered an exception", ex);
            }
        }
    }
     ...
     * will also return <code>null</code>.
     *
     * @see es.pode.administracion.presentacion.categorias.modificarCategoriaNoticia.ModificarCategoriaNoticiaCUFormImpl#getIdiomas
     */
    ...
    public void setIdiomasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ModificarCategoriaNoticiaCUFormImpl.setIdiomasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarCategoriaNoticiaCUFormImpl.setIdiomasBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdCategoriaNoticiaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ModificarCategoriaNoticiaCUFormImpl.setIdCategoriaNoticiaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarCategoriaNoticiaCUFormImpl.setIdCategoriaNoticiaBackingList encountered an exception", ex);
            }
        }
    }
