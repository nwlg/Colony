 ...
 * <code>obtenerFaqs</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.faqs.verFaq.VerFaqController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.faqs.verFaq.VerFaqController#obtenerFaqs
 */
public interface ObtenerFaqsForm
{
    /**
