 ...
 * <code>validarFormularioNoDisponibles</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.planificador.modificarTarea.ObtenerTareaController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.planificador.modificarTarea.ObtenerTareaController#validarFormularioNoDisponibles
 */
public interface ValidarFormularioNoDisponiblesForm
{
    /**
