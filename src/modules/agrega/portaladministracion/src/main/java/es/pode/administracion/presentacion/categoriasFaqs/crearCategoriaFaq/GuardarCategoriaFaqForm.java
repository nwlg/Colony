 ...
 * <code>guardarCategoriaFaq</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.CrearCategoriaFaqController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.CrearCategoriaFaqController#guardarCategoriaFaq
 */
public interface GuardarCategoriaFaqForm
{
    /**
