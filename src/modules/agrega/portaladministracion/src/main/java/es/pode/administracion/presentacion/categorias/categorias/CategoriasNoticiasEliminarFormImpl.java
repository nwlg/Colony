...
public class CategoriasNoticiasEliminarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.categorias.categorias.GetIdsForm
{
    ...
    public CategoriasNoticiasEliminarFormImpl()
    {
    }
    ...
    public void setIdCategoriaNoticiaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CategoriasNoticiasEliminarFormImpl.setIdCategoriaNoticiaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasNoticiasEliminarFormImpl.setIdCategoriaNoticiaBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.categorias.categorias.CategoriasNoticiasEliminarFormImpl#getIds
     */
    ...
    public void setIdsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CategoriasNoticiasEliminarFormImpl.setIdsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasNoticiasEliminarFormImpl.setIdsBackingList encountered an exception", ex);
            }
        }
    }
