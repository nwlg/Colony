...
public class CategoriasNoticiasModificarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public CategoriasNoticiasModificarFormImpl()
    {
    }
    ...
    public void setIdCategoriaNoticiaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CategoriasNoticiasModificarFormImpl.setIdCategoriaNoticiaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasNoticiasModificarFormImpl.setIdCategoriaNoticiaBackingList encountered an exception", ex);
            }
        }
    }
