...
public class ListarTareasEnEjecucionFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.planificador.listarTareasEnEjecucion.ObtenerTareasEnEjecucionForm
{
    ...
    private java.util.Collection tareasEnEjecucion = null;
    private java.lang.Object[] tareasEnEjecucionValueList;
    private java.lang.Object[] tareasEnEjecucionLabelList;

    public ListarTareasEnEjecucionFormImpl()
    {
    }
    ...
    public void setTriggerBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListarTareasEnEjecucionFormImpl.setTriggerBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarTareasEnEjecucionFormImpl.setTriggerBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setGrupoTriggerBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarTareasEnEjecucionFormImpl.setGrupoTriggerBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarTareasEnEjecucionFormImpl.setGrupoTriggerBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setGrupoTrabajoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarTareasEnEjecucionFormImpl.setGrupoTrabajoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarTareasEnEjecucionFormImpl.setGrupoTrabajoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTrabajoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarTareasEnEjecucionFormImpl.setTrabajoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarTareasEnEjecucionFormImpl.setTrabajoBackingList encountered an exception", ex);
            }
        }
    }

    /**
     * Resets the given <code>tareasEnEjecucion</code>.
     */
    public void resetTareasEnEjecucion()
    {
        this.tareasEnEjecucion = null;
    }

    public void setTareasEnEjecucion(java.util.Collection tareasEnEjecucion)
    {
        this.tareasEnEjecucion = tareasEnEjecucion;
    }

    /**
     * 
     */
    public java.util.Collection getTareasEnEjecucion()
    {
        return this.tareasEnEjecucion;
    }

    public void setTareasEnEjecucionAsArray(Object[] tareasEnEjecucion)
    {
        this.tareasEnEjecucion = (tareasEnEjecucion == null) ? null : java.util.Arrays.asList(tareasEnEjecucion);
    }
     ...
     *
     * @see es.pode.administracion.presentacion.planificador.listarTareasEnEjecucion.ListarTareasEnEjecucionFormImpl#getTareasEnEjecucion
     */
    public java.lang.Object[] getTareasEnEjecucionAsArray()
    {
        return (tareasEnEjecucion == null) ? null : tareasEnEjecucion.toArray();
    }
    
    public java.lang.Object[] getTareasEnEjecucionBackingList()
    {
        java.lang.Object[] values = this.tareasEnEjecucionValueList;
        java.lang.Object[] labels = this.tareasEnEjecucionLabelList;
    ...
    public java.lang.Object[] getTareasEnEjecucionValueList()
    {
        return this.tareasEnEjecucionValueList;
    }

    public void setTareasEnEjecucionValueList(java.lang.Object[] tareasEnEjecucionValueList)
    {
        this.tareasEnEjecucionValueList = tareasEnEjecucionValueList;
    }

    public java.lang.Object[] getTareasEnEjecucionLabelList()
    {
        return this.tareasEnEjecucionLabelList;
    }

    public void setTareasEnEjecucionLabelList(java.lang.Object[] tareasEnEjecucionLabelList)
    {
        this.tareasEnEjecucionLabelList = tareasEnEjecucionLabelList;
    }

    public void setTareasEnEjecucionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarTareasEnEjecucionFormImpl.setTareasEnEjecucionBackingList requires non-null property arguments");
        }

        this.tareasEnEjecucionValueList = null;
        this.tareasEnEjecucionLabelList = null;

        if (items != null)
        {
            this.tareasEnEjecucionValueList = new java.lang.Object[items.size()];
            this.tareasEnEjecucionLabelList = new java.lang.Object[items.size()];
            ...
            try
            {
                ...
                for (java.util.Iterator iterator = items.iterator(); iterator.hasNext(); i++)
                {
                    ...
                    this.tareasEnEjecucionValueList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, valueProperty);
                    this.tareasEnEjecucionLabelList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, labelProperty);
                }
            }
            catch (Exception ex)
            {
                throw new java.lang.RuntimeException("ListarTareasEnEjecucionFormImpl.setTareasEnEjecucionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public java.lang.String toString()
    {
        ...
        builder.append("tareasEnEjecucion", this.tareasEnEjecucion);
