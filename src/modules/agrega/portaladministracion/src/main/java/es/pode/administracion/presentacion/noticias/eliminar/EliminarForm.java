 ...
 *
 * <p>
 * Eliminar las noticias identificadas por el array de IDs
 * proporcionado.
 * </p>
 *
 * @see es.pode.administracion.presentacion.noticias.eliminar.EliminarController#eliminar
 */
public interface EliminarForm
{
     ...
     * 
     *
     * @see #setNoticiasDeleted#sArray(Object[])
     */
     ...
     * 
     *
     * @see #setNoticiasDeleted(java.util.Collection)
     */
     ...
     * 
     *
     * @see #getNoticiasDeleted()
     */
    public java.lang.Object[] getNoticiasDeletedAsArray();

    /**
     * Resets the <code>noticiasDeleted</code> field.
     */
    public void resetNoticiasDeleted();

    /**
     * The <code>noticiasDeleted</code> field can be selected from a list,
     ...
     *
     * @see #getNoticiasDeleted()
     * @see #getNoticiasDeletedValueList()
     * @see #getNoticiasDeletedLabelList()
     * @see #setNoticiasDeletedLabelList(java.util.Collection,java.lang.String,java.lang.String)
     */
    public java.lang.Object[] getNoticiasDeletedBackingList();

    /**
     * Convenient method to quickly set the value and label backinglist for the
     * noticiasDeleted property. This method takes a collection of objects, as well as
     ...
     * </ul>
     * But you need to populate the noticiasDeleted backing list with the <code>id</code> properties as the values and the
     * <code>name</code> properties as the labels then you would make a call like this:
     * <code>setNoticiasDeletedBackingList(valueObjects, "id", "name")</code>
     * <p/>
     ...
     * @see #getNoticiasDeletedLabelList()
     */
    public void setNoticiasDeletedBackingList(java.util.Collection items, String valueProperty, String labelProperty);
     ...
     *
     * @see #getNoticiasDeleted()
     * @see #getNoticiasDeletedBackingList()
     */
