...
public class FormularioListadoUsuariosInactivosActivarUsuarioFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public FormularioListadoUsuariosInactivosActivarUsuarioFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioListadoUsuariosInactivosActivarUsuarioFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioListadoUsuariosInactivosActivarUsuarioFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
