...
public class DesactivarUsuarioFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.adminusuarios.desactivarUsuario.GetUsuarioForm
{
    ...
    public DesactivarUsuarioFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("DesactivarUsuarioFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DesactivarUsuarioFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setUsuarioBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DesactivarUsuarioFormImpl.setUsuarioBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DesactivarUsuarioFormImpl.setUsuarioBackingList encountered an exception", ex);
            }
        }
    }
