...
public class FormularioListadoUsuariosDesactivarUsuarioFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public FormularioListadoUsuariosDesactivarUsuarioFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioListadoUsuariosDesactivarUsuarioFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioListadoUsuariosDesactivarUsuarioFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
