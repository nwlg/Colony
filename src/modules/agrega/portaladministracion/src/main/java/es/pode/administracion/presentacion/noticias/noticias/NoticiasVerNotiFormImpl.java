...
public class NoticiasVerNotiFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public NoticiasVerNotiFormImpl()
    {
    }
    ...
    public void setIdNoticiaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("NoticiasVerNotiFormImpl.setIdNoticiaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NoticiasVerNotiFormImpl.setIdNoticiaBackingList encountered an exception", ex);
            }
        }
    }
