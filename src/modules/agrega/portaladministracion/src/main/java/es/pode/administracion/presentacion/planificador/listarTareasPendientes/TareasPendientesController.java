 ...
 * 
 */
public abstract class TareasPendientesController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.administracion.presentacion.planificador.listarTareasPendientes.ObtenerTareasPendientesForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void obtenerTareasPendientes(org.apache.struts.action.ActionMapping mapping, es.pode.administracion.presentacion.planificador.listarTareasPendientes.ObtenerTareasPendientesForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvBuscadorServiceInputStream=TareasPendientesController.class.getClassLoader().getResourceAsStream(srvBuscadorServiceFile);
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvPlanificadorServiceInputStream=TareasPendientesController.class.getClassLoader().getResourceAsStream(srvPlanificadorServiceFile);
