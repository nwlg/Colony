 ...
 * 
 */
public abstract class MonitorizarNodosController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.administracion.presentacion.monitorizarnodos.monitorizar.EstadoNodosForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void estadoNodos(org.apache.struts.action.ActionMapping mapping, es.pode.administracion.presentacion.monitorizarnodos.monitorizar.EstadoNodosForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
        this.saveErrorMessage(request, message, null);
			    ...
			    /**
	     * Returns a reference to the srvMonitorizarService imported service.
         * @return es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarService  
         * @throws java.lang.Exception Exception
	     */
	    protected final es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarService getSrvMonitorizarService()
	        throws java.lang.Exception
	    {
            String srvMonitorizarServiceFile="importedServices.properties";	    
	        java.io.InputStream srvMonitorizarServiceInputStream=MonitorizarNodosController.class.getClassLoader().getResourceAsStream(srvMonitorizarServiceFile);
	        java.util.Properties srvMonitorizarServiceProperties = new java.util.Properties();
	        srvMonitorizarServiceProperties.load(srvMonitorizarServiceInputStream);
	        String srvMonitorizarServiceEndPointAddress="";
	        srvMonitorizarServiceEndPointAddress=(String) srvMonitorizarServiceProperties.get("srvMonitorizarServicePort");
            System.out.println("srvMonitorizarServiceEndPointAddress del fichero --> " + srvMonitorizarServiceEndPointAddress);
  			es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarServiceService srvMonitorizarService = new es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarServiceServiceLocator();                                                                                                                                                                                                                                                    
            if (srvMonitorizarServiceEndPointAddress.length()>0) 
				((es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarServiceServiceLocator)srvMonitorizarService).setSrvMonitorizarServiceEndpointAddress(srvMonitorizarServiceEndPointAddress);				
	    	es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarService port = srvMonitorizarService.getSrvMonitorizarService();	    
	        return port;
	    }
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvBuscadorServiceInputStream=MonitorizarNodosController.class.getClassLoader().getResourceAsStream(srvBuscadorServiceFile);
