 ...
 * <code>obtenerInforme</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.informes.eliminarInforme.EliminarInformeController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.informes.eliminarInforme.EliminarInformeController#obtenerInforme
 */
public interface ObtenerInformeForm
{
    /**
