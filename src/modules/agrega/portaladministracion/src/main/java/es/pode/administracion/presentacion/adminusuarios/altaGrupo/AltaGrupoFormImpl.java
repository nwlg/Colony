...
public class AltaGrupoFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public void setDescripcionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("AltaGrupoFormImpl.setDescripcionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("AltaGrupoFormImpl.setDescripcionBackingList encountered an exception", ex);
            }
        }
    }
