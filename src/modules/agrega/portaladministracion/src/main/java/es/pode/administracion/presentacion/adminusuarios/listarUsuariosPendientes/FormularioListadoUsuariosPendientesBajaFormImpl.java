...
public class FormularioListadoUsuariosPendientesBajaFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.adminusuarios.listarUsuariosPendientes.GetIdsPendientesForm
{
    ...
    public FormularioListadoUsuariosPendientesBajaFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioListadoUsuariosPendientesBajaFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioListadoUsuariosPendientesBajaFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.adminusuarios.listarUsuariosPendientes.FormularioListadoUsuariosPendientesBajaFormImpl#getIds
     */
    ...
    public void setIdsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioListadoUsuariosPendientesBajaFormImpl.setIdsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioListadoUsuariosPendientesBajaFormImpl.setIdsBackingList encountered an exception", ex);
            }
        }
    }
