...
public class FormularioResultadoModificacionGrupoAceptarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public FormularioResultadoModificacionGrupoAceptarFormImpl()
    {
    }
    ...
    public void setIdModificadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioResultadoModificacionGrupoAceptarFormImpl.setIdModificadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioResultadoModificacionGrupoAceptarFormImpl.setIdModificadoBackingList encountered an exception", ex);
            }
        }
    }
