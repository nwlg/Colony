...
public class BajaUsuarioFormImpl
        ...
        , es.pode.administracion.presentacion.adminusuarios.bajaUsuario.ObtenerIdiomasForm
{
    ...
    public void setListaIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("BajaUsuarioFormImpl.setListaIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("BajaUsuarioFormImpl.setListaIdBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.adminusuarios.bajaUsuario.BajaUsuarioFormImpl#getIds
     */
    ...
    public void setIdsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("BajaUsuarioFormImpl.setIdsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("BajaUsuarioFormImpl.setIdsBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setUsuariosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("BajaUsuarioFormImpl.setUsuariosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("BajaUsuarioFormImpl.setUsuariosBackingList encountered an exception", ex);
            }
        }
    }
