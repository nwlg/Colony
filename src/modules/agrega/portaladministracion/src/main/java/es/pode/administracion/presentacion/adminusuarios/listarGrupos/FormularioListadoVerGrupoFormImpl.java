...
public class FormularioListadoVerGrupoFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public FormularioListadoVerGrupoFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioListadoVerGrupoFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioListadoVerGrupoFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
