 ...
 * <code>obtenerArboles</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.estructuraseducativas.arboles.listar.ListarArbolesController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.estructuraseducativas.arboles.listar.ListarArbolesController#obtenerArboles
 */
public interface ObtenerArbolesForm
{
    /**
