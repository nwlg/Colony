...
public class CrearCategoriaFaqFormImpl
        ...
        , es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.RecuperarDatosForm
{
    ...
    public CrearCategoriaFaqFormImpl()
    {
    }
     ...
     *
     * @see es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.CrearCategoriaFaqFormImpl#getNombreCategoria
     */
    ...
    public void setNombreCategoriaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CrearCategoriaFaqFormImpl.setNombreCategoriaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearCategoriaFaqFormImpl.setNombreCategoriaBackingList encountered an exception", ex);
            }
        }
    }
     ...
     * will also return <code>null</code>.
     *
     * @see es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.CrearCategoriaFaqFormImpl#getIdiomas
     */
    ...
    public void setIdiomasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CrearCategoriaFaqFormImpl.setIdiomasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearCategoriaFaqFormImpl.setIdiomasBackingList encountered an exception", ex);
            }
        }
    }
