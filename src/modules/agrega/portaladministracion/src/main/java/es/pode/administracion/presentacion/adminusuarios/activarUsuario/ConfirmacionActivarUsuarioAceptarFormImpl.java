...
public class ConfirmacionActivarUsuarioAceptarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.adminusuarios.activarUsuario.ActivarUsuarioForm
{
    ...
    public ConfirmacionActivarUsuarioAceptarFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfirmacionActivarUsuarioAceptarFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionActivarUsuarioAceptarFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setResultadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionActivarUsuarioAceptarFormImpl.setResultadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionActivarUsuarioAceptarFormImpl.setResultadoBackingList encountered an exception", ex);
            }
        }
    }
