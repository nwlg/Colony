 ...
 * 
 */
public final class FormularioListadoEliminarGrupo extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final FormularioListadoEliminarGrupoFormImpl specificForm = (FormularioListadoEliminarGrupoFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _submit(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.administracion.presentacion.adminusuarios.listarGrupos.ListarGruposControllerFactory.getListarGruposControllerInstance().submit(mapping, (FormularioListadoEliminarGrupoFormImpl)form, request, response);
        forward = mapping.findForward("baja.grupo");
    ...
    private org.apache.struts.action.ActionForward _obtenerIdentificadores(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.administracion.presentacion.adminusuarios.listarGrupos.ListarGruposControllerFactory.getListarGruposControllerInstance().obtenerIdentificadores(mapping, (FormularioListadoEliminarGrupoFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.administracion.presentacion.adminusuarios.listarGrupos.ListarGruposControllerFactory.getListarGruposControllerInstance().obtenerIdentificadores(mapping, (FormularioListadoEliminarGrupoFormImpl)form, request, response));

        if (value.equals("vacio"))
        {
            return mapping.findForward("formulario.listado");
        }
