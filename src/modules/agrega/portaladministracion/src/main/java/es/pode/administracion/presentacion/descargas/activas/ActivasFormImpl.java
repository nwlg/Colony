        ...
        , es.pode.administracion.presentacion.descargas.activas.ObtenerDatosForm
{
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ActivasFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ActivasFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.descargas.activas.ActivasFormImpl#getDescargas
     */
    ...
    public void setDescargasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ActivasFormImpl.setDescargasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ActivasFormImpl.setDescargasBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdModificadaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ActivasFormImpl.setIdModificadaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ActivasFormImpl.setIdModificadaBackingList encountered an exception", ex);
            }
        }
    }
