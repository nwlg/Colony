...
public class ListadoFechasCancelarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ListadoFechasCancelarFormImpl()
    {
    }
     ...
     *
     * @see es.pode.administracion.presentacion.informes.crearInforme.ListadoFechasCancelarFormImpl#getInformes
     */
    ...
    public void setInformesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoFechasCancelarFormImpl.setInformesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoFechasCancelarFormImpl.setInformesBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setInformeBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListadoFechasCancelarFormImpl.setInformeBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoFechasCancelarFormImpl.setInformeBackingList encountered an exception", ex);
            }
        }
    }
