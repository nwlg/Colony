...
public class FormularioListadoUsuariosVerUsuarioFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public FormularioListadoUsuariosVerUsuarioFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioListadoUsuariosVerUsuarioFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioListadoUsuariosVerUsuarioFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
