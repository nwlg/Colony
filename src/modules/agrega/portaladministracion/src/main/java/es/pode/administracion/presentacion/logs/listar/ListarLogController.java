 ...
 * 
 */
public abstract class ListarLogController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.administracion.presentacion.logs.listar.ListarLogsForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void listarLogs(org.apache.struts.action.ActionMapping mapping, es.pode.administracion.presentacion.logs.listar.ListarLogsForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.administracion.presentacion.logs.listar.GetLogsForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void getLogs(org.apache.struts.action.ActionMapping mapping, es.pode.administracion.presentacion.logs.listar.GetLogsForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.administracion.presentacion.logs.listar.RecuperarFicheroLogForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void recuperarFicheroLog(org.apache.struts.action.ActionMapping mapping, es.pode.administracion.presentacion.logs.listar.RecuperarFicheroLogForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvBuscadorServiceInputStream=ListarLogController.class.getClassLoader().getResourceAsStream(srvBuscadorServiceFile);
	        ...
	        return port;
			    ...
			    /**
	     * Returns a reference to the srvLogService imported service.
         * @return es.pode.contenidos.negocio.logs.servicio.SrvLogService  
         * @throws java.lang.Exception Exception
	     */
	    protected final es.pode.contenidos.negocio.logs.servicio.SrvLogService getSrvLogService()
	        throws java.lang.Exception
	    {
            String srvLogServiceFile="importedServices.properties";	    
	        java.io.InputStream srvLogServiceInputStream=ListarLogController.class.getClassLoader().getResourceAsStream(srvLogServiceFile);
	        java.util.Properties srvLogServiceProperties = new java.util.Properties();
	        srvLogServiceProperties.load(srvLogServiceInputStream);
	        String srvLogServiceEndPointAddress="";
	        srvLogServiceEndPointAddress=(String) srvLogServiceProperties.get("srvLogServicePort");
            System.out.println("srvLogServiceEndPointAddress del fichero --> " + srvLogServiceEndPointAddress);
  			es.pode.contenidos.negocio.logs.servicio.SrvLogServiceService srvLogService = new es.pode.contenidos.negocio.logs.servicio.SrvLogServiceServiceLocator();                                                                                                                                                                                                                                                    
            if (srvLogServiceEndPointAddress.length()>0) 
				((es.pode.contenidos.negocio.logs.servicio.SrvLogServiceServiceLocator)srvLogService).setSrvLogServiceEndpointAddress(srvLogServiceEndPointAddress);				
	    	es.pode.contenidos.negocio.logs.servicio.SrvLogService port = srvLogService.getSrvLogService();	    
	        return port;
	    }
