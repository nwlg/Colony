 ...
 * 
 */
public final class AltaTesauros extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final AltaTesaurosFormImpl specificForm = (AltaTesaurosFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _cargarDatos(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.administracion.presentacion.estructuraseducativas.tesauros.alta.AltaTesaurosControllerFactory.getAltaTesaurosControllerInstance().obtenerIdiomas(mapping, (AltaTesaurosFormImpl)form, request, response);
