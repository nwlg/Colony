 ...
 * <code>comprobarFinSesionUsuarios</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.informes.crearInforme.CrearInformeController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.informes.crearInforme.CrearInformeController#comprobarFinSesionUsuarios
 */
public interface ComprobarFinSesionUsuariosForm
{
    /**
