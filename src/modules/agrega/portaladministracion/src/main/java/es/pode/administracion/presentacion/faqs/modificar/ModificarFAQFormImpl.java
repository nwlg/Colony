...
public class ModificarFAQFormImpl
        ...
        , es.pode.administracion.presentacion.faqs.modificar.ObtenerIdentificadoresForm
{
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ModificarFAQFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarFAQFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setCategoriaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ModificarFAQFormImpl.setCategoriaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarFAQFormImpl.setCategoriaBackingList encountered an exception", ex);
            }
        }
    }
