...
public class ModificarGrupoFormImpl
        ...
        , es.pode.administracion.presentacion.adminusuarios.modificarGrupo.CargarDescripcionForm
{
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ModificarGrupoFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarGrupoFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setDescripcionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ModificarGrupoFormImpl.setDescripcionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarGrupoFormImpl.setDescripcionBackingList encountered an exception", ex);
            }
        }
    }
