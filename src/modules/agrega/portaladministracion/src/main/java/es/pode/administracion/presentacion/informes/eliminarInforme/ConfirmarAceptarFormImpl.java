...
public class ConfirmarAceptarFormImpl
    ...
    implements java.io.Serializable
        , es.pode.administracion.presentacion.informes.eliminarInforme.EliminarInformeForm
{
    ...
    public void setInformesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfirmarAceptarFormImpl.setInformesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmarAceptarFormImpl.setInformesBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setInformesBorradosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmarAceptarFormImpl.setInformesBorradosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmarAceptarFormImpl.setInformesBorradosBackingList encountered an exception", ex);
            }
        }
    }
