 ...
 * <code>crearFaqDos</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.faqs.crear.CrearController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.faqs.crear.CrearController#crearFaqDos
 */
public interface CrearFaqDosForm
{
    /**
