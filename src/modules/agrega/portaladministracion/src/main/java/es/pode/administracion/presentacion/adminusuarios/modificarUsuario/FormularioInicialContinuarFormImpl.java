...
public class FormularioInicialContinuarFormImpl
    ...
    implements java.io.Serializable
        , es.pode.administracion.presentacion.adminusuarios.modificarUsuario.RecuperarGruposForm
{
    ...
    public void setTipoCatalogadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioInicialContinuarFormImpl.setTipoCatalogadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioInicialContinuarFormImpl.setTipoCatalogadorBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setCuotaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioInicialContinuarFormImpl.setCuotaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioInicialContinuarFormImpl.setCuotaBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.adminusuarios.modificarUsuario.FormularioInicialContinuarFormImpl#getGrupos
     */
