 ...
 * <code>comprobarFinSesionFechas</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.informes.crearInforme.CrearInformeController</code> controller.
 *
 * <p>
 * Comprueba si ha finalizado la sesion del usuario, devolverá una
 * cadena con el valor de TRUE en caso afirmativo
 * </p>
 *
 * @see es.pode.administracion.presentacion.informes.crearInforme.CrearInformeController#comprobarFinSesionFechas
 */
public interface ComprobarFinSesionFechasForm
{
    /**
