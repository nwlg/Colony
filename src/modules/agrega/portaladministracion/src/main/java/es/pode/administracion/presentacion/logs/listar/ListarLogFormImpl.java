        ...
        , es.pode.administracion.presentacion.logs.listar.ListarLogsForm
{
    ...
    public void setNombreBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListarLogFormImpl.setNombreBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarLogFormImpl.setNombreBackingList encountered an exception", ex);
            }
        }
    }
    ...
    {
        this.logs = (logs == null) ? null : java.util.Arrays.asList(logs);
    }
     ...
     *
     * @see es.pode.administracion.presentacion.logs.listar.ListarLogFormImpl#getLogs
     */
    ...
    public void setLogsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarLogFormImpl.setLogsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarLogFormImpl.setLogsBackingList encountered an exception", ex);
            }
        }
    }
