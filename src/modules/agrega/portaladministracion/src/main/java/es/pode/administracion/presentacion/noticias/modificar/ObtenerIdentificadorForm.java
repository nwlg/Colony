 ...
 * <code>obtenerIdentificador</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.noticias.modificar.ModificarController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.noticias.modificar.ModificarController#obtenerIdentificador
 */
public interface ObtenerIdentificadorForm
{
    /**
