...
public class FormularioListadoUsuariosPendientesAltaFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public FormularioListadoUsuariosPendientesAltaFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioListadoUsuariosPendientesAltaFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioListadoUsuariosPendientesAltaFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
