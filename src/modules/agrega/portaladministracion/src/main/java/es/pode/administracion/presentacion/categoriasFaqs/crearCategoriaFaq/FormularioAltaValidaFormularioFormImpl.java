...
public class FormularioAltaValidaFormularioFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.GuardarCategoriaFaqForm
        , es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.RecuperarDatosForm
        , es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.ValidarFormularioForm
        , es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.AnalizaValidacionForm
{
    ...
    public FormularioAltaValidaFormularioFormImpl()
    {
    }
     ...
     *
     * @see es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.FormularioAltaValidaFormularioFormImpl#getNombreCategoria
     */
    ...
    public void setNombreCategoriaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioAltaValidaFormularioFormImpl.setNombreCategoriaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioAltaValidaFormularioFormImpl.setNombreCategoriaBackingList encountered an exception", ex);
            }
        }
    }
     ...
     * will also return <code>null</code>.
     *
     * @see es.pode.administracion.presentacion.categoriasFaqs.crearCategoriaFaq.FormularioAltaValidaFormularioFormImpl#getIdiomas
     */
    ...
    public void setIdiomasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioAltaValidaFormularioFormImpl.setIdiomasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioAltaValidaFormularioFormImpl.setIdiomasBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setValidoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioAltaValidaFormularioFormImpl.setValidoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioAltaValidaFormularioFormImpl.setValidoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdModificadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioAltaValidaFormularioFormImpl.setIdModificadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioAltaValidaFormularioFormImpl.setIdModificadoBackingList encountered an exception", ex);
            }
        }
    }
