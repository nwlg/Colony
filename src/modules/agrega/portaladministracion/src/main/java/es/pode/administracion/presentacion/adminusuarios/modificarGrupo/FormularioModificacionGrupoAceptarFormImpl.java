...
public class FormularioModificacionGrupoAceptarFormImpl
        ...
        , es.pode.administracion.presentacion.adminusuarios.modificarGrupo.ModificarGrupoForm
{
    ...
    public FormularioModificacionGrupoAceptarFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioModificacionGrupoAceptarFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioModificacionGrupoAceptarFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdModificadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioModificacionGrupoAceptarFormImpl.setIdModificadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioModificacionGrupoAceptarFormImpl.setIdModificadoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setResultadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioModificacionGrupoAceptarFormImpl.setResultadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioModificacionGrupoAceptarFormImpl.setResultadoBackingList encountered an exception", ex);
            }
        }
    }
