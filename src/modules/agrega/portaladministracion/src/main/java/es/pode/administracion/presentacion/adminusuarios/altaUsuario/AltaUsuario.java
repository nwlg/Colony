 ...
 * 
 */
public final class AltaUsuario extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final AltaUsuarioFormImpl specificForm = (AltaUsuarioFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _obtenerIdiomas(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.administracion.presentacion.adminusuarios.altaUsuario.AltaUsuarioControllerFactory.getAltaUsuarioControllerInstance().obtenerIdiomas(mapping, (AltaUsuarioFormImpl)form, request, response);
