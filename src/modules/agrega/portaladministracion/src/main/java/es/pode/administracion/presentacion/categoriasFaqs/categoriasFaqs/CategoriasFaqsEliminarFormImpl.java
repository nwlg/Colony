...
public class CategoriasFaqsEliminarFormImpl
        ...
        , es.pode.administracion.presentacion.categoriasFaqs.categoriasFaqs.GetIdsForm
{
    ...
    public CategoriasFaqsEliminarFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CategoriasFaqsEliminarFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFaqsEliminarFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.categoriasFaqs.categoriasFaqs.CategoriasFaqsEliminarFormImpl#getIds
     */
    ...
    public void setIdsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CategoriasFaqsEliminarFormImpl.setIdsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFaqsEliminarFormImpl.setIdsBackingList encountered an exception", ex);
            }
        }
    }
