...
public class ModificarCategoriaFaqFormImpl
        ...
        , es.pode.administracion.presentacion.categoriasFaqs.modificarCategoriaFaq.RecuperarDatosForm
{
    ...
    public ModificarCategoriaFaqFormImpl()
    {
    }
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ModificarCategoriaFaqFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarCategoriaFaqFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.administracion.presentacion.categoriasFaqs.modificarCategoriaFaq.ModificarCategoriaFaqFormImpl#getNombreCategoria
     */
    ...
    public void setNombreCategoriaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ModificarCategoriaFaqFormImpl.setNombreCategoriaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarCategoriaFaqFormImpl.setNombreCategoriaBackingList encountered an exception", ex);
            }
        }
    }
     ...
     * will also return <code>null</code>.
     *
     * @see es.pode.administracion.presentacion.categoriasFaqs.modificarCategoriaFaq.ModificarCategoriaFaqFormImpl#getIdiomas
     */
    ...
    public void setIdiomasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ModificarCategoriaFaqFormImpl.setIdiomasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarCategoriaFaqFormImpl.setIdiomasBackingList encountered an exception", ex);
            }
        }
    }
