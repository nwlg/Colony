 ...
 * <code>modificarFaqUno</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.faqs.modificar.ModificarController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.faqs.modificar.ModificarController#modificarFaqUno
 */
public interface ModificarFaqUnoForm
{
    /**
