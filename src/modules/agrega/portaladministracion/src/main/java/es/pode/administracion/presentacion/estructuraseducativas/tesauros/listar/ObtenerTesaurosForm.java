 ...
 * <code>obtenerTesauros</code> method, which is located on the
 * <code>es.pode.administracion.presentacion.estructuraseducativas.tesauros.listar.ListarTesaurosController</code> controller.
 *
 * 
 *
 * @see es.pode.administracion.presentacion.estructuraseducativas.tesauros.listar.ListarTesaurosController#obtenerTesauros
 */
public interface ObtenerTesaurosForm
{
    /**
     ...
     * 
     *
     * @see #setTesauros(java.util.Collection)
     */
