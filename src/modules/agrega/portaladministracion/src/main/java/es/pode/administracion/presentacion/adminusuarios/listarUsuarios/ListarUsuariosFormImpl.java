...
public class ListarUsuariosFormImpl
        ...
        , es.pode.administracion.presentacion.adminusuarios.listarUsuarios.ObtenerUsuariosForm
{
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListarUsuariosFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarUsuariosFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdModificadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarUsuariosFormImpl.setIdModificadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarUsuariosFormImpl.setIdModificadoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    {
        this.usuarios = (usuarios == null) ? null : java.util.Arrays.asList(usuarios);
    }
     ...
     *
     * @see es.pode.administracion.presentacion.adminusuarios.listarUsuarios.ListarUsuariosFormImpl#getUsuarios
     */
    public java.lang.Object[] getUsuariosAsArray()
    {
        return (usuarios == null) ? null : usuarios.toArray();
    }
    ...
    public void setUsuariosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarUsuariosFormImpl.setUsuariosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarUsuariosFormImpl.setUsuariosBackingList encountered an exception", ex);
            }
        }
    }
