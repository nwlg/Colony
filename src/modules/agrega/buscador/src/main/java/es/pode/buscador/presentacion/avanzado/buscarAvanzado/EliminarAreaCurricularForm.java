 ...
 * <code>eliminarAreaCurricular</code> method, which is located on the
 * <code>es.pode.buscador.presentacion.avanzado.buscarAvanzado.BuscarAvanzadoController</code> controller.
 *
 * <p>
 * Se elimina del formulario el área curricular para que al
 * recargar el formulario no lo muestre.
 * </p>
 *
 * @see es.pode.buscador.presentacion.avanzado.buscarAvanzado.BuscarAvanzadoController#eliminarAreaCurricular
 */
public interface EliminarAreaCurricularForm
{
    /**
