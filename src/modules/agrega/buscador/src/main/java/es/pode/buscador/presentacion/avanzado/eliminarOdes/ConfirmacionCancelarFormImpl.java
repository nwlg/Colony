...
public class ConfirmacionCancelarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ConfirmacionCancelarFormImpl()
    {
    }
    ...
    public void setBusquedaSimpleAvanzadaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfirmacionCancelarFormImpl.setBusquedaSimpleAvanzadaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionCancelarFormImpl.setBusquedaSimpleAvanzadaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionCancelarFormImpl.setIdiomaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionCancelarFormImpl.setIdiomaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setNumeroResultadosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionCancelarFormImpl.setNumeroResultadosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionCancelarFormImpl.setNumeroResultadosBackingList encountered an exception", ex);
            }
        }
    }
