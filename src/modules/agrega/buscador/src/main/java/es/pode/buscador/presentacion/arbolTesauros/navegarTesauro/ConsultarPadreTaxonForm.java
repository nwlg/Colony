 ...
 * <code>consultarPadreTaxon</code> method, which is located on the
 * <code>es.pode.buscador.presentacion.arbolTesauros.navegarTesauro.NavegarTesauroController</code> controller.
 *
 * <p>
 * Este método recopila la información necesaria para mostrar la
 * ruta y los hijos a partir de un identificador de taxón ruta.
 * </p>
 *
 * @see es.pode.buscador.presentacion.arbolTesauros.navegarTesauro.NavegarTesauroController#consultarPadreTaxon
 */
public interface ConsultarPadreTaxonForm
{
    /**
