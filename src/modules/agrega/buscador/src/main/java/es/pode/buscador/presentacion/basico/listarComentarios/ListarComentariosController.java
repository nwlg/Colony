 ...
 * 
 */
public abstract class ListarComentariosController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.buscador.presentacion.basico.listarComentarios.RecuperarComentariosForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void recuperarComentarios(org.apache.struts.action.ActionMapping mapping, es.pode.buscador.presentacion.basico.listarComentarios.RecuperarComentariosForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvValoracionServiceInputStream=ListarComentariosController.class.getClassLoader().getResourceAsStream(srvValoracionServiceFile);
