 ...
 * 
 */
public abstract class AnadirCarpetaPersonalController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.buscador.presentacion.basico.anadirCarpetaPersonal.AnadirODECarpetaPersonalForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void anadirODECarpetaPersonal(org.apache.struts.action.ActionMapping mapping, es.pode.buscador.presentacion.basico.anadirCarpetaPersonal.AnadirODECarpetaPersonalForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvEntregarServiceInputStream=AnadirCarpetaPersonalController.class.getClassLoader().getResourceAsStream(srvEntregarServiceFile);
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvLocalizadorServiceInputStream=AnadirCarpetaPersonalController.class.getClassLoader().getResourceAsStream(srvLocalizadorServiceFile);
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvPublicacionServiceInputStream=AnadirCarpetaPersonalController.class.getClassLoader().getResourceAsStream(srvPublicacionServiceFile);
