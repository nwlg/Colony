...
public final class ListadoODEDecidirSalida extends org.apache.struts.action.Action
{
     ...
     * 
     */
    private org.apache.struts.action.ActionForward _tesauro(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        org.apache.struts.action.ActionForward forward = null;
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.buscador.presentacion.arbolTesauros.listarODETesauro.ListarODETesauroControllerFactory.getListarODETesauroControllerInstance().decidirSalida(mapping, (ListadoODEDecidirSalidaFormImpl)form, request, response));

        if (value.equals("DETALLE_ODE"))
        {
            return _detalleODE(mapping, form, request, response);
        }
        if (value.equals("DETALLE_ODE_FEDERADA"))
        {
            return _detalleFederada(mapping, form, request, response);
        }
        if (value.equals("BUSQUEDA_TESAURO"))
        {
            return _tesauro(mapping, form, request, response);
        }
