 ...
 * <code>insertarComentarioODE</code> method, which is located on the
 * <code>es.pode.buscador.presentacion.basico.introducirComentarios.IntroducirComentariosController</code> controller.
 *
 * <p>
 * Insertamos un comentario para el ODE.
 * </p>
 *
 * @see es.pode.buscador.presentacion.basico.introducirComentarios.IntroducirComentariosController#insertarComentarioODE
 */
public interface InsertarComentarioODEForm
{
    /**
