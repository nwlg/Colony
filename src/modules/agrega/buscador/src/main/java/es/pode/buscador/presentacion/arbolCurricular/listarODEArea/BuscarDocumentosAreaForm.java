 ...
 * <code>buscarDocumentosArea</code> method, which is located on the
 ...
 * que se ha configurado en el buscador por árbol curricular de la
 * aplicación.
 * </p>
 * <p>
 ...
 * </p>
 *
 * @see es.pode.buscador.presentacion.arbolCurricular.listarODEArea.ListarODEAreaController#buscarDocumentosArea
 */
public interface BuscarDocumentosAreaForm
{
    /**
    ...
    /**
     * Sets the <code>esHoja</code> field.
     *
     * 
     */
    ...
    /**
     * Gets the <code>esHoja</code> field.
     *
     * 
     */
    ...
    /**
     * Resets the <code>esHoja</code> field.
     */
