 ...
 * <code>consultarId</code> method, which is located on the
 ...
 * ruta y los hijos a partir de un identificador de taxón hijo.
 * </p>
 *
 * @see es.pode.buscador.presentacion.arbolTesauros.navegarTesauro.NavegarTesauroController#consultarId
 */
public interface ConsultarIdForm
{
    /**
