 ...
 * <code>recuperarSeleccionIds</code> method, which is located on the
 * <code>es.pode.buscador.presentacion.basico.introducirComentarios.IntroducirComentariosController</code> controller.
 *
 * <p>
 * Recuperar la selección de los identificadores de los
 * comentarios que se van a eliminar
 * </p>
 *
 * @see es.pode.buscador.presentacion.basico.introducirComentarios.IntroducirComentariosController#recuperarSeleccionIds
 */
public interface RecuperarSeleccionIdsForm
{
    /**
