 ...
 * <code>descargarFicheroODE</code> method, which is located on the
 * <code>es.pode.buscador.presentacion.basico.descargar.DescargarController</code> controller.
 *
 * <p>
 * Este metodo realiza la descarga del fichero PIF del ODE. Tiene
 * que invocar al servicio de entregar para que le suministre el
 * fichero y despues devolverlo por http. Ver ejemplo en
 * documentacion de ibuilder.
 * </p>
 *
 * @see es.pode.buscador.presentacion.basico.descargar.DescargarController#descargarFicheroODE
 */
public interface DescargarFicheroODEForm
{
    /**
