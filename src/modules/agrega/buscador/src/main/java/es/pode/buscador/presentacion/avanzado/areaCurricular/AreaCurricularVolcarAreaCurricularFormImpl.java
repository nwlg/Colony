...
public class AreaCurricularVolcarAreaCurricularFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.buscador.presentacion.avanzado.areaCurricular.VolcarAreaCurricularSesionForm
{
    ...
    public AreaCurricularVolcarAreaCurricularFormImpl()
    {
    }
    ...
    public void setAreaCurricularBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("AreaCurricularVolcarAreaCurricularFormImpl.setAreaCurricularBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("AreaCurricularVolcarAreaCurricularFormImpl.setAreaCurricularBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTipoLayoutBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("AreaCurricularVolcarAreaCurricularFormImpl.setTipoLayoutBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("AreaCurricularVolcarAreaCurricularFormImpl.setTipoLayoutBuscadorBackingList encountered an exception", ex);
            }
        }
    }
