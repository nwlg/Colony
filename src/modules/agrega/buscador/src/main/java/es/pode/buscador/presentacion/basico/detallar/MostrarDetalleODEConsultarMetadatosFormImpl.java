...
public class MostrarDetalleODEConsultarMetadatosFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.buscador.presentacion.basico.detallar.CargarMetadatosCatalogadorForm
{
    ...
    public MostrarDetalleODEConsultarMetadatosFormImpl()
    {
    }
    ...
    public void setIdentificadorODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("MostrarDetalleODEConsultarMetadatosFormImpl.setIdentificadorODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarDetalleODEConsultarMetadatosFormImpl.setIdentificadorODEBackingList encountered an exception", ex);
            }
        }
    }
