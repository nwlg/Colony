 ...
 * <code>cargaFormularioBusquedaAvanzada</code> method, which is located on the
 * <code>es.pode.buscador.presentacion.avanzado.buscarAvanzado.BuscarAvanzadoController</code> controller.
 *
 * <p>
 * Este metodo carga todos los datos necesarios en la pantalla de
 * busqueda avanzada.
 * </p>
 * <p>
 * Utiliza la sesion para recoger la informacion que se ha
 * seleccionado para la busqueda avanzada.
 * </p>
 *
 * @see es.pode.buscador.presentacion.avanzado.buscarAvanzado.BuscarAvanzadoController#cargaFormularioBusquedaAvanzada
 */
public interface CargaFormularioBusquedaAvanzadaForm
{
    /**
