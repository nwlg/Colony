 ...
 *
 * <p>
 * Determina si la pulsacion ha sido aceptar o cancelar. Al aceptar
 * se elimina la lista de comentarios; y al cancelar se vuelve a la
 * lista original. Devuelve el valor del botón pulsado
 * (aceptar/cancelar)
 * </p>
 *
 * @see es.pode.buscador.presentacion.basico.introducirComentarios.IntroducirComentariosController#analizaPulsacion
 */
