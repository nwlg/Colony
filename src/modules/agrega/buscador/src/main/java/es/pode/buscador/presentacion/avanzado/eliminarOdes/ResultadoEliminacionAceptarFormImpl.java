...
public class ResultadoEliminacionAceptarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ResultadoEliminacionAceptarFormImpl()
    {
    }
    ...
    public void setBusquedaSimpleAvanzadaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ResultadoEliminacionAceptarFormImpl.setBusquedaSimpleAvanzadaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ResultadoEliminacionAceptarFormImpl.setBusquedaSimpleAvanzadaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ResultadoEliminacionAceptarFormImpl.setIdiomaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ResultadoEliminacionAceptarFormImpl.setIdiomaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setNumeroResultadosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ResultadoEliminacionAceptarFormImpl.setNumeroResultadosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ResultadoEliminacionAceptarFormImpl.setNumeroResultadosBackingList encountered an exception", ex);
            }
        }
    }
