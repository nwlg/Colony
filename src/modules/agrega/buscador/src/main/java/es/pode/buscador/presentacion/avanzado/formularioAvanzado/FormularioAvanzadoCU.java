 ...
 * 
 */
public final class FormularioAvanzadoCU extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final FormularioAvanzadoCUFormImpl specificForm = (FormularioAvanzadoCUFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _prepararConsulta(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.buscador.presentacion.avanzado.formularioAvanzado.FormularioAvanzadoControllerFactory.getFormularioAvanzadoControllerInstance().prepararConsulta(mapping, (FormularioAvanzadoCUFormImpl)form, request, response);
