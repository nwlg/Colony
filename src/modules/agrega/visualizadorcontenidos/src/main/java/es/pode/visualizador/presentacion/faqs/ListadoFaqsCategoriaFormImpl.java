...
public class ListadoFaqsCategoriaFormImpl
        ...
        , es.pode.visualizador.presentacion.faqs.CargaFaqsForm
{
    ...
    public ListadoFaqsCategoriaFormImpl()
    {
    }
    ...
    public void setCategoriaSeleccionadaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoFaqsCategoriaFormImpl.setCategoriaSeleccionadaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoFaqsCategoriaFormImpl.setCategoriaSeleccionadaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setFaqsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListadoFaqsCategoriaFormImpl.setFaqsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoFaqsCategoriaFormImpl.setFaqsBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.visualizador.presentacion.faqs.ListadoFaqsCategoriaFormImpl#getCategorias
     */
    ...
    public void setCategoriasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListadoFaqsCategoriaFormImpl.setCategoriasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoFaqsCategoriaFormImpl.setCategoriasBackingList encountered an exception", ex);
            }
        }
    }
