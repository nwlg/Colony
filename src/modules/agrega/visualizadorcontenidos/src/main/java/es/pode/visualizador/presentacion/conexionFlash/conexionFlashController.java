 ...
 * 
 */
public abstract class conexionFlashController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.visualizador.presentacion.conexionFlash.ConstruirXMLForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void construirXML(org.apache.struts.action.ActionMapping mapping, es.pode.visualizador.presentacion.conexionFlash.ConstruirXMLForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvBuscarServiceInputStream=conexionFlashController.class.getClassLoader().getResourceAsStream(srvBuscarServiceFile);
