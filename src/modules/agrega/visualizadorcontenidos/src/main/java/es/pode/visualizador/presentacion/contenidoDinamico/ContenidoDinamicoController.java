 ...
 * 
 */
public abstract class ContenidoDinamicoController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.visualizador.presentacion.contenidoDinamico.ObtenerContenidoDinamicoForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void obtenerContenidoDinamico(org.apache.struts.action.ActionMapping mapping, es.pode.visualizador.presentacion.contenidoDinamico.ObtenerContenidoDinamicoForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
        this.saveErrorMessage(request, message, null);
			    ...
			    /**
	     * Returns a reference to the srvGeneracionDinamicaService imported service.
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvGeneracionDinamicaServiceInputStream=ContenidoDinamicoController.class.getClassLoader().getResourceAsStream(srvGeneracionDinamicaServiceFile);
            ...
            System.out.println("srvGeneracionDinamicaServiceEndPointAddress del fichero --> " + srvGeneracionDinamicaServiceEndPointAddress);
