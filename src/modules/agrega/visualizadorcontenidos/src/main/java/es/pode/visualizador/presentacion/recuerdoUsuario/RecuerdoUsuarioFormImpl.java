...
public class RecuerdoUsuarioFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public RecuerdoUsuarioFormImpl()
    {
    }
    ...
    public void setNifBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("RecuerdoUsuarioFormImpl.setNifBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("RecuerdoUsuarioFormImpl.setNifBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setEmailBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("RecuerdoUsuarioFormImpl.setEmailBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("RecuerdoUsuarioFormImpl.setEmailBackingList encountered an exception", ex);
            }
        }
    }
