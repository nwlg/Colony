        ...
        , es.pode.visualizador.presentacion.descargas.ListadoDescargasForm
{
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("DescargasFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DescargasFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.visualizador.presentacion.descargas.DescargasFormImpl#getDescargas
     */
    ...
    public void setDescargasBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DescargasFormImpl.setDescargasBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DescargasFormImpl.setDescargasBackingList encountered an exception", ex);
            }
        }
    }
