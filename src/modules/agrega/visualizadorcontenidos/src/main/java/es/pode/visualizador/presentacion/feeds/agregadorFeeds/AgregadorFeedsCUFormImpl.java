...
public class AgregadorFeedsCUFormImpl
        ...
        , es.pode.visualizador.presentacion.feeds.agregadorFeeds.ObtenerFeedsForm
{
    ...
    public AgregadorFeedsCUFormImpl()
    {
    }
    ...
    public void setFeedsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("AgregadorFeedsCUFormImpl.setFeedsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("AgregadorFeedsCUFormImpl.setFeedsBackingList encountered an exception", ex);
            }
        }
    }
