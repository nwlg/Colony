 ...
 * 
 */
public final class ListadoFaqsCategoria extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final ListadoFaqsCategoriaFormImpl specificForm = (ListadoFaqsCategoriaFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _cargaFaqs(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.visualizador.presentacion.faqs.FaqsControllerFactory.getFaqsControllerInstance().cargaFaqs(mapping, (ListadoFaqsCategoriaFormImpl)form, request, response);
