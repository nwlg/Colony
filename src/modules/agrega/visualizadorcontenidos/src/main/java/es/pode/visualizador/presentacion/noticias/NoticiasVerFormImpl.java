...
public class NoticiasVerFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public void setIdBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("NoticiasVerFormImpl.setIdBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("NoticiasVerFormImpl.setIdBackingList encountered an exception", ex);
            }
        }
    }
