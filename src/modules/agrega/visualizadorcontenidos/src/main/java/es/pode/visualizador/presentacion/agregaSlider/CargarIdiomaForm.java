 ...
 * <code>cargarIdioma</code> method, which is located on the
 * <code>es.pode.visualizador.presentacion.agregaSlider.AgregaSliderController</code> controller.
 *
 * 
 *
 * @see es.pode.visualizador.presentacion.agregaSlider.AgregaSliderController#cargarIdioma
 */
public interface CargarIdiomaForm
{
    /**
