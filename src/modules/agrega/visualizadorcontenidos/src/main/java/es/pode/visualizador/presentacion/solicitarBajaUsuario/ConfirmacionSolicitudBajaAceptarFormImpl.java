...
public class ConfirmacionSolicitudBajaAceptarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.visualizador.presentacion.solicitarBajaUsuario.EnviarCorreoBajaForm
{
    ...
    public ConfirmacionSolicitudBajaAceptarFormImpl()
    {
    }
    ...
    public void setResultadoEnvioBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfirmacionSolicitudBajaAceptarFormImpl.setResultadoEnvioBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionSolicitudBajaAceptarFormImpl.setResultadoEnvioBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setUsuarioBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionSolicitudBajaAceptarFormImpl.setUsuarioBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionSolicitudBajaAceptarFormImpl.setUsuarioBackingList encountered an exception", ex);
            }
        }
    }
