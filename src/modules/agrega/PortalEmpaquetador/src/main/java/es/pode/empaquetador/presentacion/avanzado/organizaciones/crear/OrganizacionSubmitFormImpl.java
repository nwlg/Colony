...
public class OrganizacionSubmitFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.avanzado.organizaciones.crear.SubmitForm
        , es.pode.empaquetador.presentacion.avanzado.organizaciones.crear.TerminarCreacionForm
        , es.pode.empaquetador.presentacion.avanzado.organizaciones.crear.CrearOrganizacionForm
        , es.pode.empaquetador.presentacion.avanzado.organizaciones.crear.SelectActionForm
{
    ...
    public OrganizacionSubmitFormImpl()
    {
    }
    ...
    public void setTitleBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("OrganizacionSubmitFormImpl.setTitleBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("OrganizacionSubmitFormImpl.setTitleBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("OrganizacionSubmitFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("OrganizacionSubmitFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
