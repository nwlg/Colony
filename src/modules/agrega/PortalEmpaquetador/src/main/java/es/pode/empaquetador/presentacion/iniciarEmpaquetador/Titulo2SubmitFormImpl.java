...
public class Titulo2SubmitFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.CrearLomesInicialForm
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.RedirectForm
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.CrearSesionForm
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.SelectActionEditarForm
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.EsAvanzadoForm
{
    ...
    public void setTituloBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("Titulo2SubmitFormImpl.setTituloBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("Titulo2SubmitFormImpl.setTituloBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setOdeBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("Titulo2SubmitFormImpl.setOdeBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("Titulo2SubmitFormImpl.setOdeBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("Titulo2SubmitFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("Titulo2SubmitFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("Titulo2SubmitFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("Titulo2SubmitFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
