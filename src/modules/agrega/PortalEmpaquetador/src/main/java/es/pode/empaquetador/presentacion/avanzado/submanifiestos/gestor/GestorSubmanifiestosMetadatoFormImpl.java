...
public class GestorSubmanifiestosMetadatoFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public GestorSubmanifiestosMetadatoFormImpl()
    {
    }
    ...
    public void setIdentifierBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GestorSubmanifiestosMetadatoFormImpl.setIdentifierBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorSubmanifiestosMetadatoFormImpl.setIdentifierBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setReturnURLBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("GestorSubmanifiestosMetadatoFormImpl.setReturnURLBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorSubmanifiestosMetadatoFormImpl.setReturnURLBackingList encountered an exception", ex);
            }
        }
    }
