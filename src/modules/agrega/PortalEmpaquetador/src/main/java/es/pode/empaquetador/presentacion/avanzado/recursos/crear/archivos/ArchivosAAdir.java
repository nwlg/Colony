 ...
 * 
 */
public final class ArchivosAAdir extends org.apache.struts.action.Action
{
    ...
    private org.apache.struts.action.ActionForward _aceptar(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.avanzado.recursos.crear.archivos.CrearRecursoAvanzadoArchivosControllerFactory.getCrearRecursoAvanzadoArchivosControllerInstance().terminarSeleccionArchivos(mapping, new TerminarSeleccionArchivosForm(){}, request, response);
        forward = _cancelar(mapping, form, request, response);
    ...
    private org.apache.struts.action.ActionForward _cancelar(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        // we pass an empty form implementation to the controller, we know there are no parameters on this operation because the
        // cartridge would have issued a model validation error
        es.pode.empaquetador.presentacion.avanzado.recursos.crear.archivos.CrearRecursoAvanzadoArchivosControllerFactory.getCrearRecursoAvanzadoArchivosControllerInstance().cancelar(mapping, new CancelarForm(){}, request, response);
