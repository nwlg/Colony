        ...
        , es.pode.empaquetador.presentacion.avanzado.recursos.eliminar.EliminarForm
{
     ...
     *
     * @see es.pode.empaquetador.presentacion.avanzado.recursos.eliminar.AdvertenciaAceptarFormImpl#getRecursosVO
     */
    ...
    public void setRecursosVOBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("AdvertenciaAceptarFormImpl.setRecursosVOBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("AdvertenciaAceptarFormImpl.setRecursosVOBackingList encountered an exception", ex);
            }
        }
    }
