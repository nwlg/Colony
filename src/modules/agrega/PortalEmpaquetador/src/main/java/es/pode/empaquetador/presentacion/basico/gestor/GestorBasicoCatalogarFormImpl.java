...
public class GestorBasicoCatalogarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public GestorBasicoCatalogarFormImpl()
    {
    }
    ...
    public void setIdentifierBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GestorBasicoCatalogarFormImpl.setIdentifierBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorBasicoCatalogarFormImpl.setIdentifierBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setReturnURLBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("GestorBasicoCatalogarFormImpl.setReturnURLBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorBasicoCatalogarFormImpl.setReturnURLBackingList encountered an exception", ex);
            }
        }
    }
