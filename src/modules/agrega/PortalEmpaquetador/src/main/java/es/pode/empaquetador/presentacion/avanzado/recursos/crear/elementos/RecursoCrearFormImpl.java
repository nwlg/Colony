...
public class RecursoCrearFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.avanzado.recursos.crear.elementos.TerminarSesionForm
        , es.pode.empaquetador.presentacion.avanzado.recursos.crear.elementos.CrearRecursoForm
        , es.pode.empaquetador.presentacion.avanzado.recursos.crear.elementos.SubmitForm
        , es.pode.empaquetador.presentacion.avanzado.recursos.crear.elementos.SelectActionCrearForm
{
    private java.lang.String action;
    private java.lang.Object[] actionValueList;
    private java.lang.Object[] actionLabelList;

    public RecursoCrearFormImpl()
    {
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("RecursoCrearFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("RecursoCrearFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
