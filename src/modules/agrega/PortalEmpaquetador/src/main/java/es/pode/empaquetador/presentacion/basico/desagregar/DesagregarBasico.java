 ...
 * 
 */
public final class DesagregarBasico extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final DesagregarBasicoFormImpl specificForm = (DesagregarBasicoFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _local(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.basico.desagregar.DesagregarBasicoControllerFactory.getDesagregarBasicoControllerInstance().desagregarLocal(mapping, (DesagregarBasicoFormImpl)form, request, response);
        forward = null;
    ...
    private org.apache.struts.action.ActionForward _crearSesion(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.basico.desagregar.DesagregarBasicoControllerFactory.getDesagregarBasicoControllerInstance().crearSesion(mapping, (DesagregarBasicoFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.empaquetador.presentacion.basico.desagregar.DesagregarBasicoControllerFactory.getDesagregarBasicoControllerInstance().esOffline(mapping, (DesagregarBasicoFormImpl)form, request, response));
