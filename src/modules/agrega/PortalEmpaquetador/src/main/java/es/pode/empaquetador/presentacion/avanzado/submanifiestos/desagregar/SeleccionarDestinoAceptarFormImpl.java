...
public class SeleccionarDestinoAceptarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.avanzado.submanifiestos.desagregar.DesagregarLocalForm
        , es.pode.empaquetador.presentacion.avanzado.submanifiestos.desagregar.SubmitForm
        , es.pode.empaquetador.presentacion.avanzado.submanifiestos.desagregar.BorrarObjetoSesionForm
        , es.pode.empaquetador.presentacion.avanzado.submanifiestos.desagregar.DesagregarPersonalesForm
        , es.pode.empaquetador.presentacion.avanzado.submanifiestos.desagregar.SelectActionForm
{
    ...
    public SeleccionarDestinoAceptarFormImpl()
    {
    }
    ...
    public void setDestinoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("SeleccionarDestinoAceptarFormImpl.setDestinoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarDestinoAceptarFormImpl.setDestinoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarDestinoAceptarFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarDestinoAceptarFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
