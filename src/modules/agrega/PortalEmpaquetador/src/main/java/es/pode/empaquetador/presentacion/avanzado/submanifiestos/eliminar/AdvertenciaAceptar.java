 ...
 * 
 */
public final class AdvertenciaAceptar extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final AdvertenciaAceptarFormImpl specificForm = (AdvertenciaAceptarFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _eliminar(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.avanzado.submanifiestos.eliminar.EliminarSubmanifiestosControllerFactory.getEliminarSubmanifiestosControllerInstance().eliminar(mapping, (AdvertenciaAceptarFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _borrarObjetoSesion(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.avanzado.submanifiestos.eliminar.EliminarSubmanifiestosControllerFactory.getEliminarSubmanifiestosControllerInstance().borrarObjetoSesion(mapping, (AdvertenciaAceptarFormImpl)form, request, response);
