...
public class EliminarSubmanifiestosFormImpl
    ...
    implements java.io.Serializable
        ...
        , es.pode.empaquetador.presentacion.avanzado.submanifiestos.eliminar.RecuperarDatosForm
        , es.pode.empaquetador.presentacion.avanzado.submanifiestos.eliminar.HayReferenciasForm
{
    ...
    public EliminarSubmanifiestosFormImpl()
    {
    }
     ...
     *
     * @see es.pode.empaquetador.presentacion.avanzado.submanifiestos.eliminar.EliminarSubmanifiestosFormImpl#getIdentificadores
     */
    ...
    public void setIdentificadoresBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("EliminarSubmanifiestosFormImpl.setIdentificadoresBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("EliminarSubmanifiestosFormImpl.setIdentificadoresBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("EliminarSubmanifiestosFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("EliminarSubmanifiestosFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
