...
public class SeleccionarSubmitFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.basico.asociar.BorrarSesionForm
        , es.pode.empaquetador.presentacion.basico.asociar.RecuperaURLForm
        , es.pode.empaquetador.presentacion.basico.asociar.RecuperarObjectForm
        , es.pode.empaquetador.presentacion.basico.asociar.SeleccionarForm
{
    ...
    public SeleccionarSubmitFormImpl()
    {
    }
    ...
    public void setTextoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("SeleccionarSubmitFormImpl.setTextoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarSubmitFormImpl.setTextoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTipoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarSubmitFormImpl.setTipoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarSubmitFormImpl.setTipoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarSubmitFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarSubmitFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setUrlBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarSubmitFormImpl.setUrlBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarSubmitFormImpl.setUrlBackingList encountered an exception", ex);
            }
        }
    }
