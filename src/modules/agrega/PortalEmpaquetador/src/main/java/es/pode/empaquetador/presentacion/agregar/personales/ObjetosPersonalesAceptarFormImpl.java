...
public class ObjetosPersonalesAceptarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.agregar.personales.AgregarForm
        , es.pode.empaquetador.presentacion.agregar.personales.SubmitForm
        , es.pode.empaquetador.presentacion.agregar.personales.TipoEmpaquetadorForm
        , es.pode.empaquetador.presentacion.agregar.personales.SelectActionForm
{
    ...
    public ObjetosPersonalesAceptarFormImpl()
    {
    }
    ...
    public void setIdODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ObjetosPersonalesAceptarFormImpl.setIdODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPersonalesAceptarFormImpl.setIdODEBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ObjetosPersonalesAceptarFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPersonalesAceptarFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
