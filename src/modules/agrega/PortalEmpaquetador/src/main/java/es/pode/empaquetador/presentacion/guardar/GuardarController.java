 ...
 * 
 */
public abstract class GuardarController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.empaquetador.presentacion.guardar.GuardarForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void guardar(org.apache.struts.action.ActionMapping mapping, es.pode.empaquetador.presentacion.guardar.GuardarForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvGestorManifestServiceInputStream=GuardarController.class.getClassLoader().getResourceAsStream(srvGestorManifestServiceFile);
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvGestorArchivosServiceInputStream=GuardarController.class.getClassLoader().getResourceAsStream(srvGestorArchivosServiceFile);
