...
public class GestorBasicoRenombrarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public GestorBasicoRenombrarFormImpl()
    {
    }
    ...
    public void setEsModificarBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GestorBasicoRenombrarFormImpl.setEsModificarBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorBasicoRenombrarFormImpl.setEsModificarBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdentifierBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("GestorBasicoRenombrarFormImpl.setIdentifierBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorBasicoRenombrarFormImpl.setIdentifierBackingList encountered an exception", ex);
            }
        }
    }
