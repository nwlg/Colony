...
public class GestorBasicoPrincipalFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public GestorBasicoPrincipalFormImpl()
    {
    }
    ...
    public void setIdentifierBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GestorBasicoPrincipalFormImpl.setIdentifierBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorBasicoPrincipalFormImpl.setIdentifierBackingList encountered an exception", ex);
            }
        }
    }
