 ...
 * 
 */
public final class GestorBasicoVaciarPortapapeles extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final GestorBasicoVaciarPortapapelesFormImpl specificForm = (GestorBasicoVaciarPortapapelesFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _recuperarDatos(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.basico.gestor.GestorBasicoControllerFactory.getGestorBasicoControllerInstance().recuperarDatos(mapping, (GestorBasicoVaciarPortapapelesFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _vaciarPortapapeles(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.basico.gestor.GestorBasicoControllerFactory.getGestorBasicoControllerInstance().vaciarPortapapeles(mapping, (GestorBasicoVaciarPortapapelesFormImpl)form, request, response);
