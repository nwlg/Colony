...
public class EliminarRecursosFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.avanzado.recursos.eliminar.EliminarForm
        , es.pode.empaquetador.presentacion.avanzado.recursos.eliminar.HayReferenciasForm
{
    ...
    public EliminarRecursosFormImpl()
    {
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("EliminarRecursosFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("EliminarRecursosFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.empaquetador.presentacion.avanzado.recursos.eliminar.EliminarRecursosFormImpl#getRecursosVO
     */
    ...
    public void setRecursosVOBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("EliminarRecursosFormImpl.setRecursosVOBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("EliminarRecursosFormImpl.setRecursosVOBackingList encountered an exception", ex);
            }
        }
    }
