 ...
 * 
 */
public abstract class ModificarArchivoController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.empaquetador.presentacion.archivos.modificar.ModificarForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void modificar(org.apache.struts.action.ActionMapping mapping, es.pode.empaquetador.presentacion.archivos.modificar.ModificarForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvGestorArchivosServiceInputStream=ModificarArchivoController.class.getClassLoader().getResourceAsStream(srvGestorArchivosServiceFile);
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvEmpaquetadorBasicoServiceInputStream=ModificarArchivoController.class.getClassLoader().getResourceAsStream(srvEmpaquetadorBasicoServiceFile);
