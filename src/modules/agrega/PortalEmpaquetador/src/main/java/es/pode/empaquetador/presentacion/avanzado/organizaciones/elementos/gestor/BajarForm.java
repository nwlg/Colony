 ...
 * <code>bajar</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.empaquetador.presentacion.avanzado.organizaciones.elementos.gestor.GestorElementosController#bajar
 */
public interface BajarForm
{
    /**
