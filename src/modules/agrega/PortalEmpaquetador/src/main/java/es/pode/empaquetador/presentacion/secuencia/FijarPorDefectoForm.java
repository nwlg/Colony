 ...
 * <code>fijarPorDefecto</code> method, which is located on the
 * <code>es.pode.empaquetador.presentacion.secuencia.SecuenciaController</code> controller.
 *
 * 
 *
 * @see es.pode.empaquetador.presentacion.secuencia.SecuenciaController#fijarPorDefecto
 */
public interface FijarPorDefectoForm
{
    /**
