 ...
 * 
 */
public abstract class ExportarRecursosController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void exportar(org.apache.struts.action.ActionMapping mapping, es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.empaquetador.presentacion.avanzado.recursos.exportar.SelectActionForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     * @return java.lang.String
     */
    public abstract java.lang.String selectAction(org.apache.struts.action.ActionMapping mapping, es.pode.empaquetador.presentacion.avanzado.recursos.exportar.SelectActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.empaquetador.presentacion.avanzado.recursos.exportar.CrearSesionForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void crearSesion(org.apache.struts.action.ActionMapping mapping, es.pode.empaquetador.presentacion.avanzado.recursos.exportar.CrearSesionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
     ...
     *
     * @param mapping org.apache.struts.action.ActionMapping          
     * @param form es.pode.empaquetador.presentacion.avanzado.recursos.exportar.TerminarSesionForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void terminarSesion(org.apache.struts.action.ActionMapping mapping, es.pode.empaquetador.presentacion.avanzado.recursos.exportar.TerminarSesionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    /**
     * Returns the current ExportarRecursosSession from the session found in the argument request.
     * <p/>
     * In case an object was found in the session but it was not of the correct type, this method
     * will return <code>null</code>.
     * <p/>
     ...
     *
     * @param request javax.servlet.http.HttpServletRequest          
     * @return es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession
     */
    protected final es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession getExportarRecursosSession(javax.servlet.http.HttpServletRequest request)
    {
        es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession object = null;
        javax.servlet.http.HttpSession session = request.getSession(true);

        Object attribute = session.getAttribute(es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession.SESSION_KEY);
        if (attribute instanceof es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession)
        {
            object = (es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession)attribute;
        }
        else if (attribute == null)
        {
            object = new es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession ();
            setExportarRecursosSession(request, object);
        }
    ...
    /**
     * Set the argument ExportarRecursosSession object in the session corresponding with the argument request.
     * In case the session would not exist it will be created.
     *
     * @param request javax.servlet.http.HttpServletRequest 
     * @param object es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession                          
     */
    protected final void setExportarRecursosSession(javax.servlet.http.HttpServletRequest request, es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession object)
    {
        setExportarRecursosSession(request, object, true);
    }
     ...
     * @param object es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession             
     */
    protected final void setExportarRecursosSession(javax.servlet.http.HttpServletRequest request, es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession object, boolean createSession)
    {
        javax.servlet.http.HttpSession session = request.getSession(createSession);
        if (session != null)
        {
            session.setAttribute(es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession.SESSION_KEY, object);
        }
    }

    /**
     * Removes the argument ExportarRecursosSession object from the session corresponding with the argument request.
     * In any of the following cases this method will do nothing:
     * <ul>
     *   <li>No session corresponds to the argument request</li>
     *   <li>No ExportarRecursosSession object could be found in the request</li>
     *   <li>The object is not of the correct type</li>
     * </ul>
     * @param request javax.servlet.http.HttpServletRequest            
     */
    protected final void removeExportarRecursosSession(javax.servlet.http.HttpServletRequest request)
    {
        javax.servlet.http.HttpSession session = request.getSession(false);
        if (session != null)
        {
            ...
            if (attribute instanceof es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession)
            {
                session.removeAttribute(es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarRecursosSession.SESSION_KEY);
            }
        }
    }
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvGestorManifestServiceInputStream=ExportarRecursosController.class.getClassLoader().getResourceAsStream(srvGestorManifestServiceFile);
