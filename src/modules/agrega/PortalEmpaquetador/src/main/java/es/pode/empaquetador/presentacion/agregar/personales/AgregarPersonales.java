 ...
 * 
 */
public final class AgregarPersonales extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final AgregarPersonalesFormImpl specificForm = (AgregarPersonalesFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _recuperarDatos(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.agregar.personales.AgregarPersonalesControllerFactory.getAgregarPersonalesControllerInstance().recuperarDatos(mapping, (AgregarPersonalesFormImpl)form, request, response);
        forward = mapping.findForward("objetos.personales");
