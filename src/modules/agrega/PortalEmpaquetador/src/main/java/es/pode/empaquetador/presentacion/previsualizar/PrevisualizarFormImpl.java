...
public class PrevisualizarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.previsualizar.PrevisualizarForm
        , es.pode.empaquetador.presentacion.previsualizar.TieneSecuenciaForm
{
    ...
    public void setTipoVisualizadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("PrevisualizarFormImpl.setTipoVisualizadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("PrevisualizarFormImpl.setTipoVisualizadorBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("PrevisualizarFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("PrevisualizarFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
