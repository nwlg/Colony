...
public class FormularioExportarSelectActionFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.avanzado.recursos.exportar.ExportarForm
        , es.pode.empaquetador.presentacion.avanzado.recursos.exportar.TerminarSesionForm
        , es.pode.empaquetador.presentacion.avanzado.recursos.exportar.SelectActionForm
{
    ...
    public FormularioExportarSelectActionFormImpl()
    {
    }
    ...
    public void setDestinoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("FormularioExportarSelectActionFormImpl.setDestinoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioExportarSelectActionFormImpl.setDestinoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setNombreBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioExportarSelectActionFormImpl.setNombreBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioExportarSelectActionFormImpl.setNombreBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioExportarSelectActionFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioExportarSelectActionFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.empaquetador.presentacion.avanzado.recursos.exportar.FormularioExportarSelectActionFormImpl#getRecursosVO
     */
    ...
    public void setRecursosVOBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("FormularioExportarSelectActionFormImpl.setRecursosVOBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("FormularioExportarSelectActionFormImpl.setRecursosVOBackingList encountered an exception", ex);
            }
        }
    }
