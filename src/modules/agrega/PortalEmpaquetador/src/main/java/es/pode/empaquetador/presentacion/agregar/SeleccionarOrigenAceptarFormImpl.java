...
public class SeleccionarOrigenAceptarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.agregar.TipoEmpaquetadorForm
        , es.pode.empaquetador.presentacion.agregar.SeleccionarOrigenForm
{
    ...
    public SeleccionarOrigenAceptarFormImpl()
    {
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("SeleccionarOrigenAceptarFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarOrigenAceptarFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setOrigenBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("SeleccionarOrigenAceptarFormImpl.setOrigenBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("SeleccionarOrigenAceptarFormImpl.setOrigenBackingList encountered an exception", ex);
            }
        }
    }
