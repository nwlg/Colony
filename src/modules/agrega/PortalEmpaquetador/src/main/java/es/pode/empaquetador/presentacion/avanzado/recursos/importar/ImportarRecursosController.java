 ...
 * 
 */
public abstract class ImportarRecursosController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.empaquetador.presentacion.avanzado.recursos.importar.ImportarZIPForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void importarZIP(org.apache.struts.action.ActionMapping mapping, es.pode.empaquetador.presentacion.avanzado.recursos.importar.ImportarZIPForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvGestorManifestServiceInputStream=ImportarRecursosController.class.getClassLoader().getResourceAsStream(srvGestorManifestServiceFile);
