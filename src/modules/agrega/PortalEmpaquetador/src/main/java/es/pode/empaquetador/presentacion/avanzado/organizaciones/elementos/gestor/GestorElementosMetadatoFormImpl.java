...
public class GestorElementosMetadatoFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public GestorElementosMetadatoFormImpl()
    {
    }
    ...
    public void setIdentifierBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GestorElementosMetadatoFormImpl.setIdentifierBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorElementosMetadatoFormImpl.setIdentifierBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setReturnURLBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("GestorElementosMetadatoFormImpl.setReturnURLBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorElementosMetadatoFormImpl.setReturnURLBackingList encountered an exception", ex);
            }
        }
    }
