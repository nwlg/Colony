        ...
        , es.pode.empaquetador.presentacion.guardar.GuardarForm
{
    ...
    public void setReturnURLBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GuardarFormImpl.setReturnURLBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GuardarFormImpl.setReturnURLBackingList encountered an exception", ex);
            }
        }
    }
