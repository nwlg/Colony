...
public class ArchivosArchivosFormImpl
        ...
        , es.pode.empaquetador.presentacion.basico.asociar.archivos.BorrarSesionForm
{
    ...
    public ArchivosArchivosFormImpl()
    {
    }
    ...
    public void setIdentifierBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ArchivosArchivosFormImpl.setIdentifierBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ArchivosArchivosFormImpl.setIdentifierBackingList encountered an exception", ex);
            }
        }
    }
