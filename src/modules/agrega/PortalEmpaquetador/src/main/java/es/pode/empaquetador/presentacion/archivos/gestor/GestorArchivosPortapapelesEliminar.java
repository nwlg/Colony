 ...
 * 
 */
public final class GestorArchivosPortapapelesEliminar extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final GestorArchivosPortapapelesEliminarFormImpl specificForm = (GestorArchivosPortapapelesEliminarFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _eliminarPortapapeles(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.archivos.gestor.GestorArchivosControllerFactory.getGestorArchivosControllerInstance().eliminarDePortapapeles(mapping, (GestorArchivosPortapapelesEliminarFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _cargarDatos(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.archivos.gestor.GestorArchivosControllerFactory.getGestorArchivosControllerInstance().cargarDatos(mapping, (GestorArchivosPortapapelesEliminarFormImpl)form, request, response);
