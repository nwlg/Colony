...
public class DestinoSubmitFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.basico.desagregar.DesagregarLocalForm
        , es.pode.empaquetador.presentacion.basico.desagregar.DesagregarPersonalesForm
        , es.pode.empaquetador.presentacion.basico.desagregar.BorrarObjetoSesionForm
        , es.pode.empaquetador.presentacion.basico.desagregar.SelectActionForm
{
    ...
    public void setDestinoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("DestinoSubmitFormImpl.setDestinoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DestinoSubmitFormImpl.setDestinoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DestinoSubmitFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DestinoSubmitFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
