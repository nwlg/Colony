...
public class GestorBasicoAsociarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public GestorBasicoAsociarFormImpl()
    {
    }
    ...
    public void setIdentifierBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GestorBasicoAsociarFormImpl.setIdentifierBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorBasicoAsociarFormImpl.setIdentifierBackingList encountered an exception", ex);
            }
        }
    }
