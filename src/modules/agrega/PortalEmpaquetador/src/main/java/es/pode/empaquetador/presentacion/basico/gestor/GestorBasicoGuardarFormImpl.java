...
public class GestorBasicoGuardarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public GestorBasicoGuardarFormImpl()
    {
    }
    ...
    public void setReturnURLBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GestorBasicoGuardarFormImpl.setReturnURLBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorBasicoGuardarFormImpl.setReturnURLBackingList encountered an exception", ex);
            }
        }
    }
