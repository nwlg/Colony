...
public class CrearCarpetaAceptarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.archivos.crearcarpeta.CrearCarpetaForm
{
    ...
    public CrearCarpetaAceptarFormImpl()
    {
    }
    ...
    public void setNombreBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CrearCarpetaAceptarFormImpl.setNombreBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearCarpetaAceptarFormImpl.setNombreBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CrearCarpetaAceptarFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CrearCarpetaAceptarFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
