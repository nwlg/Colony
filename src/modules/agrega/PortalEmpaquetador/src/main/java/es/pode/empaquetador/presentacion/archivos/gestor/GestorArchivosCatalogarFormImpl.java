...
public class GestorArchivosCatalogarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public GestorArchivosCatalogarFormImpl()
    {
    }
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GestorArchivosCatalogarFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorArchivosCatalogarFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setReturnURLBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("GestorArchivosCatalogarFormImpl.setReturnURLBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GestorArchivosCatalogarFormImpl.setReturnURLBackingList encountered an exception", ex);
            }
        }
    }
