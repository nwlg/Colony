 ...
 * 
 */
public final class GestorRecursosSubmit extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final GestorRecursosSubmitFormImpl specificForm = (GestorRecursosSubmitFormImpl)form;
    ...
    {
        org.apache.struts.action.ActionForward forward = null;
        forward = mapping.findForward("eliminar.recursos");
        return forward;
    }

    /**
     * <p>
     * Actividad fantasma para forzar el pase del parametro recursosVO.
     * </p>
     */
    ...
    {
        org.apache.struts.action.ActionForward forward = null;
        forward = mapping.findForward("exportar.recursos.avanzado");
        return forward;
    }
    ...
    private org.apache.struts.action.ActionForward _submit(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.avanzado.recursos.gestor.GestorRecursosControllerFactory.getGestorRecursosControllerInstance().submit(mapping, (GestorRecursosSubmitFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.empaquetador.presentacion.avanzado.recursos.gestor.GestorRecursosControllerFactory.getGestorRecursosControllerInstance().selectAction(mapping, (GestorRecursosSubmitFormImpl)form, request, response));
        ...
        {
            return mapping.findForward("importar.recursos");
        }
