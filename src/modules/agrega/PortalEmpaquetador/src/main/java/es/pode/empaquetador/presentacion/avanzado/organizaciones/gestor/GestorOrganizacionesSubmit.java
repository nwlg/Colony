 ...
 * 
 */
public final class GestorOrganizacionesSubmit extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final GestorOrganizacionesSubmitFormImpl specificForm = (GestorOrganizacionesSubmitFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _cargarDatos(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.avanzado.organizaciones.gestor.GestorOrganizacionesControllerFactory.getGestorOrganizacionesControllerInstance().cargarDatos(mapping, (GestorOrganizacionesSubmitFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _submit(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.avanzado.organizaciones.gestor.GestorOrganizacionesControllerFactory.getGestorOrganizacionesControllerInstance().submit(mapping, (GestorOrganizacionesSubmitFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _eliminar(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.avanzado.organizaciones.gestor.GestorOrganizacionesControllerFactory.getGestorOrganizacionesControllerInstance().eliminar(mapping, (GestorOrganizacionesSubmitFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.empaquetador.presentacion.avanzado.organizaciones.gestor.GestorOrganizacionesControllerFactory.getGestorOrganizacionesControllerInstance().selectAction(mapping, (GestorOrganizacionesSubmitFormImpl)form, request, response));
        ...
        {
            return mapping.findForward("crear.organizacion");
        }
        if (value.equals("Principal"))
        {
            return mapping.findForward("organizacion.principal");
        }
