 ...
 * <code>comprobarReferencias</code> method, which is located on the
 * <code>es.pode.empaquetador.presentacion.archivos.gestor.GestorArchivosController</code> controller.
 *
 * 
 *
 * @see es.pode.empaquetador.presentacion.archivos.gestor.GestorArchivosController#comprobarReferencias
 */
public interface ComprobarReferenciasForm
{
    /**
