 ...
 * 
 */
public final class TipoRecursoContinuar extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final TipoRecursoContinuarFormImpl specificForm = (TipoRecursoContinuarFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _submit(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.avanzado.recursos.crear.tipo.CrearRecursoAvanzadoTipoControllerFactory.getCrearRecursoAvanzadoTipoControllerInstance().submit(mapping, (TipoRecursoContinuarFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _destruirSesion(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.empaquetador.presentacion.avanzado.recursos.crear.tipo.CrearRecursoAvanzadoTipoControllerFactory.getCrearRecursoAvanzadoTipoControllerInstance().destruirSesion(mapping, (TipoRecursoContinuarFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.empaquetador.presentacion.avanzado.recursos.crear.tipo.CrearRecursoAvanzadoTipoControllerFactory.getCrearRecursoAvanzadoTipoControllerInstance().selectAction(mapping, (TipoRecursoContinuarFormImpl)form, request, response));
