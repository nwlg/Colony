...
public class TituloSubmitFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.RedirectForm
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.CrearOdeForm
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.CrearSesionForm
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.SelectActionForm
        , es.pode.empaquetador.presentacion.iniciarEmpaquetador.EsAvanzadoForm
{
    ...
    public void setTituloBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("TituloSubmitFormImpl.setTituloBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("TituloSubmitFormImpl.setTituloBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setOdeBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("TituloSubmitFormImpl.setOdeBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("TituloSubmitFormImpl.setOdeBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setActionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("TituloSubmitFormImpl.setActionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("TituloSubmitFormImpl.setActionBackingList encountered an exception", ex);
            }
        }
    }
