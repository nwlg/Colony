...
public class ListadoTagsModificarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ListadoTagsModificarFormImpl()
    {
    }
    ...
    public void setTagBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoTagsModificarFormImpl.setTagBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoTagsModificarFormImpl.setTagBackingList encountered an exception", ex);
            }
        }
    }
