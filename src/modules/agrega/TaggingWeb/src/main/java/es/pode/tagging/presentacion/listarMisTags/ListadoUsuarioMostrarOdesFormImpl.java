...
public class ListadoUsuarioMostrarOdesFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ListadoUsuarioMostrarOdesFormImpl()
    {
    }
    ...
    public void setTagBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoUsuarioMostrarOdesFormImpl.setTagBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoUsuarioMostrarOdesFormImpl.setTagBackingList encountered an exception", ex);
            }
        }
    }
