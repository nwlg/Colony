...
public class ListarMisTagsFormImpl
        ...
        , es.pode.tagging.presentacion.listarMisTags.ObtenerMisTagsForm
{
    ...
    public void setTagBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListarMisTagsFormImpl.setTagBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarMisTagsFormImpl.setTagBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.tagging.presentacion.listarMisTags.ListarMisTagsFormImpl#getMisTags
     */
    ...
    public void setMisTagsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListarMisTagsFormImpl.setMisTagsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListarMisTagsFormImpl.setMisTagsBackingList encountered an exception", ex);
            }
        }
    }
