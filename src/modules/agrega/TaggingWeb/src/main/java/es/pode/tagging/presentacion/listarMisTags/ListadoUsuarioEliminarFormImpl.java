...
public class ListadoUsuarioEliminarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.tagging.presentacion.listarMisTags.SubmitForm
{
    ...
    public ListadoUsuarioEliminarFormImpl()
    {
    }
     ...
     *
     * @see es.pode.tagging.presentacion.listarMisTags.ListadoUsuarioEliminarFormImpl#getTagsEliminar
     */
    ...
    public void setTagsEliminarBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoUsuarioEliminarFormImpl.setTagsEliminarBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoUsuarioEliminarFormImpl.setTagsEliminarBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTagBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListadoUsuarioEliminarFormImpl.setTagBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoUsuarioEliminarFormImpl.setTagBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setAccionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ListadoUsuarioEliminarFormImpl.setAccionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoUsuarioEliminarFormImpl.setAccionBackingList encountered an exception", ex);
            }
        }
    }
