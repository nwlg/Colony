 ...
 * <code>obtenerOdes</code> method, which is located on the
 * <code>es.pode.tagging.presentacion.adminTag.mostrarOdes.MostrarOdesController</code> controller.
 *
 * 
 *
 * @see es.pode.tagging.presentacion.adminTag.mostrarOdes.MostrarOdesController#obtenerOdes
 */
public interface ObtenerOdesForm
{
    /**
