...
public class MostrarOdesMisTagsFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.tagging.presentacion.mostrarOdesMisTags.ObtenerOdesTagForm
{
    ...
    public MostrarOdesMisTagsFormImpl()
    {
    }
    ...
    public void setTagBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("MostrarOdesMisTagsFormImpl.setTagBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarOdesMisTagsFormImpl.setTagBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.tagging.presentacion.mostrarOdesMisTags.MostrarOdesMisTagsFormImpl#getOdes
     */
    ...
    public void setOdesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarOdesMisTagsFormImpl.setOdesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarOdesMisTagsFormImpl.setOdesBackingList encountered an exception", ex);
            }
        }
    }
