...
public class ListadoMostrarOdesAgregaFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ListadoMostrarOdesAgregaFormImpl()
    {
    }
    ...
    public void setTagBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoMostrarOdesAgregaFormImpl.setTagBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoMostrarOdesAgregaFormImpl.setTagBackingList encountered an exception", ex);
            }
        }
    }
