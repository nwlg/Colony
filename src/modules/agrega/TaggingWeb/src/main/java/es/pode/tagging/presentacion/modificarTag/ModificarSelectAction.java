...
public final class ModificarSelectAction extends org.apache.struts.action.Action
{
    ...
    private org.apache.struts.action.ActionForward _modificarTag(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.tagging.presentacion.modificarTag.ModificarTagControllerFactory.getModificarTagControllerInstance().modificarTag(mapping, (ModificarSelectActionFormImpl)form, request, response);
        forward = mapping.findForward("listar.mis.tags");
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.tagging.presentacion.modificarTag.ModificarTagControllerFactory.getModificarTagControllerInstance().selectAction(mapping, (ModificarSelectActionFormImpl)form, request, response));
