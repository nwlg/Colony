...
public class MostrarOdesAgregaTagsFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.tagging.presentacion.mostrarOdesAgregaTags.ObtenerOdesTagForm
{
    ...
    public MostrarOdesAgregaTagsFormImpl()
    {
    }
    ...
    public void setEsAnonimoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("MostrarOdesAgregaTagsFormImpl.setEsAnonimoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarOdesAgregaTagsFormImpl.setEsAnonimoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTagBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarOdesAgregaTagsFormImpl.setTagBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarOdesAgregaTagsFormImpl.setTagBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTipoLayoutBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarOdesAgregaTagsFormImpl.setTipoLayoutBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarOdesAgregaTagsFormImpl.setTipoLayoutBuscadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.tagging.presentacion.mostrarOdesAgregaTags.MostrarOdesAgregaTagsFormImpl#getOdes
     */
    ...
    public void setOdesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarOdesAgregaTagsFormImpl.setOdesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarOdesAgregaTagsFormImpl.setOdesBackingList encountered an exception", ex);
            }
        }
    }
