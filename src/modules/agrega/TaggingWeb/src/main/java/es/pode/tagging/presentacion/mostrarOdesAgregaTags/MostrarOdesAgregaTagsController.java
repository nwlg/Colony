 ...
 * 
 */
public abstract class MostrarOdesAgregaTagsController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.tagging.presentacion.mostrarOdesAgregaTags.ObtenerOdesTagForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void obtenerOdesTag(org.apache.struts.action.ActionMapping mapping, es.pode.tagging.presentacion.mostrarOdesAgregaTags.ObtenerOdesTagForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvTaggingServerInputStream=MostrarOdesAgregaTagsController.class.getClassLoader().getResourceAsStream(srvTaggingServerFile);
