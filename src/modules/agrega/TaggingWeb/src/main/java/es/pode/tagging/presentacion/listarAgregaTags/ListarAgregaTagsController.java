 ...
 * 
 */
public abstract class ListarAgregaTagsController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.tagging.presentacion.listarAgregaTags.ObtenerAgregaTagsForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void obtenerAgregaTags(org.apache.struts.action.ActionMapping mapping, es.pode.tagging.presentacion.listarAgregaTags.ObtenerAgregaTagsForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvTaggingServerInputStream=ListarAgregaTagsController.class.getClassLoader().getResourceAsStream(srvTaggingServerFile);
