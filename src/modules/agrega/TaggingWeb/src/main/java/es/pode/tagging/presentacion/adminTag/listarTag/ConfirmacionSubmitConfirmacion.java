...
public final class ConfirmacionSubmitConfirmacion extends org.apache.struts.action.Action
{
    ...
    private org.apache.struts.action.ActionForward _eliminarTags(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.tagging.presentacion.adminTag.listarTag.ListarTagControllerFactory.getListarTagControllerInstance().eliminar(mapping, (ConfirmacionSubmitConfirmacionFormImpl)form, request, response);
    ...
    private org.apache.struts.action.ActionForward _obtenerTag(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.tagging.presentacion.adminTag.listarTag.ListarTagControllerFactory.getListarTagControllerInstance().obtenerTags(mapping, (ConfirmacionSubmitConfirmacionFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.tagging.presentacion.adminTag.listarTag.ListarTagControllerFactory.getListarTagControllerInstance().submitConfirmacion(mapping, (ConfirmacionSubmitConfirmacionFormImpl)form, request, response));
        ...
        {
            return _obtenerTag(mapping, form, request, response);
        }
