...
public class ModificarSelectActionFormImpl
    ...
    implements java.io.Serializable
        , es.pode.tagging.presentacion.modificarTag.ModificarTagForm
        , es.pode.tagging.presentacion.modificarTag.SelectActionForm
{
    ...
    public void setTagBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ModificarSelectActionFormImpl.setTagBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ModificarSelectActionFormImpl.setTagBackingList encountered an exception", ex);
            }
        }
    }
