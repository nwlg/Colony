...
public class ListadoTagsMostrarOdesFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ListadoTagsMostrarOdesFormImpl()
    {
    }
    ...
    public void setTagBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ListadoTagsMostrarOdesFormImpl.setTagBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ListadoTagsMostrarOdesFormImpl.setTagBackingList encountered an exception", ex);
            }
        }
    }
