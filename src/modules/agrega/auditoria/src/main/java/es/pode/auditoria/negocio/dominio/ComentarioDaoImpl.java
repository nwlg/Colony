...
public class ComentarioDaoImpl
    extends es.pode.auditoria.negocio.dominio.ComentarioDaoBase
{
    /**
     * @see es.pode.auditoria.negocio.dominio.ComentarioDao#toComentarioVO(es.pode.auditoria.negocio.dominio.Comentario)
     */
    public es.pode.auditoria.negocio.servicios.ComentarioVO toComentarioVO(final es.pode.auditoria.negocio.dominio.Comentario entity)
    {
        //default mapping between entity and VO
        //@todo verify or customize behaviour of this mapping
        return (es.pode.auditoria.negocio.servicios.ComentarioVO)
                  this.getBeanMapper().map(entity, es.pode.auditoria.negocio.servicios.ComentarioVO.class, DEF_MAPPING_COMENTARIO_COMENTARIOVO);
    }
	 ...
	 * @see es.pode.auditoria.negocio.dominio.ComentarioDao#fromComentarioVO(es.pode.auditoria.negocio.servicios.ComentarioVO)
	 */
	 ...
	 * @see es.pode.auditoria.negocio.dominio.ComentarioDao#fromComentarioVO(es.pode.auditoria.negocio.servicios.ComentarioVO ,es.pode.auditoria.negocio.dominio.Comentario)
	 */
