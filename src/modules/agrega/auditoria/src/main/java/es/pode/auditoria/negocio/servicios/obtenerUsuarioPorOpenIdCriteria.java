...
/**
 * <p>
 * Criterio para obtener el usuario pasandole el openId
 * </p>
 */
public class obtenerUsuarioPorOpenIdCriteria
    implements java.io.Serializable
{

    public obtenerUsuarioPorOpenIdCriteria()
    {
    }
    ...
    /**
     * Copies constructor from other obtenerUsuarioPorOpenIdCriteria
     */
    public obtenerUsuarioPorOpenIdCriteria(obtenerUsuarioPorOpenIdCriteria otherBean)
    {
        if (otherBean != null)
        {
