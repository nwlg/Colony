...
public interface UsuarioDao
{
     ...
     * {@link es.pode.auditoria.negocio.servicios.UsuarioVO}.
     */
    public final static int TRANSFORM_USUARIOVO = 1;
    
    
    /**
     * Converts this DAO's entity to an object of type {@link es.pode.auditoria.negocio.servicios.UsuarioVO}.
     */
    public es.pode.auditoria.negocio.servicios.UsuarioVO toUsuarioVO(es.pode.auditoria.negocio.dominio.Usuario entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link es.pode.auditoria.negocio.servicios.UsuarioVO}.
     */
    public void toUsuarioVOCollection(java.util.Collection entities);

    public es.pode.auditoria.negocio.dominio.Usuario fromUsuarioVO(es.pode.auditoria.negocio.servicios.UsuarioVO vo);
    ...
    /**
     * Loads an instance of es.pode.auditoria.negocio.dominio.Usuario from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link es.pode.auditoria.negocio.dominio.Usuario}.
     * 
    ...
    /**
     * Creates an instance of es.pode.auditoria.negocio.dominio.Usuario and adds it to the persistent store.
     */
    public es.pode.auditoria.negocio.dominio.Usuario create(es.pode.auditoria.negocio.dominio.Usuario usuario);

    /**
     * <p>
     *   Does the same thing as {@link #create(es.pode.auditoria.negocio.dominio.Usuario)} with an
     *   additional flag called <code>transform</code>.  If this flag is set to <code>TRANSFORM_NONE</code> then
     *   the returned entity will <strong>NOT</strong> be transformed.  If this flag is any of the other constants
     *   defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     *   transform the entity (into a value object for example).  By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, es.pode.auditoria.negocio.dominio.Usuario usuario);

    /**
     * Creates a new instance of es.pode.auditoria.negocio.dominio.Usuario and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of es.pode.auditoria.negocio.dominio.Usuario
     *        instances to create.
     *
    ...
    /**
     * <p>
     *   Creates a new <code>es.pode.auditoria.negocio.dominio.Usuario</code>
    ...
    /**
     * Removes the instance of es.pode.auditoria.negocio.dominio.Usuario from the persistent store.
     */
    public void remove(es.pode.auditoria.negocio.dominio.Usuario usuario);

    /**
     * Removes the instance of es.pode.auditoria.negocio.dominio.Usuario having the given
     ...
     * </p>
     */
    public es.pode.auditoria.negocio.dominio.Usuario obtenerDatosUsuario(String queryString, java.lang.String usuario);
     ...
     * </p>
     */
    public es.pode.auditoria.negocio.dominio.Usuario obtenerUsuario(String queryString, java.lang.String NIF);
    ...
    /**
     * <p>
     *   Does the same thing as {@link #obtenerUsuariosPorOpenId(es.pode.auditoria.negocio.servicios.obtenerUsuarioPorOpenIdCriteria)} with an
     *   additional flag called <code>transform</code>.  If this flag is set to <code>TRANSFORM_NONE</code> then
     *   finder results will <strong>NOT</strong> be transformed during retrieval.
     *   If this flag is any of the other constants defined here
     *   then finder results <strong>WILL BE</strong> passed through an operation which can optionally
