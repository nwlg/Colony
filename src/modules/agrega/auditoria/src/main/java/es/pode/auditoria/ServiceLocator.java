...
public class ServiceLocator
{
     ...
     */
    private final String DEFAULT_BEAN_REFERENCE_LOCATION = "beanRefFactory_auditoria.xml";
     ...
     */
    public final es.pode.auditoria.negocio.servicios.SrvAuditoriaServicio getSrvAuditoriaServicio()
    {
        return (es.pode.auditoria.negocio.servicios.SrvAuditoriaServicio)
            getContext().getBean("srvAuditoriaServicio");
    }

    /**
     * Gets an instance of {@link es.pode.auditoria.negocio.servicios.SrvAuditoriaFederadaServicio}.
     */
    public final es.pode.auditoria.negocio.servicios.SrvAuditoriaFederadaServicio getSrvAuditoriaFederadaServicio()
    {
        return (es.pode.auditoria.negocio.servicios.SrvAuditoriaFederadaServicio)
            getContext().getBean("srvAuditoriaFederadaServicio");
    }


    /**
     * Gets an instance of {@link es.pode.auditoria.negocio.servicios.jms.SrvAuditoriaRecibirServicio}.
     */
    public final es.pode.auditoria.negocio.servicios.jms.SrvAuditoriaRecibirServicio getSrvAuditoriaRecibirServicio()
    {
        
        return (es.pode.auditoria.negocio.servicios.jms.SrvAuditoriaRecibirServicio)
            getContext().getBean("SrvAuditoriaRecibirServicio");
    }
