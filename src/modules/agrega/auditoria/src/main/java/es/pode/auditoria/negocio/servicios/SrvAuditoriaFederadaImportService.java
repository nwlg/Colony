...
public interface SrvAuditoriaFederadaImportService extends java.rmi.Remote {
     ...
     */
	es.pode.auditoria.negocio.servicios.InformeAgregacionFederadaVO[] informeNivelAgregacionFederado(ParametrosInformeFederadoVO parametros) throws java.rmi.RemoteException;
		
	/**

     */
	es.pode.auditoria.negocio.servicios.InformeAgregacionFederadaVO nivelAgregacionFederadoLocal(ParametrosInformeFederadoVO parametros) throws java.rmi.RemoteException;
