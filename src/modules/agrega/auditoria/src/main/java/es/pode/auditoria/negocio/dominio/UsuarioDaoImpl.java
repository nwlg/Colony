 ...
 */
public class UsuarioDaoImpl extends es.pode.auditoria.negocio.dominio.UsuarioDaoBase {
    /**
     * @see es.pode.auditoria.negocio.dominio.UsuarioDao#toUsuarioVO(es.pode.auditoria.negocio.dominio.Usuario)
     */
    public es.pode.auditoria.negocio.servicios.UsuarioVO toUsuarioVO(
	    final es.pode.auditoria.negocio.dominio.Usuario entity) {
	// default mapping between entity and VO
	// @todo verify or customize behaviour of this mapping
	return (es.pode.auditoria.negocio.servicios.UsuarioVO) this.getBeanMapper().map(entity,
		es.pode.auditoria.negocio.servicios.UsuarioVO.class, DEF_MAPPING_USUARIO_USUARIOVO);
    }
     ...
     * @see es.pode.auditoria.negocio.dominio.UsuarioDao#fromUsuarioVO(es.pode.auditoria.negocio.servicios.UsuarioVO)
     */
    public es.pode.auditoria.negocio.dominio.Usuario fromUsuarioVO(
	    final es.pode.auditoria.negocio.servicios.UsuarioVO vo) {
     ...
     * @see es.pode.auditoria.negocio.dominio.UsuarioDao#fromUsuarioVO(es.pode.auditoria.negocio.servicios.UsuarioVO
     *      ,es.pode.auditoria.negocio.dominio.Usuario)
     */
    public void fromUsuarioVO(es.pode.auditoria.negocio.servicios.UsuarioVO vo,
	    es.pode.auditoria.negocio.dominio.Usuario entity) {
	// default mapping between VO and entity
	// @todo verify or customize behaviour of this mapping
