...
/**
 * <p>
 * Este criterio implementa la busqueda de transiciones a un estado
 * dado que se producen en un periodo de tiempo.
 * </p>
 */
public class ActividadDesdeHastaCriteria
    implements java.io.Serializable
{
   ...
   */
    public ActividadDesdeHastaCriteria()
    {
    }
     ...
     */
    public ActividadDesdeHastaCriteria(
        es.pode.publicacion.negocio.dominio.Estado estado,
    ...
    /**
     * Copies constructor from other ActividadDesdeHastaCriteria
      * @param otherBean ActividadDesdeHastaCriteria
     */
    ...
    private es.pode.publicacion.negocio.dominio.Estado estado;
   ...
   */
    public es.pode.publicacion.negocio.dominio.Estado getEstado()
    {
        return this.estado;
    }
   ...
   */
    public void setEstado(es.pode.publicacion.negocio.dominio.Estado estado)
    {
        this.estado = estado;
    }
