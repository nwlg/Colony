...
public class CriteriaSearchProperties
{
    ...
    private static final void initialize1()
    {
        embeddedValuesByType.put(
            es.pode.publicacion.negocio.dominio.OdePublicadoImpl.class,
            null);
    ...
    {
        embeddedValuesByType.put(
            es.pode.publicacion.negocio.dominio.TransicionImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.publicacion.negocio.dominio.TransicionImpl.class,
            java.util.Arrays.asList(
                new AssociationType[] 
                {
                    new AssociationType("estadoTransitado", es.pode.publicacion.negocio.dominio.EstadoImpl.class), 
                    new AssociationType("estadoActual", es.pode.publicacion.negocio.dominio.EstadoImpl.class)
                }
            )
        );
    }
    ...
    {
        embeddedValuesByType.put(
            es.pode.publicacion.negocio.dominio.EstadoImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.publicacion.negocio.dominio.EstadoImpl.class,
            java.util.Arrays.asList(
