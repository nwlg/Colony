...
/**
 * <p>
 * Este criterio sirve para buscar los ODEs del usuario que alguna
 * vez estuvieron en cierto estado.
 * </p>
 */
public class UsuarioEstadoODECriteria
    implements java.io.Serializable
{
   ...
   */
    public UsuarioEstadoODECriteria()
    {
    }
    ...
    /**
     * Copies constructor from other UsuarioEstadoODECriteria
      * @param otherBean UsuarioEstadoODECriteria
     */
    public UsuarioEstadoODECriteria(UsuarioEstadoODECriteria otherBean)
    {
        if (otherBean != null)
        {
   ...
   * Valor del Estado Actual.
   * </p>
   *  @param estadoActual  Valor del Estado Actual. 
   */
