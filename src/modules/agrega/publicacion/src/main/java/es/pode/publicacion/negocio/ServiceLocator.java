...
//
package es.pode.publicacion.negocio;
...
public class ServiceLocator
{
     ...
     */
    private final String DEFAULT_BEAN_REFERENCE_LOCATION = "beanRefFactory_publicacion.xml";
     ...
     */
    public final es.pode.publicacion.negocio.servicios.SrvPublicacionService getSrvPublicacionService()
    {
        return (es.pode.publicacion.negocio.servicios.SrvPublicacionService)
            getContext().getBean("srvPublicacionService");
    }

    /**
     * Gets an instance of {@link es.pode.publicacion.negocio.servicios.SrvAuditaPublicacionService}.
     */
    public final es.pode.publicacion.negocio.servicios.SrvAuditaPublicacionService getSrvAuditaPublicacionService()
    {
        return (es.pode.publicacion.negocio.servicios.SrvAuditaPublicacionService)
            getContext().getBean("srvAuditaPublicacionService");
    }


    /**
     * Gets an instance of {@link es.pode.publicacion.negocio.servicios.SrvGaleriaImgServicio}.
     */
    public final es.pode.publicacion.negocio.servicios.SrvGaleriaImgServicio getSrvGaleriaImgServicio()
    {
        
        return (es.pode.publicacion.negocio.servicios.SrvGaleriaImgServicio)
            getContext().getBean("SrvGaleriaImgServicio");
    }
     ...
     */
    //public final es.pode.publicacion.negocio.servicios.ScormDao getScormDao()
     ...
     */
    //public final es.pode.publicacion.negocio.servicios.ZipDao getZipDao()
