	...
	*/
	    public int doStartTag() throws JspException{
	    	try {
	    		...
	    		if (logger.isDebugEnabled()) logger.debug("LdapUserDetailsUtils.getHost() es ["+LdapUserDetailsUtils.getHost()+"], LdapUserDetailsUtils.getSubdominio() es ["+LdapUserDetailsUtils.getSubdominio()+"]");
