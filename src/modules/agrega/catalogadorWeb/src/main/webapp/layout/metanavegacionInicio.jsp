...
<ol>
		...
		<li><a href="<html:rewrite action="/CatalogadorBasico/CatalogadorFormSubmit"/>" title="<bean:message key="catalogadorBasico.Exportar" />" id="contacto"><bean:message key="catalogadorBasico.Exportar" /></a></li>
