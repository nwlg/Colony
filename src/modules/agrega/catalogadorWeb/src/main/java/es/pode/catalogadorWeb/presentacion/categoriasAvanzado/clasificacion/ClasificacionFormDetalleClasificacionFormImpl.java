...
public class ClasificacionFormDetalleClasificacionFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public ClasificacionFormDetalleClasificacionFormImpl()
    {
    }
    ...
    public void setBotonPulsadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ClasificacionFormDetalleClasificacionFormImpl.setBotonPulsadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ClasificacionFormDetalleClasificacionFormImpl.setBotonPulsadoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTituloClasificacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ClasificacionFormDetalleClasificacionFormImpl.setTituloClasificacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ClasificacionFormDetalleClasificacionFormImpl.setTituloClasificacionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdentificadorOdeBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ClasificacionFormDetalleClasificacionFormImpl.setIdentificadorOdeBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ClasificacionFormDetalleClasificacionFormImpl.setIdentificadorOdeBackingList encountered an exception", ex);
            }
        }
    }
