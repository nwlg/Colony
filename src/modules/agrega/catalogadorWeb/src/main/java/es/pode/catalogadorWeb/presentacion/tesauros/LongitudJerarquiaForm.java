 ...
 * <code>longitudJerarquia</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.tesauros.TesaurosController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.tesauros.TesaurosController#longitudJerarquia
 */
public interface LongitudJerarquiaForm
{
    /**
