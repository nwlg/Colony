...
public final class ConfirmacionEliminarCancelarEliminar extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        try
        {
            forward = _cargaUsoEducativo(mapping, form, request, response);
        }
    ...
    private org.apache.struts.action.ActionForward _cargaUsoEducativo(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.catalogadorWeb.presentacion.categoriasAvanzado.usoeducativo.UsoeducativoControllerFactory.getUsoeducativoControllerInstance().cargarUsosEducativos(mapping, (ConfirmacionEliminarCancelarEliminarFormImpl)form, request, response);
