 ...
 * <code>eliminarTipoRecurso</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.usoeducativo.detalleUsoEducativo.DetalleUsoEduController#eliminarTipoRecurso
 */
public interface EliminarTipoRecursoForm
{
    /**
