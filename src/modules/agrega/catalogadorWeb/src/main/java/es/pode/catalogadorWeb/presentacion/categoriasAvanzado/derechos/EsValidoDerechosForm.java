 ...
 * <code>esValidoDerechos</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.DerechosController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.DerechosController#esValidoDerechos
 */
public interface EsValidoDerechosForm
{
    /**
