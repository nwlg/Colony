...
public class ConfirmacionEliminarCancelarEliminarFormImpl
    ...
    implements java.io.Serializable
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.clasificacion.CargarClasificacionForm
{
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.clasificacion.ConfirmacionEliminarCancelarEliminarFormImpl#getListadoClasificacion
     */
    ...
    public void setListadoClasificacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarCancelarEliminarFormImpl.setListadoClasificacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarCancelarEliminarFormImpl.setListadoClasificacionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTituloClasificacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarCancelarEliminarFormImpl.setTituloClasificacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarCancelarEliminarFormImpl.setTituloClasificacionBackingList encountered an exception", ex);
            }
        }
    }
