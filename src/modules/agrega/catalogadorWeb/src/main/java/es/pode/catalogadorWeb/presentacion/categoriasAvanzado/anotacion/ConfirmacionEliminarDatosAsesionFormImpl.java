...
public class ConfirmacionEliminarDatosAsesionFormImpl
    ...
    implements java.io.Serializable
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.anotacion.GuardarEnSesionForm
{
    ...
    public void setTituloAnotacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarDatosAsesionFormImpl.setTituloAnotacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarDatosAsesionFormImpl.setTituloAnotacionBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.anotacion.ConfirmacionEliminarDatosAsesionFormImpl#getListadoAnotaciones
     */
    ...
    public void setListadoAnotacionesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarDatosAsesionFormImpl.setListadoAnotacionesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarDatosAsesionFormImpl.setListadoAnotacionesBackingList encountered an exception", ex);
            }
        }
    }
