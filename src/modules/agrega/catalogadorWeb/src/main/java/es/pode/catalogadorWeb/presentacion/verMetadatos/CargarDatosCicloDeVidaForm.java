 ...
 * <code>cargarDatosCicloDeVida</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.verMetadatos.VerMetadatosController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.verMetadatos.VerMetadatosController#cargarDatosCicloDeVida
 */
public interface CargarDatosCicloDeVidaForm
{
    /**
