    ...
    implements java.io.Serializable
{
    ...
    public void setAccionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("VolverFormImpl.setAccionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("VolverFormImpl.setAccionBackingList encountered an exception", ex);
            }
        }
    }
