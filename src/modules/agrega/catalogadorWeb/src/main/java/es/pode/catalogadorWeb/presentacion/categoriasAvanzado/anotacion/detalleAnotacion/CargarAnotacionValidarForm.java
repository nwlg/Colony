 ...
 * <code>cargarAnotacionValidar</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.anotacion.detalleAnotacion.DetalleAnotacionController#cargarAnotacionValidar
 */
public interface CargarAnotacionValidarForm
{
    /**
