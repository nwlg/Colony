...
public class CategoriasFormModificarCicloDeVidaFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public CategoriasFormModificarCicloDeVidaFormImpl()
    {
    }
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CategoriasFormModificarCicloDeVidaFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFormModificarCicloDeVidaFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.catalogadorAvanzado.CategoriasFormModificarCicloDeVidaFormImpl#getDatos
     */
    ...
    public void setDatosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CategoriasFormModificarCicloDeVidaFormImpl.setDatosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFormModificarCicloDeVidaFormImpl.setDatosBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setReturnURLBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CategoriasFormModificarCicloDeVidaFormImpl.setReturnURLBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFormModificarCicloDeVidaFormImpl.setReturnURLBackingList encountered an exception", ex);
            }
        }
    }
