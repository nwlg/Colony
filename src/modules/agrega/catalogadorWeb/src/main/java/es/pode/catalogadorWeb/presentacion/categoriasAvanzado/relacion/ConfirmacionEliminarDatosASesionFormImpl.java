...
public class ConfirmacionEliminarDatosASesionFormImpl
    ...
    implements java.io.Serializable
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.relacion.GuardarEnSesionForm
{
    ...
    public void setTituloRelacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarDatosASesionFormImpl.setTituloRelacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarDatosASesionFormImpl.setTituloRelacionBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.relacion.ConfirmacionEliminarDatosASesionFormImpl#getListadoRelaciones
     */
    ...
    public void setListadoRelacionesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarDatosASesionFormImpl.setListadoRelacionesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarDatosASesionFormImpl.setListadoRelacionesBackingList encountered an exception", ex);
            }
        }
    }
