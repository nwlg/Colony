 ...
 * <code>eliminarArbol</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.catalogadorBasico.CatBasicoController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.catalogadorBasico.CatBasicoController#eliminarArbol
 */
public interface EliminarArbolForm
{
    /**
    ...
    /**
     * Sets the <code>idArbol</code> field.
     *
     * 
     */
    ...
    /**
     * Gets the <code>idArbol</code> field.
     *
     * 
     */
    ...
    /**
     * Resets the <code>idArbol</code> field.
     */
