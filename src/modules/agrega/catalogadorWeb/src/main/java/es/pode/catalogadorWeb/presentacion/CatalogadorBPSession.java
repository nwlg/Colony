 ...
 * </p>
 */
public class CatalogadorBPSession implements Serializable
{
  /**
   * Clave del objeto de session
   */
    public final static String SESSION_KEY = "catalogadorBPSession";
    
    private es.pode.catalogacion.negocio.servicios.LomAvanzadoVO MBOSesion;
    private es.pode.catalogacion.negocio.servicios.ArbolCurricularVO[] curriculumTrees;
   ...
   */
    public es.pode.catalogacion.negocio.servicios.LomAvanzadoVO getMBOSesion()
    {
 ...
 Este atributo puede ser nulo, ya que al inicio de la sesion en el catalogador aun no habra sido cargado con ningun valor.  
   */
    public void setMBOSesion(es.pode.catalogacion.negocio.servicios.LomAvanzadoVO MBOSesion)
    {
   ...
   */
    ...
    /*
     * Store the currently selected curriculum trees
     */
  
    public ArbolCurricularVO[] getCurriculumTreesArray()
    {
    	return this.curriculumTrees;
    }

    public void setCurriculumTreesArray(ArbolCurricularVO[] curriculumTrees)
    {
