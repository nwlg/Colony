 ...
 * <code>eliminarIdentificador</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.metametadatos.MetametadatosController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.metametadatos.MetametadatosController#eliminarIdentificador
 */
public interface EliminarIdentificadorForm
{
    /**
