 ...
 * <code>eliminarPalabraClave</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.clasificacion.detalleClasificacion.DetalleClasificacionController#eliminarPalabraClave
 */
public interface EliminarPalabraClaveForm
{
    /**
