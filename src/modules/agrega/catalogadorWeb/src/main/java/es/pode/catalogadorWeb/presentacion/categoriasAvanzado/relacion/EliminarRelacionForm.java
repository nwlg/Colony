 ...
 * <code>eliminarRelacion</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.relacion.RelacionController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.relacion.RelacionController#eliminarRelacion
 */
public interface EliminarRelacionForm
{
    /**
     ...
     * 
     *
     * @see #setTituloRelacionRowSelection#sArray(java.lang.String[])
     */
     ...
     * 
     *
     * @see #getTituloRelacionRowSelection#sArray()
     */
     ...
     * 
     *
     * @see #setTituloRelacionRowSelection(java.util.List)
     */
     ...
     * 
     *
     * @see #getTituloRelacionRowSelection()
     */
