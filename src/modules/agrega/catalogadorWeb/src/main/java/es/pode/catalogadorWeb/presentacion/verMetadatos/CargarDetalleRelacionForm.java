 ...
 * <code>cargarDetalleRelacion</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.verMetadatos.VerMetadatosController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.verMetadatos.VerMetadatosController#cargarDetalleRelacion
 */
public interface CargarDetalleRelacionForm
{
    /**
