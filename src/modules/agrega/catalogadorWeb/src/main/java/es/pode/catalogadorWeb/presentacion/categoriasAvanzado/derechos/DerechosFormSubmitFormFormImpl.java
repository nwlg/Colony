...
public class DerechosFormSubmitFormFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.GuardarDerechosForm
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.ResetForm
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.EliminarDescripcionForm
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.AnadirDescripcionForm
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.CancelarForm
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.EsValidoDerechosForm
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.AccionSubmitForm
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.ComprobarErroresForm
{
    ...
    private java.lang.Object[] codigoErrorValueList;
    private java.lang.Object[] codigoErrorLabelList;
    ...
    public DerechosFormSubmitFormFormImpl()
    {
    }
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.DerechosFormSubmitFormFormImpl#getDescripciones
     */
    ...
    public void setDescripcionesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setDescripcionesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setDescripcionesBackingList encountered an exception", ex);
            }
        }
    }

    /**
     * Resets the given <code>codigoError</code>.
     */
    public void resetCodigoError()
    {
    ...
    public java.lang.Object[] getCodigoErrorBackingList()
    {
        java.lang.Object[] values = this.codigoErrorValueList;
        java.lang.Object[] labels = this.codigoErrorLabelList;
    ...
    public java.lang.Object[] getCodigoErrorValueList()
    {
        return this.codigoErrorValueList;
    }

    public void setCodigoErrorValueList(java.lang.Object[] codigoErrorValueList)
    {
        this.codigoErrorValueList = codigoErrorValueList;
    }

    public java.lang.Object[] getCodigoErrorLabelList()
    {
        return this.codigoErrorLabelList;
    }

    public void setCodigoErrorLabelList(java.lang.Object[] codigoErrorLabelList)
    {
        this.codigoErrorLabelList = codigoErrorLabelList;
    }

    public void setCodigoErrorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setCodigoErrorBackingList requires non-null property arguments");
        }

        this.codigoErrorValueList = null;
        this.codigoErrorLabelList = null;

        if (items != null)
        {
            this.codigoErrorValueList = new java.lang.Object[items.size()];
            this.codigoErrorLabelList = new java.lang.Object[items.size()];
            ...
            try
            {
                ...
                for (java.util.Iterator iterator = items.iterator(); iterator.hasNext(); i++)
                {
                    ...
                    this.codigoErrorValueList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, valueProperty);
                    this.codigoErrorLabelList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, labelProperty);
                }
            }
            catch (Exception ex)
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setCodigoErrorBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setCopyRestriccionesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setCopyRestriccionesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setCopyRestriccionesBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setAccionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setAccionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setAccionBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setListadoComunidadesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setListadoComunidadesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setListadoComunidadesBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdEliminadoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setIdEliminadoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setIdEliminadoBackingList encountered an exception", ex);
            }
        }
    }
     ...
     * will also return <code>null</code>.
     *
     * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.DerechosFormSubmitFormFormImpl#getListadoNodos
     */
    ...
    public void setListadoNodosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setListadoNodosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setListadoNodosBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTipoAccesoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setTipoAccesoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setTipoAccesoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setComboIdiomaBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setComboIdiomaBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setComboIdiomaBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setCosteBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setCosteBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setCosteBackingList encountered an exception", ex);
            }
        }
    }
     ...
     * will also return <code>null</code>.
     *
     * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.DerechosFormSubmitFormFormImpl#getMensajesError
     */
    ...
    public void setMensajesErrorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setMensajesErrorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setMensajesErrorBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdentificadorOdeBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setIdentificadorOdeBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setIdentificadorOdeBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setCoypRestriccionesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("DerechosFormSubmitFormFormImpl.setCoypRestriccionesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("DerechosFormSubmitFormFormImpl.setCoypRestriccionesBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public java.lang.String toString()
    {
        ...
        builder.append("codigoError", this.codigoError);
