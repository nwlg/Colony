...
public class CategoriasFormModificarAnotacionFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public CategoriasFormModificarAnotacionFormImpl()
    {
    }
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CategoriasFormModificarAnotacionFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFormModificarAnotacionFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.catalogadorAvanzado.CategoriasFormModificarAnotacionFormImpl#getDatos
     */
    ...
    public void setDatosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CategoriasFormModificarAnotacionFormImpl.setDatosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFormModificarAnotacionFormImpl.setDatosBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setReturnURLBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CategoriasFormModificarAnotacionFormImpl.setReturnURLBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFormModificarAnotacionFormImpl.setReturnURLBackingList encountered an exception", ex);
            }
        }
    }
