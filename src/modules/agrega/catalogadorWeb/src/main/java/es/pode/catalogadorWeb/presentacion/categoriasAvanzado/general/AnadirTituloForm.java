 ...
 * <code>anadirTitulo</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.general.GeneralController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.general.GeneralController#anadirTitulo
 */
public interface AnadirTituloForm
{
    /**
