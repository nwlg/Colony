 ...
 * 
 */
public final class Tesauros extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final TesaurosFormImpl specificForm = (TesaurosFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _cargarTesauros(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.catalogadorWeb.presentacion.tesauros.TesaurosControllerFactory.getTesaurosControllerInstance().cargaTesauros(mapping, (TesaurosFormImpl)form, request, response);
