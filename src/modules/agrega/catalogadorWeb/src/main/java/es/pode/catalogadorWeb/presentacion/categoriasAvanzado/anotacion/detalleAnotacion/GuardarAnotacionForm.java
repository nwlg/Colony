 ...
 * <code>guardarAnotacion</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.anotacion.detalleAnotacion.DetalleAnotacionController#guardarAnotacion
 */
public interface GuardarAnotacionForm
{
    /**
