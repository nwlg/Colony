 ...
 * <code>eliminarProcesoCognitivo</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.usoeducativo.detalleUsoEducativo.DetalleUsoEduController#eliminarProcesoCognitivo
 */
public interface EliminarProcesoCognitivoForm
{
    /**
