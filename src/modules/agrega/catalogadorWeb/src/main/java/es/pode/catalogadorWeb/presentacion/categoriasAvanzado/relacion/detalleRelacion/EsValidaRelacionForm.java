 ...
 * <code>esValidaRelacion</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.relacion.detalleRelacion.DetalleRelacionController#esValidaRelacion
 */
public interface EsValidaRelacionForm
{
    /**
