...
public class CategoriasFormModificarMetaMetadatosFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public CategoriasFormModificarMetaMetadatosFormImpl()
    {
    }
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("CategoriasFormModificarMetaMetadatosFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFormModificarMetaMetadatosFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.catalogadorAvanzado.CategoriasFormModificarMetaMetadatosFormImpl#getDatos
     */
    ...
    public void setDatosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CategoriasFormModificarMetaMetadatosFormImpl.setDatosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFormModificarMetaMetadatosFormImpl.setDatosBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setReturnURLBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("CategoriasFormModificarMetaMetadatosFormImpl.setReturnURLBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("CategoriasFormModificarMetaMetadatosFormImpl.setReturnURLBackingList encountered an exception", ex);
            }
        }
    }
