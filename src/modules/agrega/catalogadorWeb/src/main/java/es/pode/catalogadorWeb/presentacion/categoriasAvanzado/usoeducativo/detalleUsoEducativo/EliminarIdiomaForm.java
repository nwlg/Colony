 ...
 * <code>eliminarIdioma</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.usoeducativo.detalleUsoEducativo.DetalleUsoEduController#eliminarIdioma
 */
public interface EliminarIdiomaForm
{
    /**
