...
public final class ConfirmacionEliminarCancelarEliminar extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        try
        {
            forward = _cargaRelaciones(mapping, form, request, response);
        }
    ...
    private org.apache.struts.action.ActionForward _cargaRelaciones(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.catalogadorWeb.presentacion.categoriasAvanzado.relacion.RelacionControllerFactory.getRelacionControllerInstance().cargarRelaciones(mapping, (ConfirmacionEliminarCancelarEliminarFormImpl)form, request, response);
