 ...
 * <code>anadirContenidoDescripcion</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.general.GeneralController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.general.GeneralController#anadirContenidoDescripcion
 */
public interface AnadirContenidoDescripcionForm
{
    /**
