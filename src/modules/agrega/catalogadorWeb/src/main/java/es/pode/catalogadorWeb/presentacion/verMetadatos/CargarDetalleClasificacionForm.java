 ...
 * <code>cargarDetalleClasificacion</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.verMetadatos.VerMetadatosController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.verMetadatos.VerMetadatosController#cargarDetalleClasificacion
 */
public interface CargarDetalleClasificacionForm
{
    /**
    ...
    /**
     * Sets the <code>proposito</code> field.
     *
     * 
     */
    ...
    /**
     * Gets the <code>proposito</code> field.
     *
     * 
     */
    ...
    /**
     * Resets the <code>proposito</code> field.
     */
    public void resetProposito();

    /**
     * The <code>proposito</code> field can be selected from a list,
     * this method allows you to retrieve the current elements from that list.
     * <p/>
     * <i>Please note that the elements from that list are key value pairs, so you will
     * need to call <code>getLabel()</code> and <code>getValue()</code> to get the label and
     ...
     *
     * @see #getProposito()
     * @see #getPropositoValueList()
     * @see #getPropositoLabelList()
     * @see #setPropositoLabelList(java.util.Collection,java.lang.String,java.lang.String)
     */
    public java.lang.Object[] getPropositoBackingList();

    /**
     * Convenient method to quickly set the value and label backinglist for the
     * proposito property. This method takes a collection of objects, as well as
     * the property names to query on these objects in order to find the corresponding
     * values and labels.
     * <p/>
     * Let's say you have a set of value objects with the following properties:
     ...
     *  <li><code>description</code></li>
     * </ul>
     * But you need to populate the proposito backing list with the <code>id</code> properties as the values and the
     * <code>name</code> properties as the labels then you would make a call like this:
     * <code>setPropositoBackingList(valueObjects, "id", "name")</code>
     * <p/>
     * This method knows how to handle primitive property types as it simply delegates to
     * <code>org.apache.commons.beanutils.PropertyUtils.getProperty(Object, String)</code>.
     *
     ...
     * @see #getPropositoLabelList()
     */
    public void setPropositoBackingList(java.util.Collection items, String valueProperty, String labelProperty);
