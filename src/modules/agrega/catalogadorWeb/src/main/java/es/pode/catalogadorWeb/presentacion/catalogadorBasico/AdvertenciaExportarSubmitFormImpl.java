...
public class AdvertenciaExportarSubmitFormImpl
    ...
    implements java.io.Serializable
        ...
        , es.pode.catalogadorWeb.presentacion.catalogadorBasico.SubmitAdvertenciaExportarForm
        , es.pode.catalogadorWeb.presentacion.catalogadorBasico.SonValidosExportarForm
{
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.catalogadorBasico.AdvertenciaExportarSubmitFormImpl#getArboles
     */
     ...
     * will also return <code>null</code>.
     *
     * @see es.pode.catalogadorWeb.presentacion.catalogadorBasico.AdvertenciaExportarSubmitFormImpl#getMensajesError
     */
