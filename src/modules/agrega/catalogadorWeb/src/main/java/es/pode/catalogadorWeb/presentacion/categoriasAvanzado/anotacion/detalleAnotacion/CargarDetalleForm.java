 ...
 * <code>cargarDetalle</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.anotacion.detalleAnotacion.DetalleAnotacionController#cargarDetalle
 */
public interface CargarDetalleForm
{
    /**
