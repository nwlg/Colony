        ...
        , es.pode.catalogadorWeb.presentacion.catalogadorBasicPlus.SubmitAdvertenciaImportarForm
{
    ...
    public void setAccionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("AdvertenciaImportarSubmitFormImpl.setAccionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("AdvertenciaImportarSubmitFormImpl.setAccionBackingList encountered an exception", ex);
            }
        }
    }
