 ...
 * <code>eliminarUsoEducativo</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.usoeducativo.UsoeducativoController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.usoeducativo.UsoeducativoController#eliminarUsoEducativo
 */
public interface EliminarUsoEducativoForm
{
    /**
     ...
     * 
     *
     * @see #setTituloUsoEduRowSelection#sArray(java.lang.String[])
     */
     ...
     * 
     *
     * @see #getTituloUsoEduRowSelection#sArray()
     */
     ...
     * 
     *
     * @see #setTituloUsoEduRowSelection(java.util.List)
     */
     ...
     * 
     *
     * @see #getTituloUsoEduRowSelection()
     */
    public java.lang.String[] getTituloUsoEduRowSelectionAsArray();

    /**
     * Resets the <code>tituloUsoEdu</code> field.
     */
