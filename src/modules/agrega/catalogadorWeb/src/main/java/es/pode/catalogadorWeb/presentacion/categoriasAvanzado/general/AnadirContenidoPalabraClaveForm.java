 ...
 * <code>anadirContenidoPalabraClave</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.general.GeneralController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.general.GeneralController#anadirContenidoPalabraClave
 */
public interface AnadirContenidoPalabraClaveForm
{
    /**
