 ...
 * <code>guardarClasificacion</code> method, which is located on the
 ...
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.clasificacion.detalleClasificacion.DetalleClasificacionController#guardarClasificacion
 */
public interface GuardarClasificacionForm
{
    /**
