 ...
 * <code>eliminarAnotacion</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.anotacion.AnotacionController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.anotacion.AnotacionController#eliminarAnotacion
 */
public interface EliminarAnotacionForm
{
    /**
     ...
     * 
     *
     * @see #setTituloAnotacionRowSelection#sArray(java.lang.String[])
     */
     ...
     * 
     *
     * @see #getTituloAnotacionRowSelection#sArray()
     */
     ...
     * 
     *
     * @see #setTituloAnotacionRowSelection(java.util.List)
     */
     ...
     * 
     *
     * @see #getTituloAnotacionRowSelection()
     */
