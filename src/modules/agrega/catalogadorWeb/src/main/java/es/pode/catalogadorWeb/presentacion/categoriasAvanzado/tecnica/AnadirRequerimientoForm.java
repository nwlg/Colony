 ...
 * <code>anadirRequerimiento</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.tecnica.TecnicaController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.tecnica.TecnicaController#anadirRequerimiento
 */
public interface AnadirRequerimientoForm
{
    /**
