 ...
 * <code>anadirVersion</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.ciclodevida.CiclodevidaController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.ciclodevida.CiclodevidaController#anadirVersion
 */
public interface AnadirVersionForm
{
    /**
