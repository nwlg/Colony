 ...
 * 
 */
public final class TesaurosFormBuscar extends org.apache.struts.action.Action
{
    public org.apache.struts.action.ActionForward execute(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        final TesaurosFormBuscarFormImpl specificForm = (TesaurosFormBuscarFormImpl)form;
    ...
    private org.apache.struts.action.ActionForward _buscarTerminos(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.catalogadorWeb.presentacion.tesauros.TesaurosControllerFactory.getTesaurosControllerInstance().buscarTerminos(mapping, (TesaurosFormBuscarFormImpl)form, request, response);
