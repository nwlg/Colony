        ...
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.usoeducativo.CargarUsosEducativosForm
{
    ...
    public void setTituloUsoEducativoBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfirmacionEliminarCancelarEliminarFormImpl.setTituloUsoEducativoBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarCancelarEliminarFormImpl.setTituloUsoEducativoBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setTituloUsoEduBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarCancelarEliminarFormImpl.setTituloUsoEduBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarCancelarEliminarFormImpl.setTituloUsoEduBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.usoeducativo.ConfirmacionEliminarCancelarEliminarFormImpl#getListadoUsosEdu
     */
    ...
    public void setListadoUsosEduBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarCancelarEliminarFormImpl.setListadoUsosEduBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarCancelarEliminarFormImpl.setListadoUsosEduBackingList encountered an exception", ex);
            }
        }
    }
