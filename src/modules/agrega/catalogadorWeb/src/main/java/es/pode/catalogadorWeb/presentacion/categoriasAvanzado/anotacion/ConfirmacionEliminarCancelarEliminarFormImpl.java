...
public class ConfirmacionEliminarCancelarEliminarFormImpl
    ...
    implements java.io.Serializable
        , es.pode.catalogadorWeb.presentacion.categoriasAvanzado.anotacion.CargarAnotacionesForm
{
    ...
    public void setTituloAnotacionBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarCancelarEliminarFormImpl.setTituloAnotacionBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarCancelarEliminarFormImpl.setTituloAnotacionBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.anotacion.ConfirmacionEliminarCancelarEliminarFormImpl#getListadoAnotaciones
     */
    ...
    public void setListadoAnotacionesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionEliminarCancelarEliminarFormImpl.setListadoAnotacionesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionEliminarCancelarEliminarFormImpl.setListadoAnotacionesBackingList encountered an exception", ex);
            }
        }
    }
