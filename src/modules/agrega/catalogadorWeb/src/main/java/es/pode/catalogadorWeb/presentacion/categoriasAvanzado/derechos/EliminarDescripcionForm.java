 ...
 * <code>eliminarDescripcion</code> method, which is located on the
 * <code>es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.DerechosController</code> controller.
 *
 * 
 *
 * @see es.pode.catalogadorWeb.presentacion.categoriasAvanzado.derechos.DerechosController#eliminarDescripcion
 */
public interface EliminarDescripcionForm
{
    /**
    ...
    /**
     * Sets the <code>idEliminado</code> field.
     *
     * 
     */
    ...
    /**
     * Gets the <code>idEliminado</code> field.
     *
     * 
     */
    ...
    /**
     * Resets the <code>idEliminado</code> field.
     */
