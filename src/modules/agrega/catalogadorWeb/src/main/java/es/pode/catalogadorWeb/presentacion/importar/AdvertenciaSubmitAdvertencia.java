...
public final class AdvertenciaSubmitAdvertencia extends org.apache.struts.action.Action
{
    ...
    private org.apache.struts.action.ActionForward _subirFichero(org.apache.struts.action.ActionMapping mapping, org.apache.struts.action.ActionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
        ...
        es.pode.catalogadorWeb.presentacion.importar.ImportarControllerFactory.getImportarControllerInstance().subirFichero(mapping, (AdvertenciaSubmitAdvertenciaFormImpl)form, request, response);
    ...
    {
        final java.lang.String value = java.lang.String.valueOf(es.pode.catalogadorWeb.presentacion.importar.ImportarControllerFactory.getImportarControllerInstance().submitAdvertencia(mapping, (AdvertenciaSubmitAdvertenciaFormImpl)form, request, response));
