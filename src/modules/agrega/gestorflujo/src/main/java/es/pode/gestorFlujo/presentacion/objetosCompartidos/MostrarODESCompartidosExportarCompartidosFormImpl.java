...
public class MostrarODESCompartidosExportarCompartidosFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public MostrarODESCompartidosExportarCompartidosFormImpl()
    {
    }
    ...
    public void setTituloBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("MostrarODESCompartidosExportarCompartidosFormImpl.setTituloBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESCompartidosExportarCompartidosFormImpl.setTituloBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarODESCompartidosExportarCompartidosFormImpl.setIdODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESCompartidosExportarCompartidosFormImpl.setIdODEBackingList encountered an exception", ex);
            }
        }
    }
