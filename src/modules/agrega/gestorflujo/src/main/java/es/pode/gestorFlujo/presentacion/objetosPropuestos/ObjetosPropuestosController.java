 ...
 * de uso de Objetos Propuestos.
 * </p>
 */
public abstract class ObjetosPropuestosController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.gestorFlujo.presentacion.objetosPropuestos.CargarODESPropuestosForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void cargarODESPropuestos(org.apache.struts.action.ActionMapping mapping, es.pode.gestorFlujo.presentacion.objetosPropuestos.CargarODESPropuestosForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvPublicacionServiceInputStream=ObjetosPropuestosController.class.getClassLoader().getResourceAsStream(srvPublicacionServiceFile);
