...
public class ProponerPrincipalAceptarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.gestorFlujo.presentacion.objetosPendientesCatalogacion.proponer.ProponerODEPublicacionForm
{
    ...
    public ProponerPrincipalAceptarFormImpl()
    {
    }
    ...
    public void setTituloBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ProponerPrincipalAceptarFormImpl.setTituloBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ProponerPrincipalAceptarFormImpl.setTituloBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setMensajesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ProponerPrincipalAceptarFormImpl.setMensajesBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ProponerPrincipalAceptarFormImpl.setMensajesBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setComentariosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ProponerPrincipalAceptarFormImpl.setComentariosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ProponerPrincipalAceptarFormImpl.setComentariosBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ProponerPrincipalAceptarFormImpl.setIdODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ProponerPrincipalAceptarFormImpl.setIdODEBackingList encountered an exception", ex);
            }
        }
    }
