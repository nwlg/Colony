...
public class VerHistorialCUFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.gestorFlujo.presentacion.objetosPersonales.verHistorial.CargarHistorialODEForm
{
    ...
    private java.util.Collection historiales;
    private java.lang.Object[] historialesValueList;
    private java.lang.Object[] historialesLabelList;

    public VerHistorialCUFormImpl()
    {
    }
    ...
    public void setTituloBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("VerHistorialCUFormImpl.setTituloBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("VerHistorialCUFormImpl.setTituloBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("VerHistorialCUFormImpl.setIdODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("VerHistorialCUFormImpl.setIdODEBackingList encountered an exception", ex);
            }
        }
    }

    /**
     * Resets the given <code>historiales</code>.
     */
    ...
    {
        this.historiales = (historiales == null) ? null : java.util.Arrays.asList(historiales);
    }
     ...
     *
     * @see es.pode.gestorFlujo.presentacion.objetosPersonales.verHistorial.VerHistorialCUFormImpl#getHistoriales
     */
    public java.lang.Object[] getHistorialesAsArray()
    {
        return (historiales == null) ? null : historiales.toArray();
    }
    
    public java.lang.Object[] getHistorialesBackingList()
    {
        java.lang.Object[] values = this.historialesValueList;
        java.lang.Object[] labels = this.historialesLabelList;
    ...
    public java.lang.Object[] getHistorialesValueList()
    {
        return this.historialesValueList;
    }

    public void setHistorialesValueList(java.lang.Object[] historialesValueList)
    {
        this.historialesValueList = historialesValueList;
    }

    public java.lang.Object[] getHistorialesLabelList()
    {
        return this.historialesLabelList;
    }

    public void setHistorialesLabelList(java.lang.Object[] historialesLabelList)
    {
        this.historialesLabelList = historialesLabelList;
    }

    public void setHistorialesBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("VerHistorialCUFormImpl.setHistorialesBackingList requires non-null property arguments");
        }

        this.historialesValueList = null;
        this.historialesLabelList = null;

        if (items != null)
        {
            this.historialesValueList = new java.lang.Object[items.size()];
            this.historialesLabelList = new java.lang.Object[items.size()];
            ...
            try
            {
                ...
                for (java.util.Iterator iterator = items.iterator(); iterator.hasNext(); i++)
                {
                    ...
                    this.historialesValueList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, valueProperty);
                    this.historialesLabelList[i] = org.apache.commons.beanutils.PropertyUtils.getProperty(item, labelProperty);
                }
            }
            catch (Exception ex)
            {
                throw new java.lang.RuntimeException("VerHistorialCUFormImpl.setHistorialesBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public java.lang.String toString()
    {
        ...
        builder.append("historiales", this.historiales);
