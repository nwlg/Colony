...
public class RechazarCancelarFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public RechazarCancelarFormImpl()
    {
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("RechazarCancelarFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("RechazarCancelarFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
