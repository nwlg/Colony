...
public class MostrarODESPersonalesProponerFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public MostrarODESPersonalesProponerFormImpl()
    {
    }
    ...
    public void setTituloBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("MostrarODESPersonalesProponerFormImpl.setTituloBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESPersonalesProponerFormImpl.setTituloBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdUsuarioBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarODESPersonalesProponerFormImpl.setIdUsuarioBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESPersonalesProponerFormImpl.setIdUsuarioBackingList encountered an exception", ex);
            }
        }
    }
    ...
    /**
     * <p>
     * Identificador alfanumerico del ODE que se quiere proponer para
     * publicacion.
     * </p>
     */
    ...
    public void setIdODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarODESPersonalesProponerFormImpl.setIdODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESPersonalesProponerFormImpl.setIdODEBackingList encountered an exception", ex);
            }
        }
    }
