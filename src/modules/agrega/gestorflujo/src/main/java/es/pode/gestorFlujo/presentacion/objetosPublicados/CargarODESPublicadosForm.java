 ...
 * <code>cargarODESPublicados</code> method, which is located on the
 * <code>es.pode.gestorFlujo.presentacion.objetosPublicados.ObjetosPublicadosController</code> controller.
 *
 * <p>
 * Este metodo se encarga de recuperar la lista de ODEs publicados
 * que tiene asociados el usuario que esta navegando.
 * </p>
 *
 * @see es.pode.gestorFlujo.presentacion.objetosPublicados.ObjetosPublicadosController#cargarODESPublicados
 */
public interface CargarODESPublicadosForm
{
    /**
