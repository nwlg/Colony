...
public class ObjetosPropuestosCUFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.gestorFlujo.presentacion.objetosPropuestos.CargarODESPropuestosForm
{
    ...
    public ObjetosPropuestosCUFormImpl()
    {
    }
    ...
    public void setTituloBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ObjetosPropuestosCUFormImpl.setTituloBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPropuestosCUFormImpl.setTituloBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ObjetosPropuestosCUFormImpl.setIdODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPropuestosCUFormImpl.setIdODEBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.gestorFlujo.presentacion.objetosPropuestos.ObjetosPropuestosCUFormImpl#getListaODES
     */
    ...
    public void setListaODESBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ObjetosPropuestosCUFormImpl.setListaODESBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPropuestosCUFormImpl.setListaODESBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ObjetosPropuestosCUFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPropuestosCUFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
