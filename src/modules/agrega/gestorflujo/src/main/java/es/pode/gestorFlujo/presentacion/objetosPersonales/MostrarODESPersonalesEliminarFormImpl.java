...
public class MostrarODESPersonalesEliminarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.gestorFlujo.presentacion.objetosPersonales.SubmitArchivosForm
{
    ...
    public MostrarODESPersonalesEliminarFormImpl()
    {
    }
    ...
    public void setIdODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("MostrarODESPersonalesEliminarFormImpl.setIdODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESPersonalesEliminarFormImpl.setIdODEBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setListODEsBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarODESPersonalesEliminarFormImpl.setListODEsBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESPersonalesEliminarFormImpl.setListODEsBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setOrigenBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarODESPersonalesEliminarFormImpl.setOrigenBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESPersonalesEliminarFormImpl.setOrigenBackingList encountered an exception", ex);
            }
        }
    }
