...
public class MostrarODESDespublicadosPendientesFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public MostrarODESDespublicadosPendientesFormImpl()
    {
    }
    ...
    public void setTipoBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("MostrarODESDespublicadosPendientesFormImpl.setTipoBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESDespublicadosPendientesFormImpl.setTipoBuscadorBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarODESDespublicadosPendientesFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESDespublicadosPendientesFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
