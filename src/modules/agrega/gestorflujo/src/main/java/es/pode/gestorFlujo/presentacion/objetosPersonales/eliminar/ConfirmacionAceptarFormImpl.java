...
public class ConfirmacionAceptarFormImpl
    ...
    implements java.io.Serializable
        , es.pode.gestorFlujo.presentacion.objetosPersonales.eliminar.EliminarODEsForm
{
     ...
     *
     * @see es.pode.gestorFlujo.presentacion.objetosPersonales.eliminar.ConfirmacionAceptarFormImpl#getTitulos
     */
    ...
    public void setTitulosBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ConfirmacionAceptarFormImpl.setTitulosBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionAceptarFormImpl.setTitulosBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ConfirmacionAceptarFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ConfirmacionAceptarFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
