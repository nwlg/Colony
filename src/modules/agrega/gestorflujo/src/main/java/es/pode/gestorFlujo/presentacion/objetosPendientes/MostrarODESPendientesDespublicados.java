...
public final class MostrarODESPendientesDespublicados extends org.apache.struts.action.Action
{
    ...
    {
        final MostrarODESPendientesDespublicadosFormImpl specificForm = (MostrarODESPendientesDespublicadosFormImpl)form;

        org.apache.struts.action.ActionForward forward = null;

        try
        {
            forward = mapping.findForward("despublicados");
        }
