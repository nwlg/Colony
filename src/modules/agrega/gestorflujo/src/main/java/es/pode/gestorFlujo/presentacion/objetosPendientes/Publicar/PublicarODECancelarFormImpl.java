...
public class PublicarODECancelarFormImpl
        ...
        , es.pode.gestorFlujo.presentacion.objetosPendientes.Publicar.DespublicadoForm
{
    ...
    public PublicarODECancelarFormImpl()
    {
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("PublicarODECancelarFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("PublicarODECancelarFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
