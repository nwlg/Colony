 ...
 * 
 */
public abstract class ObjetosPendientesCatalogacionController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.gestorFlujo.presentacion.objetosPendientesCatalogacion.CargarODESPendientesCatalogacionForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void cargarODESPendientesCatalogacion(org.apache.struts.action.ActionMapping mapping, es.pode.gestorFlujo.presentacion.objetosPendientesCatalogacion.CargarODESPendientesCatalogacionForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvAdminUsuariosServiceInputStream=ObjetosPendientesCatalogacionController.class.getClassLoader().getResourceAsStream(srvAdminUsuariosServiceFile);
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvPublicacionServiceInputStream=ObjetosPendientesCatalogacionController.class.getClassLoader().getResourceAsStream(srvPublicacionServiceFile);
