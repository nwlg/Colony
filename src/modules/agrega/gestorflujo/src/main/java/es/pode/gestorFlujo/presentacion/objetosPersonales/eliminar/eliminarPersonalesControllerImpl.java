...
import es.pode.gestorFlujo.presentacion.objetosPersonales.eliminar.eliminarPersonalesController;
...
public class eliminarPersonalesControllerImpl extends eliminarPersonalesController
{
    ...
    /**
     * @see es.pode.gestorFlujo.presentacion.objetosPersonales.eliminar.eliminarController#eliminarODEs(org.apache.struts.action.ActionMapping, es.pode.gestorFlujo.presentacion.objetosPersonales.eliminar.EliminarODEsForm, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    public final void eliminarODEs(ActionMapping mapping, es.pode.gestorFlujo.presentacion.objetosPersonales.eliminar.EliminarODEsForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    	SrvPublicacionService publi = this.getSrvPublicacionService();
    	if(logger.isDebugEnabled())
		logger.debug("Eliminando en objetosPersonales, hemos llegado al controller");
		...
		if (idsEliminar != null && idsEliminar.length > 0) {
			...
			logger.warn("No se han seleccionado elementos a eliminar en objetos personales");
    ...
    /**
     * @see es.pode.gestorFlujo.presentacion.objetosPersonales.eliminar.eliminarController#analizaSelec(org.apache.struts.action.ActionMapping, es.pode.gestorFlujo.presentacion.objetosPersonales.eliminar.AnalizaSelecForm, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    public final java.lang.String analizaSelec(ActionMapping mapping, es.pode.gestorFlujo.presentacion.objetosPersonales.eliminar.AnalizaSelecForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
