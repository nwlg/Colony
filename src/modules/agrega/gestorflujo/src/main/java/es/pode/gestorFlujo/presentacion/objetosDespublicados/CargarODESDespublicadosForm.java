 ...
 * <code>cargarODESDespublicados</code> method, which is located on the
 ...
 * nodo) que están en estado no disponible(despublicados).
 * </p>
 *
 * @see es.pode.gestorFlujo.presentacion.objetosDespublicados.ObjetosDespublicadosController#cargarODESDespublicados
 */
public interface CargarODESDespublicadosForm
{
    /**
