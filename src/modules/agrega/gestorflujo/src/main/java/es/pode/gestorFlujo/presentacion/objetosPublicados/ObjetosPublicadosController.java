 ...
 * de uso del tratamiento de los Objetos Publicados.
 * </p>
 */
public abstract class ObjetosPublicadosController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.gestorFlujo.presentacion.objetosPublicados.CargarODESPublicadosForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void cargarODESPublicados(org.apache.struts.action.ActionMapping mapping, es.pode.gestorFlujo.presentacion.objetosPublicados.CargarODESPublicadosForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvPublicacionServiceInputStream=ObjetosPublicadosController.class.getClassLoader().getResourceAsStream(srvPublicacionServiceFile);
