...
public class ObjetosPublicadosCUFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.gestorFlujo.presentacion.objetosPublicados.CargarODESPublicadosForm
{
    ...
    public ObjetosPublicadosCUFormImpl()
    {
    }
    ...
    public void setTituloBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("ObjetosPublicadosCUFormImpl.setTituloBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPublicadosCUFormImpl.setTituloBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ObjetosPublicadosCUFormImpl.setIdODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPublicadosCUFormImpl.setIdODEBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ObjetosPublicadosCUFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPublicadosCUFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see es.pode.gestorFlujo.presentacion.objetosPublicados.ObjetosPublicadosCUFormImpl#getListaODES
     */
    ...
    public void setListaODESBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("ObjetosPublicadosCUFormImpl.setListaODESBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("ObjetosPublicadosCUFormImpl.setListaODESBackingList encountered an exception", ex);
            }
        }
    }
