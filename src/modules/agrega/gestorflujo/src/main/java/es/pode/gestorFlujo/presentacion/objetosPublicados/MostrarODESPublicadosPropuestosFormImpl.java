...
public class MostrarODESPublicadosPropuestosFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public MostrarODESPublicadosPropuestosFormImpl()
    {
    }
    ...
    public void setIdiomaBuscadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("MostrarODESPublicadosPropuestosFormImpl.setIdiomaBuscadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESPublicadosPropuestosFormImpl.setIdiomaBuscadorBackingList encountered an exception", ex);
            }
        }
    }
