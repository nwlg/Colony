...
public class MostrarODESPendientesVerHistorialFormImpl
    ...
    implements java.io.Serializable
{
    ...
    public MostrarODESPendientesVerHistorialFormImpl()
    {
    }
    ...
    public void setTituloBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("MostrarODESPendientesVerHistorialFormImpl.setTituloBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESPendientesVerHistorialFormImpl.setTituloBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdODEBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("MostrarODESPendientesVerHistorialFormImpl.setIdODEBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("MostrarODESPendientesVerHistorialFormImpl.setIdODEBackingList encountered an exception", ex);
            }
        }
    }
