...
<tiles:insert definition="layout-gestor-flujo-con-style">
	...
	<tiles:put name="body" type="string">
		...
		<div>
		<h2><bean:message key="gestorFlujo.mostrarOdes.publicados.title" /></h2>
		</div>
		<ul>
			<li><a
...
-->
			...
			<li id="pest_activa"><a
				href="<html:rewrite action="${initParam.url_objetosPublicados}"/>"
		...
		<h3 class="h3_generico"><bean:message
			key="gestorFlujo.mostrarOdes.publicados" /></h3>
		...
		<display:table name="${form.listaODES}"
			...
			<display:caption>
				<bean:message key="gestorFlujo.mostrarOdes.tablaPublicados" />
			</display:caption>
			...
			<display:column style="valign:top;" class="ejec2">
				...
				<html:link target="blank" action="${initParam.url_objetosPersonales_mostrar_historial}?idODE=${fila.idODE}&titulo=${fila.titulo}" >
