...
<%@ taglib uri="/WEB-INF/tlds/rewriteTag.tld" prefix="rewrite" %> 
 ...
 <frameset rows="87,*" cols="100%"  class="frame_set" border="0" style="max-width:100% !important;">
	<frame name="cabecera" title="Cabecera" src="../layout/metanavegacion_nav.jsp" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" />
	<frame name="Contenido" title="Contenido" src="../layout/contenido_frame_nav.jsp" frameborder="0" scrolling="no" marginwidth="0" style="z-index:1" marginheight="0" />
...
<html:link action="../layout/metanavegacion_nav.jsp"><bean:message key="visualizar.enlaceCabecera"/></html:link>
<html:link action="../layout/menu.jsp_nav"><bean:message key="visualizar.enlaceMenu"/></html:link>
