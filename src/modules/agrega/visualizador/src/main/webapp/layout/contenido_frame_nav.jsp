...
<frameset onload="inicializar();" cols="400,*" class="frame_set" border="0" style="max-width:100% !important;">
		<frame src="menu_nav.jsp" name="menu" title="Menu" frameborder="0" scrolling="auto" marginwidth="0" marginheight="0" class="frame_menu"  />
		<frame src="contenido_index.jsp" name="contenido_principal" title="Contenido_Principal" frameborder="0" scrolling="no" scroll="no" marginwidth="0" marginheight="0" />
</frameset>
<noframes>
<body>
<p>
...
<html:link action="metanavegacion_nav.jsp"><bean:message key="visualizar.enlaceCabecera"/></html:link>
<html:link action="menu_nav.jsp"><bean:message key="visualizar.enlaceMenu"/></html:link>
