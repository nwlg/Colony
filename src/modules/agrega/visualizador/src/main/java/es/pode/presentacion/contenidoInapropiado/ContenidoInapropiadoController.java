 ...
 * 
 */
public abstract class ContenidoInapropiadoController implements java.io.Serializable
{
    /**
     *
     ...
     * @param form es.pode.presentacion.contenidoInapropiado.EnviarMensajeForm
     * @param request javax.servlet.http.HttpServletRequest
     * @param response javax.servlet.http.HttpServletResponse
     * @throws java.lang.Exception Exception
     */
    public abstract void enviarMensaje(org.apache.struts.action.ActionMapping mapping, es.pode.presentacion.contenidoInapropiado.EnviarMensajeForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    protected final void saveErrorMessage(javax.servlet.http.HttpServletRequest request, java.lang.String message)
    {
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvAdminUsuariosServiceInputStream=ContenidoInapropiadoController.class.getClassLoader().getResourceAsStream(srvAdminUsuariosServiceFile);
	        ...
	        throws java.lang.Exception
	    {
	        ...
	        java.io.InputStream srvBuscarServiceInputStream=ContenidoInapropiadoController.class.getClassLoader().getResourceAsStream(srvBuscarServiceFile);
