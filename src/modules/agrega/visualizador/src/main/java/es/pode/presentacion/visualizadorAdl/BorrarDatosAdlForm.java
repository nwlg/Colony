 ...
 * <code>borrarDatosAdl</code> method, which is located on the
 * <code>es.pode.presentacion.visualizadorAdl.VisualizadorAdlController</code> controller.
 *
 * 
 *
 * @see es.pode.presentacion.visualizadorAdl.VisualizadorAdlController#borrarDatosAdl
 */
public interface BorrarDatosAdlForm
{
    /**
