 ...
 * <code>cargarDatosNav</code> method, which is located on the
 * <code>es.pode.presentacion.visualizador.VisualizadorController</code> controller.
 *
 * 
 *
 * @see es.pode.presentacion.visualizador.VisualizadorController#cargarDatosNav
 */
public interface CargarDatosNavForm
{
    /**
