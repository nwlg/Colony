 ...
 * <code>nodoOnClick</code> method, which is located on the
 * <code>es.pode.presentacion.visualizador.VisualizadorController</code> controller.
 *
 * 
 *
 * @see es.pode.presentacion.visualizador.VisualizadorController#nodoOnClick
 */
public interface NodoOnClickForm
{
    /**
