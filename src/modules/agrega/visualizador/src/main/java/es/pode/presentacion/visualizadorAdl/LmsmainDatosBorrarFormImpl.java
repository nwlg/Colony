...
public class LmsmainDatosBorrarFormImpl
    extends org.apache.struts.validator.ValidatorForm
    implements java.io.Serializable
        , es.pode.presentacion.visualizadorAdl.BorrarDatosAdlForm
{
    ...
    public LmsmainDatosBorrarFormImpl()
    {
    }
    ...
    public void setUsuarioBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("LmsmainDatosBorrarFormImpl.setUsuarioBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("LmsmainDatosBorrarFormImpl.setUsuarioBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setIdentificadorBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("LmsmainDatosBorrarFormImpl.setIdentificadorBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("LmsmainDatosBorrarFormImpl.setIdentificadorBackingList encountered an exception", ex);
            }
        }
    }
