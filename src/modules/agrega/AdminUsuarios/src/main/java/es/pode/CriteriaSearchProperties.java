...
public class CriteriaSearchProperties
{
    ...
    private static final void initialize1()
    {
        embeddedValuesByType.put(
            es.pode.adminusuarios.negocio.dominio.UsuarioImpl.class,
            null);
        navigableAssociationEndsByType.put(
            ...
            java.util.Arrays.asList(
                new AssociationType[] 
                {
                    new AssociationType("grupos", es.pode.adminusuarios.negocio.dominio.GrupoImpl.class), 
                    new AssociationType("grupoTrabajo", es.pode.adminusuarios.negocio.dominio.GrupoTrabajoImpl.class)
                }
            )
        );
    }
    ...
    {
        embeddedValuesByType.put(
            es.pode.adminusuarios.negocio.dominio.RolImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.adminusuarios.negocio.dominio.RolImpl.class,
            java.util.Arrays.asList(
    ...
    {
        embeddedValuesByType.put(
            es.pode.adminusuarios.negocio.dominio.GrupoImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.adminusuarios.negocio.dominio.GrupoImpl.class,
            java.util.Arrays.asList(
                new AssociationType[] 
                {
                    new AssociationType("rols", es.pode.adminusuarios.negocio.dominio.RolImpl.class)
                }
            )
        );
    }
    ...
    {
        embeddedValuesByType.put(
            es.pode.adminusuarios.negocio.dominio.GrupoTrabajoImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.adminusuarios.negocio.dominio.GrupoTrabajoImpl.class,
            java.util.Arrays.asList(
