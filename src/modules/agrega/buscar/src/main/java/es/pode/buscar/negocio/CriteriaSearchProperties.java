...
public class CriteriaSearchProperties
{
    ...
    private static final void initialize1()
    {
        embeddedValuesByType.put(
            es.pode.buscar.negocio.nodosSQI.dominio.NodoSQIImpl.class,
            null);
    ...
    {
        embeddedValuesByType.put(
            es.pode.buscar.negocio.administrar.dominio.NodoImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.buscar.negocio.administrar.dominio.NodoImpl.class,
            java.util.Arrays.asList(
                new AssociationType[] 
                {
                    new AssociationType("ccaa", es.pode.buscar.negocio.administrar.dominio.CcaaImpl.class), 
                    new AssociationType("servicio", es.pode.buscar.negocio.administrar.dominio.ServicioImpl.class)
                }
            )
        );
    }
    ...
    {
        embeddedValuesByType.put(
            es.pode.buscar.negocio.administrar.dominio.ServicioImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.buscar.negocio.administrar.dominio.ServicioImpl.class,
            java.util.Arrays.asList(
    ...
    {
        embeddedValuesByType.put(
            es.pode.buscar.negocio.administrar.dominio.CcaaImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.buscar.negocio.administrar.dominio.CcaaImpl.class,
            java.util.Arrays.asList(
