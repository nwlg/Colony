...
//
package es.pode.buscar.negocio;
...
public class ServiceLocator
{
     ...
     */
    public final es.pode.buscar.negocio.buscar.servicios.SrvBuscarService getSrvBuscarService()
    {
        return (es.pode.buscar.negocio.buscar.servicios.SrvBuscarService)
            getContext().getBean("srvBuscarService");
    }

    /**
     * Gets an instance of {@link es.pode.buscar.negocio.administrar.servicio.SrvNodoService}.
     */
    public final es.pode.buscar.negocio.administrar.servicio.SrvNodoService getSrvNodoService()
    {
        return (es.pode.buscar.negocio.administrar.servicio.SrvNodoService)
            getContext().getBean("srvNodoService");
    }

    /**
     * Gets an instance of {@link es.pode.buscar.negocio.federada.servicios.SrvBuscarFederadaService}.
     */
    public final es.pode.buscar.negocio.federada.servicios.SrvBuscarFederadaService getSrvBuscarFederadaService()
    {
        return (es.pode.buscar.negocio.federada.servicios.SrvBuscarFederadaService)
            getContext().getBean("srvBuscarFederadaService");
    }

    /**
     * Gets an instance of {@link es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarService}.
     */
    public final es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarService getSrvMonitorizarService()
    {
        return (es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarService)
            getContext().getBean("srvMonitorizarService");
    }

    /**
     * Gets an instance of {@link es.pode.buscar.negocio.nodosSQI.servicio.SrvGestionSqiService}.
     */
    public final es.pode.buscar.negocio.nodosSQI.servicio.SrvGestionSqiService getSrvGestionSqiService()
    {
        return (es.pode.buscar.negocio.nodosSQI.servicio.SrvGestionSqiService)
            getContext().getBean("srvGestionSqiService");
    }
