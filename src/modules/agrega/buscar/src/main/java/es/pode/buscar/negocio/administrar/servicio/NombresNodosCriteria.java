 ...
 * 
 */
public class NombresNodosCriteria
    implements java.io.Serializable
{

    public NombresNodosCriteria()
    {
    }
    ...
    /**
     * Copies constructor from other NombresNodosCriteria
     */
    public NombresNodosCriteria(NombresNodosCriteria otherBean)
    {
        if (otherBean != null)
        {
