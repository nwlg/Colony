...
public class CriteriaSearchProperties
{
    ...
    private static final void initialize1()
    {
        embeddedValuesByType.put(
            es.pode.planificador.negocio.dominio.RegistroTareaEjecutadaImpl.class,
            null);
        navigableAssociationEndsByType.put(
            ...
            java.util.Arrays.asList(
                new AssociationType[] 
                {
                    new AssociationType("tarea_ejecutada", es.pode.planificador.negocio.dominio.TareaEjecutadaImpl.class)
                }
            )
        );
    }
    ...
    {
        embeddedValuesByType.put(
            es.pode.planificador.negocio.dominio.TareaEjecutadaImpl.class,
            null);
        navigableAssociationEndsByType.put(
            es.pode.planificador.negocio.dominio.TareaEjecutadaImpl.class,
            java.util.Arrays.asList(
                new AssociationType[] 
                {
                    new AssociationType("registroTareaEjecutadas", es.pode.planificador.negocio.dominio.RegistroTareaEjecutadaImpl.class)
                }
            )
        );
    }
