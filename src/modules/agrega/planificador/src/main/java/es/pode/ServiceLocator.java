...
public class ServiceLocator
{
     ...
     */
    private final String DEFAULT_BEAN_REFERENCE_LOCATION = "beanRefFactory_planificador.xml";
     ...
     */
    public final es.pode.planificador.negocio.servicios.SrvPlanificadorService getSrvPlanificadorService()
    {
        return (es.pode.planificador.negocio.servicios.SrvPlanificadorService)
            getContext().getBean("srvPlanificadorService");
    }

    /**
     * Gets an instance of {@link es.pode.planificador.negocio.servicios.SrvRegistroPlanificadorService}.
     */
    public final es.pode.planificador.negocio.servicios.SrvRegistroPlanificadorService getSrvRegistroPlanificadorService()
    {
        return (es.pode.planificador.negocio.servicios.SrvRegistroPlanificadorService)
            getContext().getBean("srvRegistroPlanificadorService");
    }


    /**
     * Gets an instance of {@link es.pode.planificador.negocio.servicios.jms.SrvTareaModificadorService}.
     */
    public final es.pode.planificador.negocio.servicios.jms.SrvTareaModificadorService getSrvTareaModificadorService()
    {
        
        return (es.pode.planificador.negocio.servicios.jms.SrvTareaModificadorService)
            getContext().getBean("SrvTareaModificadorService");
    }
