 ...
 * 
 */
public class TrabajosActivosCriteria
    implements java.io.Serializable
{
   ...
   */
    public TrabajosActivosCriteria()
    {
    }
    ...
    /**
     * Copies constructor from other TrabajosActivosCriteria
      * @param otherBean TrabajosActivosCriteria
     */
    public TrabajosActivosCriteria(TrabajosActivosCriteria otherBean)
    {
        if (otherBean != null)
        {
