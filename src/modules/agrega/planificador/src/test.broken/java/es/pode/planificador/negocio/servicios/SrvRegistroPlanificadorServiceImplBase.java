...
import es.pode.planificador.negocio.servicios.SrvRegistroPlanificadorService;
...
protected static Logger logger = Logger.getLogger(SrvRegistroPlanificadorServiceImplBase.class);
    ...
    */
     ...
     */
     ...
     /*
     public void testregistrarTrabajoFinfecha()
     {
     		TareaEjecutadaVO trabajoEjecutado = new TareaEjecutadaVO();
			trabajoEjecutado.setId(new Long(1));
			trabajoEjecutado.setFechaFin(new Date());
			trabajoEjecutado.setEstado("OK");
    	 	Long id = this.servicio.registrarTrabajoFechaFin(trabajoEjecutado);
    	 	assertNotNull(id);
     }
	*/
}